import{custom as e,createWalletClient as t,createPublicClient as n,http as i,erc20Abi as a,getAbiItem as s,zeroAddress as r,formatEther as o,formatUnits as d,encodeFunctionData as u,checksumAddress as p}from"viem";import{toAccount as l}from"viem/accounts";import{createSiweMessage as y}from"viem/siwe";import c from"axios";
/******************************************************************************
 ...
 */
function B(e,t,n,i,a,s,r,o,d){return m(this,void 0,void 0,(function*(){return yield this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"mintWithSignature",[e,t,a,s,r,o,n,i,d],{waitForReceipt:!0})}))}
/**
 ...
 */function Q(e,t,n,i,a,s){return this.callContractMethod(this.environment.MARKETPLACE_CONTRACT_ADDRESS,this.environment.MARKETPLACE_ABI,"buyAccess",[e,t,n,i,a],{waitForReceipt:!0,value:s})}
/**
 ...
 */
const ie=(e,t,n,i)=>{if(n<S||n>D)throw new Error(`Royalty basis points must be between ${S} and ${D}`);if(t<x||t>P)throw new Error(`Duration must be between ${x} and ${P} seconds`);if(e<N)throw new Error(`Price must be at least ${N} wei`);return{price:e,duration:t,royaltyBps:n,paymentToken:i}};var ae,se,re,oe,de,ue,pe,le,ye,ce,me,he,Te,fe,ve,we,Ae,ge,Ie;
/**
 * The Origin class
 * Handles the upload of files to Origin, as well as querying the user's stats
 */class be{constructor(e,t,n,i){ae.add(this),this.jwt=e,this.viemClient=n,this.environment=t,this.baseParentId=i,
// DataNFT methods
...
// Marketplace methods
this.buyAccess=Q.bind(this),this.hasAccess=ee.bind(this),this.subscriptionExpiry=te.bind(this)}getJwt(){return this.jwt}setViemClient(e){this.viemClient=e}mintFile(e,t,n,i,a){return m(this,void 0,void 0,(function*(){let s,r=null;try{r=yield h(this,ae,"m",pe).call(this)}catch(e){throw new Error("Failed to mint file IP. Wallet not connected.")}try{if(s=yield h(this,ae,"m",oe).call(this,e,a),!s||!s.key)throw new Error("Failed to upload file or get upload info.")}catch(e){throw new Error(`File upload failed: ${e instanceof Error?e.message:String(e)}`)}e.type&&(t.mimetype=e.type);const o=BigInt(Date.now()+6e5);// 10 minutes from now
let d;this.baseParentId&&(i||(i=[]),i.unshift(this.baseParentId));try{d=yield this.registerIpNFT("file",o,n,t,s.key,i)}catch(e){throw yield h(this,ae,"m",re).call(this,s.key,"failed"),new Error(`Failed to register IpNFT: ${e instanceof Error?e.message:String(e)}`)}const{tokenId:u,signerAddress:p,creatorContentHash:l,signature:y,uri:c}=d;if(!(u&&p&&l&&void 0!==y&&c))throw new Error("Failed to register IpNFT: Missing required fields in registration response.");try{const e=yield this.mintWithSignature(r,u,i||[],!0,l,c,n,o,y);if(-1===["0x1","success"].indexOf(e.receipt.status))throw yield h(this,ae,"m",re).call(this,s.key,"failed"),new Error(`Minting failed with status: ${e.receipt.status}`)}catch(e){throw yield h(this,ae,"m",re).call(this,s.key,"failed"),new Error(`Minting transaction failed: ${e instanceof Error?e.message:String(e)}`)}return u.toString()}))}mintSocial(e,t,n){return m(this,void 0,void 0,(function*(){let i=null;try{i=yield h(this,ae,"m",pe).call(this)}catch(e){throw new Error("Failed to mint social IP. Wallet not connected.")}t.mimetype=`social/${e}`;const a=BigInt(Math.floor(Date.now()/1e3)+600);// 10 minutes from now
...
/**
     ...
     */callContractMethod(e,t,n,i){return m(this,arguments,void 0,(function*(e,t,n,i,a={}){var r;let o=null;try{o=yield h(this,ae,"m",pe).call(this)}catch(e){throw new Error("Failed to call contract method. Wallet not connected.")}const d=s({abi:t,name:n});if(d&&"stateMutability"in d&&("view"===d.stateMutability||"pure"===d.stateMutability)){const a=b();return(yield a.readContract({address:e,abi:t,functionName:n,args:i}))||null}yield h(this,ae,"m",ue).call(this,this.environment.CHAIN);const u=b(),{result:p,request:l}=yield u.simulateContract({account:o,address:e,abi:t,functionName:n,args:i,value:a.value});
// simulate
if(a.simulate)return p;try{const e=yield null===(r=this.viemClient)||void 0===r?void 0:r.writeContract(l);if("string"!=typeof e)throw new Error("Transaction failed to send.");if(!a.waitForReceipt)return{txHash:e,simulatedResult:p};return{txHash:e,receipt:yield h(this,ae,"m",de).call(this,e),simulatedResult:p}}catch(e){throw console.error("Transaction failed:",e),new Error("Transaction failed: "+e)}}))}
/**
     * Buy access to an asset by first checking its price via getTerms, then calling buyAccess.
     * @param {bigint} tokenId The token ID of the asset.
     * @returns {Promise<any>} The result of the buyAccess call.
     */buyAccessSmart(e){return m(this,void 0,void 0,(function*(){let t=null;try{t=yield h(this,ae,"m",pe).call(this)}catch(e){throw new Error("Failed to buy access. Wallet not connected.")}const n=yield this.getTerms(e);if(!n)throw new Error("Failed to fetch terms for asset");const{price:i,paymentToken:s,duration:o}=n;if(void 0===i||void 0===s||void 0===o)throw new Error("Terms missing price, paymentToken, or duration");const d=i;return s===r?this.buyAccess(t,e,d,o,s,d):(yield function(e){return m(this,arguments,void 0,(function*({walletClient:e,publicClient:t,tokenAddress:n,owner:i,spender:s,amount:r}){(yield t.readContract({address:n,abi:a,functionName:"allowance",args:[i,s]}))<r&&(yield e.writeContract({address:n,account:i,abi:a,functionName:"approve",args:[s,r],chain:v}))}))}({walletClient:this.viemClient,publicClient:b(),tokenAddress:s,owner:t,spender:this.environment.MARKETPLACE_CONTRACT_ADDRESS,amount:d}),this.buyAccess(t,e,d,o,s))}))}getData(e){return m(this,void 0,void 0,(function*(){const t=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/data/${e}`,{method:"GET",headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!t.ok)throw new Error("Failed to fetch data");return t.json()}))}
/**
...
/**
     ...
     * ```
     */getRoyalties(e,t){return m(this,void 0,void 0,(function*(){try{const n=yield this.getTokenBoundAccount(e),i=b();let a,s;if(t&&t!==r){
// erc20 (wrapped camp)
const e=[{inputs:[{name:"owner",type:"address"}],name:"balanceOf",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"},{inputs:[],name:"decimals",outputs:[{name:"",type:"uint8"}],stateMutability:"view",type:"function"}];a=yield this.callContractMethod(t,e,"balanceOf",[n]);const i=yield this.callContractMethod(t,e,"decimals",[]);s=d(a,i)}else a=yield i.getBalance({address:n}),s=o(a);return{tokenBoundAccount:n,balance:a,balanceFormatted:s}}catch(t){throw new Error(`Failed to retrieve royalties for token ${e}: ${t instanceof Error?t.message:String(t)}`)}}))}
/**
     ...
     * ```
     */claimRoyalties(e,t,n){return m(this,void 0,void 0,(function*(){const i=yield h(this,ae,"m",le).call(this,t),a=yield this.getTokenBoundAccount(e),s=(yield this.getRoyalties(e,n)).balance;if(s===BigInt(0))throw new Error("No royalties available to claim");let o,d,p;
// Call execute on the TBA
return n&&n!==r?(
// ERC20 token transfer
o=n,d=BigInt(0),
// Encode ERC20 transfer call: transfer(address to, uint256 amount)
p=u({abi:[{inputs:[{name:"to",type:"address"},{name:"amount",type:"uint256"}],name:"transfer",outputs:[{name:"",type:"bool"}],stateMutability:"nonpayable",type:"function"}],functionName:"transfer",args:[i,s]})):(
// Native token transfer
o=i,d=s,p="0x"),this.callContractMethod(a,this.environment.TBA_ABI,"execute",[o,d,p,0],// operation: 0 = CALL
{waitForReceipt:!0,value:BigInt(0)})}))}}ae=new WeakSet,se=function(e){return m(this,void 0,void 0,(function*(){try{const t=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/upload-url`,{method:"POST",body:JSON.stringify({name:e.name,type:e.type}),headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!t.ok)throw new Error(`HTTP ${t.status}: ${t.statusText}`);const n=yield t.json();if(n.isError)throw new Error(n.message||"Failed to generate upload URL");return n.data}catch(e){throw console.error("Failed to generate upload URL:",e),e}}))},re=function(e,t){return m(this,void 0,void 0,(function*(){try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/update-status`,{method:"PATCH",body:JSON.stringify({status:t,fileKey:e}),headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!n.ok){const e=yield n.text().catch((()=>"Unknown error"));throw new Error(`HTTP ${n.status}: ${e}`)}return!0}catch(e){throw console.error("Failed to update origin status:",e),e}}))},oe=function(e,t){return m(this,void 0,void 0,(function*(){let n;try{n=yield h(this,ae,"m",se).call(this,e)}catch(e){throw console.error("Failed to generate upload URL:",e),new Error(`Failed to generate upload URL: ${e instanceof Error?e.message:String(e)}`)}if(!n)throw new Error("Failed to generate upload URL: No upload info returned");try{yield((e,t,n)=>new Promise(((i,a)=>{c.put(t,e,Object.assign({headers:{"Content-Type":e.type}},"undefined"!=typeof window&&"function"==typeof n?{onUploadProgress:e=>{if(e.total){const t=e.loaded/e.total*100;n(t)}}}:{})).then((e=>{i(e.data)})).catch((e=>{var t;const n=(null===(t=null==e?void 0:e.response)||void 0===t?void 0:t.data)||(null==e?void 0:e.message)||"Upload failed";a(n)}))})))(e,n.url,(null==t?void 0:t.progressCallback)||(()=>{}))}catch(e){try{yield h(this,ae,"m",re).call(this,n.key,"failed")}catch(e){console.error("Failed to update status to failed:",e)}const t=e instanceof Error?e.message:String(e);throw new Error(`Failed to upload file: ${t}`)}try{yield h(this,ae,"m",re).call(this,n.key,"success")}catch(e){console.error("Failed to update status to success:",e)}return n}))},de=function(e){return m(this,arguments,void 0,(function*(e,t={}){var n,i,a;const s=b();let r=e;const o=null!==(n=t.confirmations)&&void 0!==n?n:1,d=null!==(i=t.timeoutMs)&&void 0!==i?i:18e4,u=null!==(a=t.pollingIntervalMs)&&void 0!==a?a:1500;try{return yield s.waitForTransactionReceipt({hash:r,confirmations:o,timeout:d,pollingInterval:u,onReplaced:e=>{r=e.transaction.hash}})}catch(e){
// fallback
const t=Date.now();for(;Date.now()-t<d;){try{const e=yield s.getTransactionReceipt({hash:r});if(e&&e.blockNumber)return e}catch(e){}yield new Promise((e=>setTimeout(e,u)))}throw e}}))},ue=function(e){return m(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected. Could not ensure chain ID.");let t=yield this.viemClient.request({method:"eth_chainId",params:[]});if("string"==typeof t&&(t=parseInt(t,16)),t!==e.id){(e=>{I=e,g=null})// reset public client to be recreated with new chain
(e);try{yield this.viemClient.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16)}]})}catch(t){
// Unrecognized chain
if(4902!==t.code)throw t;yield this.viemClient.request({method:"wallet_addEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16),chainName:e.name,rpcUrls:e.rpcUrls.default.http,nativeCurrency:e.nativeCurrency}]}),yield this.viemClient.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16)}]})}}}))},pe=function(){return m(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected. Please connect a wallet.");
...
/**
     ...
     */
constructor({clientId:e,redirectUri:t,environment:n="DEVELOPMENT",baseParentId:i,storage:a}){if(ye.add(this),ce.set(this,void 0),me.set(this,void 0),he.set(this,void 0),Te.set(this,void 0),!e)throw new Error("clientId is required");if(-1===["PRODUCTION","DEVELOPMENT"].indexOf(n))throw new Error("Invalid environment, must be DEVELOPMENT or PRODUCTION");T(this,me,"undefined"==typeof window,"f"),T(this,Te,a||(h(this,me,"f")?new Pe:new Me),"f"),this.viem=null,this.environment=O[n],this.baseParentId=i,this.redirectUri=(e=>{const t=["twitter","spotify"];return"object"==typeof e?t.reduce(((t,n)=>(t[n]=e[n]||("undefined"!=typeof window?window.location.href:""),t)),{}):"string"==typeof e?t.reduce(((t,n)=>(t[n]=e,t)),{}):e?{}:t.reduce(((e,t)=>(e[t]="undefined"!=typeof window?window.location.href:"",e)),{})})(t),this.clientId=e,this.isAuthenticated=!1,this.jwt=null,this.origin=null,this.walletAddress=null,this.userId=null,T(this,ce,{},"f"),
// only subscribe to providers in browser environment
h(this,me,"f")||U((e=>{h(this,ye,"m",fe).call(this,"providers",e)})),h(this,ye,"m",ve).call(this)}
/**
     ...
     *  console.log(state);
     * });
     */on(e,t){h(this,ce,"f")[e]||(h(this,ce,"f")[e]=[]),h(this,ce,"f")[e].push(t),"providers"===e&&t(F())}
/**
     * Unsubscribe from an event. Possible events are "state", "provider", "providers", and "viem".
     * @param {("state"|"provider"|"providers"|"viem")} event The event.
     * @param {function} callback The callback function.
     * @returns {void}
     */off(e,t){h(this,ce,"f")[e]&&(h(this,ce,"f")[e]=h(this,ce,"f")[e].filter((e=>e!==t)))}
/**
     * Set the loading state.
     * @param {boolean} loading The loading state.
     * @returns {void}
     */setLoading(e){h(this,ye,"m",fe).call(this,"state",e?"loading":this.isAuthenticated?"authenticated":"unauthenticated")}
/**
     * Set the provider. This is useful for setting the provider when the user selects a provider from the UI or when dApp wishes to use a specific provider.
     * @param {object} options The options object. Includes the provider and the provider info.
     * @returns {void}
     * @throws {APIError} - Throws an error if the provider is not provided.
     */setProvider({provider:n,info:i,address:a}){if(!n)throw new f("provider is required");this.viem=((n,i="window.ethereum",a,s)=>{var r,o;if(!n&&!A)return console.warn("Provider is required to create a client."),null;const d=a||v;if(!A||A.transport.name!==i&&n||s!==(null===(r=A.account)||void 0===r?void 0:r.address)&&n||(null==I?void 0:I.id)!==d.id){const a={chain:d,transport:e(n,{name:i})};s&&(a.account=l(s)),A=t(a),I=d,g&&(null===(o=g.chain)||void 0===o?void 0:o.id)!==d.id&&(g=null)}return A})(n,i.name,this.environment.CHAIN,a),this.origin&&this.origin.setViemClient(this.viem),
// TODO: only use one of these
h(this,ye,"m",fe).call(this,"viem",this.viem),h(this,ye,"m",fe).call(this,"provider",{provider:n,info:i}),h(this,Te,"f").setItem("camp-sdk:provider",JSON.stringify(i))}
/**
...
/**
     ...
     */recoverProvider(){return m(this,void 0,void 0,(function*(){var e,t,n,i,a,s,r,o,d,u,p,l,y;if(!this.walletAddress)return void console.warn("No wallet address found in local storage. Please connect your wallet again.");const c=yield h(this,Te,"f").getItem("camp-sdk:provider");if(!c)return;const m=JSON.parse(c);let T;const f=null!==(e=F())&&void 0!==e?e:[];
...
/**
     * Disconnect the user.
     * @returns {Promise<void>}
     */disconnect(){return m(this,void 0,void 0,(function*(){this.isAuthenticated&&(h(this,ye,"m",fe).call(this,"state","unauthenticated"),this.isAuthenticated=!1,this.walletAddress=null,this.userId=null,this.jwt=null,this.origin=null,T(this,he,void 0,"f"),yield h(this,Te,"f").removeItem("camp-sdk:wallet-address"),yield h(this,Te,"f").removeItem("camp-sdk:user-id"),yield h(this,Te,"f").removeItem("camp-sdk:jwt"),yield h(this,Te,"f").removeItem("camp-sdk:environment"))}))}
/**
     * Connect the user's wallet and sign the message.
     * @returns {Promise<{ success: boolean; message: string; walletAddress: string }>} A promise that resolves with the authentication result.
     * @throws {APIError} - Throws an error if the user cannot be authenticated.
     */connect(){return m(this,void 0,void 0,(function*(){h(this,ye,"m",fe).call(this,"state","loading");try{this.walletAddress||(yield h(this,ye,"m",we).call(this)),this.walletAddress=p(this.walletAddress);const e=yield h(this,ye,"m",Ae).call(this),t=h(this,ye,"m",Ie).call(this,e),n=yield this.viem.signMessage({account:this.walletAddress,message:t}),i=yield h(this,ye,"m",ge).call(this,t,n);if(i.success)return this.isAuthenticated=!0,this.userId=i.userId,this.jwt=i.token,this.origin=new be(this.jwt,this.environment,this.viem,this.baseParentId),yield h(this,Te,"f").setItem("camp-sdk:jwt",this.jwt),yield h(this,Te,"f").setItem("camp-sdk:wallet-address",this.walletAddress),yield h(this,Te,"f").setItem("camp-sdk:user-id",this.userId),yield h(this,Te,"f").setItem("camp-sdk:environment",this.environment.NAME),h(this,ye,"m",fe).call(this,"state","authenticated"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,h(this,ye,"m",fe).call(this,"state","unauthenticated"),new f("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,h(this,ye,"m",fe).call(this,"state","unauthenticated"),new f(e)}}))}
/**
     ...
     */connectWithSigner(e,t){return m(this,void 0,void 0,(function*(){h(this,ye,"m",fe).call(this,"state","loading");try{T(this,he,ke(e),"f"),this.walletAddress=p(yield h(this,he,"f").getAddress()),
// store the signer as viem client if it's a viem client, otherwise keep adapter
"viem"===h(this,he,"f").type&&(this.viem=e);const n=yield h(this,ye,"m",Ae).call(this),i=h(this,ye,"m",Ie).call(this,n,null==t?void 0:t.domain,null==t?void 0:t.uri),a=yield h(this,he,"f").signMessage(i),s=yield h(this,ye,"m",ge).call(this,i,a);if(s.success)return this.isAuthenticated=!0,this.userId=s.userId,this.jwt=s.token,this.origin=new be(this.jwt,this.environment,this.viem,this.baseParentId),yield h(this,Te,"f").setItem("camp-sdk:jwt",this.jwt),yield h(this,Te,"f").setItem("camp-sdk:wallet-address",this.walletAddress),yield h(this,Te,"f").setItem("camp-sdk:user-id",this.userId),yield h(this,Te,"f").setItem("camp-sdk:environment",this.environment.NAME),h(this,ye,"m",fe).call(this,"state","authenticated"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,h(this,ye,"m",fe).call(this,"state","unauthenticated"),new f("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,T(this,he,void 0,"f"),h(this,ye,"m",fe).call(this,"state","unauthenticated"),new f(e)}}))}
/**
...
/**
     ...
     */linkTwitter(){return m(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(h(this,me,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/twitter/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.twitter}`}))}
/**
     * Link the user's Discord account.
     * @returns {Promise<void>}
     * @throws {Error} - Throws an error if the user is not authenticated or in Node.js environment.
     */linkDiscord(){return m(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(h(this,me,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/discord/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.discord}`}))}
/**
     * Link the user's Spotify account.
     * @returns {Promise<void>}
     * @throws {Error} - Throws an error if the user is not authenticated or in Node.js environment.
     */linkSpotify(){return m(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(h(this,me,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/spotify/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.spotify}`}))}
/**
