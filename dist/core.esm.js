...
// DataNFT methods
this.mintWithSignature=P.bind(this),this.registerIpNFT=x.bind(this),this.updateTerms=U.bind(this),this.requestDelete=M.bind(this),this.getTerms=O.bind(this),this.ownerOf=B.bind(this),this.balanceOf=F.bind(this),this.contentHash=R.bind(this),this.tokenURI=$.bind(this),this.dataStatus=H.bind(this),this.royaltyInfo=j.bind(this),this.getApproved=L.bind(this),this.isApprovedForAll=W.bind(this),this.transferFrom=q.bind(this),this.safeTransferFrom=K.bind(this),this.approve=z.bind(this),this.setApprovalForAll=J.bind(this),
// Marketplace methods
...
/**
     ...
     *  console.log(state);
     * });
     */on(e,t){c(this,ae,"f")[e]||(c(this,ae,"f")[e]=[]),c(this,ae,"f")[e].push(t),"providers"===e&&t(N())}
/**
...
/**
     ...
     * @returns {Promise<void>}
     */recoverProvider(){return y(this,void 0,void 0,(function*(){var e,t,n,i,a,r,s,o,d,u,p,l,y,c,h;if(!this.walletAddress)return void console.warn("No wallet address found in local storage. Please connect your wallet again.");const m=JSON.parse(localStorage.getItem("camp-sdk:provider")||"{}");let T;const f=null!==(e=N())&&void 0!==e?e:[];
