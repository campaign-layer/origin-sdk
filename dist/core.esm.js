import e from"axios";import{custom as t,createWalletClient as n,createPublicClient as i,http as a,erc20Abi as s,getAbiItem as r,zeroAddress as o,formatEther as d,formatUnits as u,encodeFunctionData as p,checksumAddress as l}from"viem";import{toAccount as y}from"viem/accounts";import{createSiweMessage as c}from"viem/siwe";
/******************************************************************************
 ...
 */function _(t){return h(this,arguments,void 0,(function*(t,n={}){try{return(yield e.get(t,{headers:n})).data}catch(e){if(e.response)throw new T(e.response.data.message||"API request failed",e.response.status);throw new T("Network error or server is unavailable",500)}}))}
/**
 ...
 */
function k(e,t={}){const n=function(e={}){return Object.keys(e).map((t=>`${encodeURIComponent(t)}=${encodeURIComponent(e[t])}`)).join("&")}(t);return n?`${e}?${n}`:e}const N="https://wv2h4to5qa.execute-api.us-east-2.amazonaws.com/dev/twitter",x="https://wv2h4to5qa.execute-api.us-east-2.amazonaws.com/dev/spotify";
/**
...
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchUserByUsername(e){return h(this,void 0,void 0,(function*(){const t=k(`${N}/user`,{twitterUserName:e});return this._fetchDataWithAuth(t)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchTweetsByUsername(e){return h(this,arguments,void 0,(function*(e,t=1,n=10){const i=k(`${N}/tweets`,{twitterUserName:e,page:t,limit:n});return this._fetchDataWithAuth(i)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchFollowersByUsername(e){return h(this,arguments,void 0,(function*(e,t=1,n=10){const i=k(`${N}/followers`,{twitterUserName:e,page:t,limit:n});return this._fetchDataWithAuth(i)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchFollowingByUsername(e){return h(this,arguments,void 0,(function*(e,t=1,n=10){const i=k(`${N}/following`,{twitterUserName:e,page:t,limit:n});return this._fetchDataWithAuth(i)}))}
/**
     * Fetch tweet by tweet ID.
     * @param {string} tweetId - The tweet ID.
     * @returns {Promise<object>} - The tweet.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchTweetById(e){return h(this,void 0,void 0,(function*(){const t=k(`${N}/getTweetById`,{tweetId:e});return this._fetchDataWithAuth(t)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchUserByWalletAddress(e){return h(this,arguments,void 0,(function*(e,t=1,n=10){const i=k(`${N}/wallet-twitter-data`,{walletAddress:e,page:t,limit:n});return this._fetchDataWithAuth(i)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchRepostedByUsername(e){return h(this,arguments,void 0,(function*(e,t=1,n=10){const i=k(`${N}/reposted`,{twitterUserName:e,page:t,limit:n});return this._fetchDataWithAuth(i)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchRepliesByUsername(e){return h(this,arguments,void 0,(function*(e,t=1,n=10){const i=k(`${N}/replies`,{twitterUserName:e,page:t,limit:n});return this._fetchDataWithAuth(i)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchLikesByUsername(e){return h(this,arguments,void 0,(function*(e,t=1,n=10){const i=k(`${N}/event/likes/${e}`,{page:t,limit:n});return this._fetchDataWithAuth(i)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchFollowsByUsername(e){return h(this,arguments,void 0,(function*(e,t=1,n=10){const i=k(`${N}/event/follows/${e}`,{page:t,limit:n});return this._fetchDataWithAuth(i)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchViewedTweetsByUsername(e){return h(this,arguments,void 0,(function*(e,t=1,n=10){const i=k(`${N}/event/viewed-tweets/${e}`,{page:t,limit:n});return this._fetchDataWithAuth(i)}))}
/**
     * Private method to fetch data with authorization header.
     * @param {string} url - The URL to fetch.
     * @returns {Promise<object>} - The response data.
     * @throws {APIError} - Throws an error if the request fails.
     */_fetchDataWithAuth(e){return h(this,void 0,void 0,(function*(){if(!this.apiKey)throw new T("API key is required for fetching data",401);try{return yield _(e,{"x-api-key":this.apiKey})}catch(e){throw new T(e.message,e.statusCode)}}))}}
/**
...
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchSavedTracksById(e){return h(this,void 0,void 0,(function*(){const t=k(`${x}/save-tracks`,{spotifyId:e});return this._fetchDataWithAuth(t)}))}
/**
     * Fetch the played tracks of a user by Spotify ID.
     * @param {string} spotifyId - The user's Spotify ID.
     * @returns {Promise<object>} - The played tracks.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchPlayedTracksById(e){return h(this,void 0,void 0,(function*(){const t=k(`${x}/played-tracks`,{spotifyId:e});return this._fetchDataWithAuth(t)}))}
/**
     * Fetch the user's saved albums by Spotify user ID.
     * @param {string} spotifyId - The user's Spotify ID.
     * @returns {Promise<object>} - The saved albums.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchSavedAlbumsById(e){return h(this,void 0,void 0,(function*(){const t=k(`${x}/saved-albums`,{spotifyId:e});return this._fetchDataWithAuth(t)}))}
/**
     * Fetch the user's saved playlists by Spotify user ID.
     * @param {string} spotifyId - The user's Spotify ID.
     * @returns {Promise<object>} - The saved playlists.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchSavedPlaylistsById(e){return h(this,void 0,void 0,(function*(){const t=k(`${x}/saved-playlists`,{spotifyId:e});return this._fetchDataWithAuth(t)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchTracksInAlbum(e,t){return h(this,void 0,void 0,(function*(){const n=k(`${x}/album/tracks`,{spotifyId:e,albumId:t});return this._fetchDataWithAuth(n)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchTracksInPlaylist(e,t){return h(this,void 0,void 0,(function*(){const n=k(`${x}/playlist/tracks`,{spotifyId:e,playlistId:t});return this._fetchDataWithAuth(n)}))}
/**
     * Fetch the user's Spotify data by wallet address.
     * @param {string} walletAddress - The wallet address.
     * @returns {Promise<object>} - The user's Spotify data.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchUserByWalletAddress(e){return h(this,void 0,void 0,(function*(){const t=k(`${x}/wallet-spotify-data`,{walletAddress:e});return this._fetchDataWithAuth(t)}))}
/**
     * Private method to fetch data with authorization header.
     * @param {string} url - The URL to fetch.
     * @returns {Promise<object>} - The response data.
     ...
     */_fetchDataWithAuth(e){return h(this,void 0,void 0,(function*(){if(!this.apiKey)throw new T("API key is required for fetching data",401);try{return yield _(e,{"x-api-key":this.apiKey})}catch(e){throw new T(e.message,e.statusCode)}}))}}
// @ts-ignore
let S=null,U=null,D=null;const B=e=>{var t;const n=D||v;return U&&(null===(t=U.chain)||void 0===t?void 0:t.id)===n.id||(U=i({chain:n,transport:a()})),U};let O=[];const F=()=>O,R=e=>{function t(t){O.some((e=>e.info.uuid===t.detail.info.uuid))||(O=[...O,t.detail],e(O))}if("undefined"!=typeof window)return window.addEventListener("eip6963:announceProvider",t),window.dispatchEvent(new Event("eip6963:requestProvider")),()=>window.removeEventListener("eip6963:announceProvider",t)};
/**
 ...
 */function $(e,t,n,i,a,s,r,o,d){return h(this,void 0,void 0,(function*(){return yield this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"mintWithSignature",[e,t,a,s,r,o,n,i,d],{waitForReceipt:!0})}))}
/**
 ...
 * @returns A promise that resolves when the transaction is complete.
 */function z(e){return this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"finalizeDelete",[e])}
/**
 * Calls the getOrCreateRoyaltyVault method on the IPNFT contract.
 * @param tokenOwner The address of the token owner for whom to get or create the royalty vault.
 * @param simulateOnly If true, simulates the transaction without executing it.
 * @returns The address of the royalty vault associated with the specified token owner.
 */function W(e){return h(this,arguments,void 0,(function*(e,t=!1){const n=yield this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"getOrCreateRoyaltyVault",[e],{waitForReceipt:!0,simulate:t});return t?n:n.simulatedResult}))}
/**
 ...
 */function ee(e,t,n,i,a,s){return this.callContractMethod(this.environment.MARKETPLACE_CONTRACT_ADDRESS,this.environment.MARKETPLACE_ABI,"buyAccess",[e,t,n,i,a],{waitForReceipt:!0,value:s})}
/**
 ...
 */function te(e,t){return h(this,void 0,void 0,(function*(){try{const n=yield this.subscriptionExpiry(t,e);return n>BigInt(Math.floor(Date.now()/1e3))}catch(e){return!1}}))}function ne(e,t){return this.callContractMethod(this.environment.MARKETPLACE_CONTRACT_ADDRESS,this.environment.MARKETPLACE_ABI,"subscriptionExpiry",[e,t])}
/**
 * Approves a spender to spend a specified amount of tokens on behalf of the owner.
 * If the current allowance is less than the specified amount, it will perform the approval.
 * @param {ApproveParams} params - The parameters for the approval.
 */var ie,ae,se,re,oe,de,ue,pe,le,ye,ce,he,me,fe,Te,ve,we,Ae;
/**
 * The Origin class
 * Handles the upload of files to Origin, as well as querying the user's stats
 */class ge{constructor(e,t,n){ie.add(this),this.jwt=e,this.viemClient=n,this.environment=t,
// DataNFT methods
this.mintWithSignature=$.bind(this),this.registerIpNFT=H.bind(this),this.updateTerms=j.bind(this),this.finalizeDelete=z.bind(this),this.getOrCreateRoyaltyVault=W.bind(this),this.getTerms=L.bind(this),this.ownerOf=q.bind(this),this.balanceOf=J.bind(this),this.tokenURI=K.bind(this),this.dataStatus=V.bind(this),this.isApprovedForAll=G.bind(this),this.transferFrom=Y.bind(this),this.safeTransferFrom=X.bind(this),this.approve=Z.bind(this),this.setApprovalForAll=Q.bind(this),
// Marketplace methods
this.buyAccess=ee.bind(this),this.hasAccess=te.bind(this),this.subscriptionExpiry=ne.bind(this)}getJwt(){return this.jwt}setViemClient(e){this.viemClient=e}uploadFile(t,n){return h(this,void 0,void 0,(function*(){let i;try{i=yield m(this,ie,"m",ae).call(this,t)}catch(e){throw console.error("Failed to generate upload URL:",e),new Error(`Failed to generate upload URL: ${e instanceof Error?e.message:String(e)}`)}if(!i)throw new Error("Failed to generate upload URL: No upload info returned");try{yield((t,n,i)=>new Promise(((a,s)=>{e.put(n,t,Object.assign({headers:{"Content-Type":t.type}},"undefined"!=typeof window&&"function"==typeof i?{onUploadProgress:e=>{if(e.total){const t=e.loaded/e.total*100;i(t)}}}:{})).then((e=>{a(e.data)})).catch((e=>{var t;const n=(null===(t=null==e?void 0:e.response)||void 0===t?void 0:t.data)||(null==e?void 0:e.message)||"Upload failed";s(n)}))})))(t,i.url,(null==n?void 0:n.progressCallback)||(()=>{}))}catch(e){try{yield m(this,ie,"m",se).call(this,i.key,"failed")}catch(e){console.error("Failed to update status to failed:",e)}const t=e instanceof Error?e.message:String(e);throw new Error(`Failed to upload file: ${t}`)}try{yield m(this,ie,"m",se).call(this,i.key,"success")}catch(e){console.error("Failed to update status to success:",e)}return i}))}mintFile(e,t,n,i,a){return h(this,void 0,void 0,(function*(){let s,r=null;try{r=yield m(this,ie,"m",de).call(this)}catch(e){throw new Error("Failed to mint file IP. Wallet not connected.")}try{if(s=yield this.uploadFile(e,a),!s||!s.key)throw new Error("Failed to upload file or get upload info.")}catch(e){throw new Error(`File upload failed: ${e instanceof Error?e.message:String(e)}`)}e.type&&(t.mimetype=e.type);const o=BigInt(Date.now()+6e5);// 10 minutes from now
let d;try{d=yield this.registerIpNFT("file",o,n,t,s.key,i)}catch(e){throw yield m(this,ie,"m",se).call(this,s.key,"failed"),new Error(`Failed to register IpNFT: ${e instanceof Error?e.message:String(e)}`)}const{tokenId:u,signerAddress:p,creatorContentHash:l,signature:y,uri:c}=d;if(!(u&&p&&l&&void 0!==y&&c))throw new Error("Failed to register IpNFT: Missing required fields in registration response.");try{const e=yield this.mintWithSignature(r,u,i||[],!0,l,c,n,o,y);if(-1===["0x1","success"].indexOf(e.receipt.status))throw yield m(this,ie,"m",se).call(this,s.key,"failed"),new Error(`Minting failed with status: ${e.receipt.status}`)}catch(e){throw yield m(this,ie,"m",se).call(this,s.key,"failed"),new Error(`Minting transaction failed: ${e instanceof Error?e.message:String(e)}`)}return u.toString()}))}mintSocial(e,t,n){return h(this,void 0,void 0,(function*(){let i=null;try{i=yield m(this,ie,"m",de).call(this)}catch(e){throw new Error("Failed to mint social IP. Wallet not connected.")}t.mimetype=`social/${e}`;const a=BigInt(Math.floor(Date.now()/1e3)+600);// 10 minutes from now
let s;try{s=yield this.registerIpNFT(e,a,n,t)}catch(e){throw new Error(`Failed to register Social IpNFT: ${e instanceof Error?e.message:String(e)}`)}const{tokenId:r,signerAddress:o,creatorContentHash:d,signature:u,uri:p}=s;if(!(r&&o&&d&&void 0!==u&&p))throw new Error("Failed to register Social IpNFT: Missing required fields in registration response.");try{const e=yield this.mintWithSignature(i,r,[],!0,d,p,n,a,u);if(-1===["0x1","success"].indexOf(e.receipt.status))throw new Error(`Minting Social IpNFT failed with status: ${e.receipt.status}`)}catch(e){throw new Error(`Minting transaction failed: ${e instanceof Error?e.message:String(e)}`)}return r.toString()}))}getOriginUploads(){return h(this,void 0,void 0,(function*(){const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/files`,{method:"GET",headers:{Authorization:`Bearer ${this.jwt}`}});if(!e.ok)return console.error("Failed to get origin uploads"),null;return(yield e.json()).data}))}
/**
...
/**
     ...
     */callContractMethod(e,t,n,i){return h(this,arguments,void 0,(function*(e,t,n,i,a={}){var s;let o=null;try{o=yield m(this,ie,"m",de).call(this)}catch(e){throw new Error("Failed to call contract method. Wallet not connected.")}const d=r({abi:t,name:n});if(d&&"stateMutability"in d&&("view"===d.stateMutability||"pure"===d.stateMutability)){const a=B();return(yield a.readContract({address:e,abi:t,functionName:n,args:i}))||null}yield m(this,ie,"m",oe).call(this,this.environment.CHAIN);const u=B(),{result:p,request:l}=yield u.simulateContract({account:o,address:e,abi:t,functionName:n,args:i,value:a.value});
// simulate
if(a.simulate)return p;try{const e=yield null===(s=this.viemClient)||void 0===s?void 0:s.writeContract(l);if("string"!=typeof e)throw new Error("Transaction failed to send.");if(!a.waitForReceipt)return{txHash:e,simulatedResult:p};return{txHash:e,receipt:yield m(this,ie,"m",re).call(this,e),simulatedResult:p}}catch(e){throw console.error("Transaction failed:",e),new Error("Transaction failed: "+e)}}))}
/**
     * Buy access to an asset by first checking its price via getTerms, then calling buyAccess.
     * @param {bigint} tokenId The token ID of the asset.
     * @returns {Promise<any>} The result of the buyAccess call.
     */buyAccessSmart(e){return h(this,void 0,void 0,(function*(){let t=null;try{t=yield m(this,ie,"m",de).call(this)}catch(e){throw new Error("Failed to buy access. Wallet not connected.")}const n=yield this.getTerms(e);if(!n)throw new Error("Failed to fetch terms for asset");const{price:i,paymentToken:a,duration:r}=n;if(void 0===i||void 0===a||void 0===r)throw new Error("Terms missing price, paymentToken, or duration");const d=i;return a===o?this.buyAccess(t,e,d,r,a,d):(yield function(e){return h(this,arguments,void 0,(function*({walletClient:e,publicClient:t,tokenAddress:n,owner:i,spender:a,amount:r}){(yield t.readContract({address:n,abi:s,functionName:"allowance",args:[i,a]}))<r&&(yield e.writeContract({address:n,account:i,abi:s,functionName:"approve",args:[a,r],chain:v}))}))}({walletClient:this.viemClient,publicClient:B(),tokenAddress:a,owner:t,spender:this.environment.MARKETPLACE_CONTRACT_ADDRESS,amount:d}),this.buyAccess(t,e,d,r,a))}))}getData(e){return h(this,void 0,void 0,(function*(){const t=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/data/${e}`,{method:"GET",headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!t.ok)throw new Error("Failed to fetch data");return t.json()}))}
/**
...
/**
     ...
     * ```
     */getRoyalties(e,t){return h(this,void 0,void 0,(function*(){try{const n=yield this.getTokenBoundAccount(e),i=B();let a,s;if(t&&t!==o){
// erc20 (wrapped camp)
const e=[{inputs:[{name:"owner",type:"address"}],name:"balanceOf",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"},{inputs:[],name:"decimals",outputs:[{name:"",type:"uint8"}],stateMutability:"view",type:"function"}];a=yield this.callContractMethod(t,e,"balanceOf",[n]);const i=yield this.callContractMethod(t,e,"decimals",[]);s=u(a,i)}else a=yield i.getBalance({address:n}),s=d(a);return{tokenBoundAccount:n,balance:a,balanceFormatted:s}}catch(t){throw new Error(`Failed to retrieve royalties for token ${e}: ${t instanceof Error?t.message:String(t)}`)}}))}
/**
     ...
     * ```
     */claimRoyalties(e,t,n){return h(this,void 0,void 0,(function*(){const i=yield m(this,ie,"m",ue).call(this,t),a=yield this.getTokenBoundAccount(e),s=(yield this.getRoyalties(e,n)).balance;if(s===BigInt(0))throw new Error("No royalties available to claim");let r,d,u;
// Call execute on the TBA
return n&&n!==o?(
// ERC20 token transfer
r=n,d=BigInt(0),
// Encode ERC20 transfer call: transfer(address to, uint256 amount)
u=p({abi:[{inputs:[{name:"to",type:"address"},{name:"amount",type:"uint256"}],name:"transfer",outputs:[{name:"",type:"bool"}],stateMutability:"nonpayable",type:"function"}],functionName:"transfer",args:[i,s]})):(
// Native token transfer
r=i,d=s,u="0x"),this.callContractMethod(a,this.environment.TBA_ABI,"execute",[r,d,u,0],// operation: 0 = CALL
{waitForReceipt:!0,value:BigInt(0)})}))}}ie=new WeakSet,ae=function(e){return h(this,void 0,void 0,(function*(){try{const t=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/upload-url`,{method:"POST",body:JSON.stringify({name:e.name,type:e.type}),headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!t.ok)throw new Error(`HTTP ${t.status}: ${t.statusText}`);const n=yield t.json();if(n.isError)throw new Error(n.message||"Failed to generate upload URL");return n.data}catch(e){throw console.error("Failed to generate upload URL:",e),e}}))},se=function(e,t){return h(this,void 0,void 0,(function*(){try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/update-status`,{method:"PATCH",body:JSON.stringify({status:t,fileKey:e}),headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!n.ok){const e=yield n.text().catch((()=>"Unknown error"));throw new Error(`HTTP ${n.status}: ${e}`)}return!0}catch(e){throw console.error("Failed to update origin status:",e),e}}))},re=function(e){return h(this,arguments,void 0,(function*(e,t={}){var n,i,a;const s=B();let r=e;const o=null!==(n=t.confirmations)&&void 0!==n?n:1,d=null!==(i=t.timeoutMs)&&void 0!==i?i:18e4,u=null!==(a=t.pollingIntervalMs)&&void 0!==a?a:1500;try{return yield s.waitForTransactionReceipt({hash:r,confirmations:o,timeout:d,pollingInterval:u,onReplaced:e=>{r=e.transaction.hash}})}catch(e){
// fallback
const t=Date.now();for(;Date.now()-t<d;){try{const e=yield s.getTransactionReceipt({hash:r});if(e&&e.blockNumber)return e}catch(e){}yield new Promise((e=>setTimeout(e,u)))}throw e}}))},oe=function(e){return h(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected. Could not ensure chain ID.");let t=yield this.viemClient.request({method:"eth_chainId",params:[]});if("string"==typeof t&&(t=parseInt(t,16)),t!==e.id){(e=>{D=e,U=null})// reset public client to be recreated with new chain
(e);try{yield this.viemClient.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16)}]})}catch(t){
// Unrecognized chain
if(4902!==t.code)throw t;yield this.viemClient.request({method:"wallet_addEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16),chainName:e.name,rpcUrls:e.rpcUrls.default.http,nativeCurrency:e.nativeCurrency}]}),yield this.viemClient.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16)}]})}}}))},de=function(){return h(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected. Please connect a wallet.");
 ...
 */class Ee{constructor(e){this.type="custom",this.signer=e}getAddress(){return h(this,void 0,void 0,(function*(){if("function"==typeof this.signer.getAddress)return yield this.signer.getAddress();if(this.signer.address)return this.signer.address;throw new Error("Custom signer must implement getAddress() or have address property")}))}signMessage(e){return h(this,void 0,void 0,(function*(){if("function"!=typeof this.signer.signMessage)throw new Error("Custom signer must implement signMessage()");return yield this.signer.signMessage(e)}))}getChainId(){return h(this,void 0,void 0,(function*(){if("function"==typeof this.signer.getChainId){const e=yield this.signer.getChainId();return"bigint"==typeof e?Number(e):e}return void 0!==this.signer.chainId?"bigint"==typeof this.signer.chainId?Number(this.signer.chainId):this.signer.chainId:484;
// Default to mainnet
}))}}
/**
...
return e.transport&&e.chain&&"function"==typeof e.signMessage?new Ie(e):
// Check for ethers signer (v5 or v6)
e._isSigner||e.provider&&"function"==typeof e.signMessage?new be(e):new Ee(e)}
/**
 * Browser localStorage adapter
 */class _e{getItem(e){return h(this,void 0,void 0,(function*(){return"undefined"==typeof localStorage?null:localStorage.getItem(e)}))}setItem(e,t){return h(this,void 0,void 0,(function*(){"undefined"!=typeof localStorage&&localStorage.setItem(e,t)}))}removeItem(e){return h(this,void 0,void 0,(function*(){"undefined"!=typeof localStorage&&localStorage.removeItem(e)}))}}
/**
 * In-memory storage adapter for Node.js
 */class ke{constructor(){this.storage=new Map}getItem(e){return h(this,void 0,void 0,(function*(){return this.storage.get(e)||null}))}setItem(e,t){return h(this,void 0,void 0,(function*(){this.storage.set(e,t)}))}removeItem(e){return h(this,void 0,void 0,(function*(){this.storage.delete(e)}))}clear(){this.storage.clear()}}
/**
 * The Auth class.
 * @class
...
/**
     ...
     */
constructor({clientId:e,redirectUri:t,environment:n="DEVELOPMENT",storage:i}){if(pe.add(this),le.set(this,void 0),ye.set(this,void 0),ce.set(this,void 0),he.set(this,void 0),!e)throw new Error("clientId is required");if(-1===["PRODUCTION","DEVELOPMENT"].indexOf(n))throw new Error("Invalid environment, must be DEVELOPMENT or PRODUCTION");f(this,ye,"undefined"==typeof window,"f"),f(this,he,i||(m(this,ye,"f")?new ke:new _e),"f"),this.viem=null,this.environment=C[n],this.redirectUri=(e=>{const t=["twitter","spotify"];return"object"==typeof e?t.reduce(((t,n)=>(t[n]=e[n]||("undefined"!=typeof window?window.location.href:""),t)),{}):"string"==typeof e?t.reduce(((t,n)=>(t[n]=e,t)),{}):e?{}:t.reduce(((e,t)=>(e[t]="undefined"!=typeof window?window.location.href:"",e)),{})})(t),this.clientId=e,this.isAuthenticated=!1,this.jwt=null,this.origin=null,this.walletAddress=null,this.userId=null,f(this,le,{},"f"),
// only subscribe to providers in browser environment
m(this,ye,"f")||R((e=>{m(this,pe,"m",me).call(this,"providers",e)})),m(this,pe,"m",fe).call(this)}
/**
     ...
     *  console.log(state);
     * });
     */on(e,t){m(this,le,"f")[e]||(m(this,le,"f")[e]=[]),m(this,le,"f")[e].push(t),"providers"===e&&t(F())}
/**
     * Unsubscribe from an event. Possible events are "state", "provider", "providers", and "viem".
     * @param {("state"|"provider"|"providers"|"viem")} event The event.
     * @param {function} callback The callback function.
     * @returns {void}
     */off(e,t){m(this,le,"f")[e]&&(m(this,le,"f")[e]=m(this,le,"f")[e].filter((e=>e!==t)))}
/**
     * Set the loading state.
     * @param {boolean} loading The loading state.
     * @returns {void}
     */setLoading(e){m(this,pe,"m",me).call(this,"state",e?"loading":this.isAuthenticated?"authenticated":"unauthenticated")}
/**
     * Set the provider. This is useful for setting the provider when the user selects a provider from the UI or when dApp wishes to use a specific provider.
     * @param {object} options The options object. Includes the provider and the provider info.
     * @returns {void}
     * @throws {APIError} - Throws an error if the provider is not provided.
     */setProvider({provider:e,info:i,address:a}){if(!e)throw new T("provider is required");this.viem=((e,i="window.ethereum",a,s)=>{var r,o;if(!e&&!S)return console.warn("Provider is required to create a client."),null;const d=a||v;if(!S||S.transport.name!==i&&e||s!==(null===(r=S.account)||void 0===r?void 0:r.address)&&e||(null==D?void 0:D.id)!==d.id){const a={chain:d,transport:t(e,{name:i})};s&&(a.account=y(s)),S=n(a),D=d,U&&(null===(o=U.chain)||void 0===o?void 0:o.id)!==d.id&&(U=null)}return S})(e,i.name,this.environment.CHAIN,a),this.origin&&this.origin.setViemClient(this.viem),
// TODO: only use one of these
m(this,pe,"m",me).call(this,"viem",this.viem),m(this,pe,"m",me).call(this,"provider",{provider:e,info:i}),m(this,he,"f").setItem("camp-sdk:provider",JSON.stringify(i))}
/**
...
/**
     ...
     * @returns {Promise<void>}
     */recoverProvider(){return h(this,void 0,void 0,(function*(){var e,t,n,i,a,s,r,o,d,u,p,l,y;if(!this.walletAddress)return void console.warn("No wallet address found in local storage. Please connect your wallet again.");const c=yield m(this,he,"f").getItem("camp-sdk:provider");if(!c)return;const h=JSON.parse(c);let f;const T=null!==(e=F())&&void 0!==e?e:[];
...
if(h.uuid&&(null===(s=e.info)||void 0===s?void 0:s.uuid)===h.uuid||h.name&&(null===(r=e.info)||void 0===r?void 0:r.name)===h.name)continue;const t=yield e.provider.request({method:"eth_accounts"});if(t.length>0&&(null===(o=t[0])||void 0===o?void 0:o.toLowerCase())===(null===(d=this.walletAddress)||void 0===d?void 0:d.toLowerCase())){f=e;break}}catch(e){console.warn("Failed to fetch accounts from provider:",e)}
...
/**
     * Disconnect the user.
     * @returns {Promise<void>}
     */disconnect(){return h(this,void 0,void 0,(function*(){this.isAuthenticated&&(m(this,pe,"m",me).call(this,"state","unauthenticated"),this.isAuthenticated=!1,this.walletAddress=null,this.userId=null,this.jwt=null,this.origin=null,f(this,ce,void 0,"f"),yield m(this,he,"f").removeItem("camp-sdk:wallet-address"),yield m(this,he,"f").removeItem("camp-sdk:user-id"),yield m(this,he,"f").removeItem("camp-sdk:jwt"),yield m(this,he,"f").removeItem("camp-sdk:environment"))}))}
/**
     * Connect the user's wallet and sign the message.
     * @returns {Promise<{ success: boolean; message: string; walletAddress: string }>} A promise that resolves with the authentication result.
     * @throws {APIError} - Throws an error if the user cannot be authenticated.
     */connect(){return h(this,void 0,void 0,(function*(){m(this,pe,"m",me).call(this,"state","loading");try{this.walletAddress||(yield m(this,pe,"m",Te).call(this)),this.walletAddress=l(this.walletAddress);const e=yield m(this,pe,"m",ve).call(this),t=m(this,pe,"m",Ae).call(this,e),n=yield this.viem.signMessage({account:this.walletAddress,message:t}),i=yield m(this,pe,"m",we).call(this,t,n);if(i.success)return this.isAuthenticated=!0,this.userId=i.userId,this.jwt=i.token,this.origin=new ge(this.jwt,this.environment,this.viem),yield m(this,he,"f").setItem("camp-sdk:jwt",this.jwt),yield m(this,he,"f").setItem("camp-sdk:wallet-address",this.walletAddress),yield m(this,he,"f").setItem("camp-sdk:user-id",this.userId),yield m(this,he,"f").setItem("camp-sdk:environment",this.environment.NAME),m(this,pe,"m",me).call(this,"state","authenticated"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,m(this,pe,"m",me).call(this,"state","unauthenticated"),new T("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,m(this,pe,"m",me).call(this,"state","unauthenticated"),new T(e)}}))}
/**
     ...
     */connectWithSigner(e,t){return h(this,void 0,void 0,(function*(){m(this,pe,"m",me).call(this,"state","loading");try{f(this,ce,Ce(e),"f"),this.walletAddress=l(yield m(this,ce,"f").getAddress()),
// store the signer as viem client if it's a viem client, otherwise keep adapter
"viem"===m(this,ce,"f").type&&(this.viem=e);const n=yield m(this,pe,"m",ve).call(this),i=m(this,pe,"m",Ae).call(this,n,null==t?void 0:t.domain,null==t?void 0:t.uri),a=yield m(this,ce,"f").signMessage(i),s=yield m(this,pe,"m",we).call(this,i,a);if(s.success)return this.isAuthenticated=!0,this.userId=s.userId,this.jwt=s.token,this.origin=new ge(this.jwt,this.environment,this.viem),yield m(this,he,"f").setItem("camp-sdk:jwt",this.jwt),yield m(this,he,"f").setItem("camp-sdk:wallet-address",this.walletAddress),yield m(this,he,"f").setItem("camp-sdk:user-id",this.userId),yield m(this,he,"f").setItem("camp-sdk:environment",this.environment.NAME),m(this,pe,"m",me).call(this,"state","authenticated"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,m(this,pe,"m",me).call(this,"state","unauthenticated"),new T("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,f(this,ce,void 0,"f"),m(this,pe,"m",me).call(this,"state","unauthenticated"),new T(e)}}))}
/**
...
/**
     ...
     */linkTwitter(){return h(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(m(this,ye,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/twitter/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.twitter}`}))}
/**
     * Link the user's Discord account.
     * @returns {Promise<void>}
     * @throws {Error} - Throws an error if the user is not authenticated or in Node.js environment.
     */linkDiscord(){return h(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(m(this,ye,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/discord/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.discord}`}))}
/**
     * Link the user's Spotify account.
     * @returns {Promise<void>}
     * @throws {Error} - Throws an error if the user is not authenticated or in Node.js environment.
     */linkSpotify(){return h(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(m(this,ye,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/spotify/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.spotify}`}))}
/**
 ...
 */
function xe(e,t,i){return n({account:e,chain:t,transport:a(i)})}le=new WeakMap,ye=new WeakMap,ce=new WeakMap,he=new WeakMap,pe=new WeakSet,me=function(e,t){m(this,le,"f")[e]&&m(this,le,"f")[e].forEach((e=>e(t)))},fe=function(e){return h(this,void 0,void 0,(function*(){const t=yield m(this,he,"f").getItem("camp-sdk:wallet-address"),n=yield m(this,he,"f").getItem("camp-sdk:user-id"),i=yield m(this,he,"f").getItem("camp-sdk:jwt"),a=yield m(this,he,"f").getItem("camp-sdk:environment");t&&n&&i&&(a===this.environment.NAME||!a)?(this.walletAddress=t,this.userId=n,this.jwt=i,this.origin=new ge(this.jwt,this.environment),this.isAuthenticated=!0,e?this.setProvider({provider:e.provider,info:e.info||{name:"Unknown"},address:t}):m(this,ye,"f")||(console.warn("No matching provider was given for the stored wallet address. Trying to recover provider."),yield this.recoverProvider())):this.isAuthenticated=!1}))},Te=function(){return h(this,void 0,void 0,(function*(){try{const[e]=yield this.viem.requestAddresses();return this.walletAddress=l(e),this.walletAddress}catch(e){throw new T(e)}}))},ve=function(){return h(this,void 0,void 0,(function*(){try{const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/nonce`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({walletAddress:this.walletAddress})}),t=yield e.json();return 200!==e.status?Promise.reject(t.message||"Failed to fetch nonce"):t.data}catch(e){throw new Error(e)}}))},we=function(e,t){return h(this,void 0,void 0,(function*(){try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/verify`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({message:e,signature:t,walletAddress:this.walletAddress})}),i=yield n.json(),a=i.data.split(".")[1],s=JSON.parse(atob(a));return{success:!i.isError,userId:s.id,token:i.data}}catch(e){throw new T(e)}}))},Ae=function(e,t,n){var i,a;const s=(null===(a=null===(i=this.viem)||void 0===i?void 0:i.chain)||void 0===a?void 0:a.id)||m(this,ce,"f")?1:this.environment.CHAIN.id;return c({domain:t||(m(this,ye,"f")?"localhost":window.location.host),address:this.walletAddress,statement:E,uri:n||(m(this,ye,"f")?"http://localhost":window.location.origin),version:"1",chainId:s,nonce:e})};export{Ne as Auth,_e as BrowserStorage,Ee as CustomSignerAdapter,be as EthersSignerAdapter,ke as MemoryStorage,P as SpotifyAPI,M as TwitterAPI,Ie as ViemSignerAdapter,w as campMainnet,v as campTestnet,xe as createNodeWalletClient,Ce as createSignerAdapter};
