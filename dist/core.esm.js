...
/**
     ...
     * ```
     */getRoyalties(e,t){return c(this,void 0,void 0,(function*(){const n=yield h(this,Q,"m",ae).call(this,t);try{const t=yield this.getOrCreateRoyaltyVault(n,!0),i=C();let a,r;if(e&&e!==o){
// erc20 (wrapped camp)
...
/**
     ...
     */setProvider({provider:e,info:i,address:a}){if(!e)throw new m("provider is required");this.viem=((e,i="window.ethereum",a,r)=>{var s,o;if(!e&&!b)return console.warn("Provider is required to create a client."),null;const d=a||g;if(!b||b.transport.name!==i&&e||r!==(null===(s=b.account)||void 0===s?void 0:s.address)&&e||(null==_?void 0:_.id)!==d.id){const a={chain:d,transport:t(e,{name:i})};r&&(a.account=l(r)),b=n(a),_=d,E&&(null===(o=E.chain)||void 0===o?void 0:o.id)!==d.id&&(E=null)}return b})(e,i.name,this.environment.CHAIN,a),this.origin&&this.origin.setViemClient(this.viem),
