 ...
 */
function J(e,t,n,i,r,a,s,o,d){return f(this,void 0,void 0,(function*(){return yield this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"mintWithSignature",[e,t,r,a,s,o,n,i,d],{waitForReceipt:!0})}))}
/**
 ...
 * @returns A promise that resolves when the transaction is complete.
 */function G(e){return this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"finalizeDelete",[e])}
/**
 * Calls the getOrCreateRoyaltyVault method on the IPNFT contract.
 * @param tokenOwner The address of the token owner for whom to get or create the royalty vault.
 * @param simulateOnly If true, simulates the transaction without executing it.
 * @returns The address of the royalty vault associated with the specified token owner.
 */function X(e){return f(this,arguments,void 0,(function*(e,t=!1){const n=yield this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"getOrCreateRoyaltyVault",[e],{waitForReceipt:!0,simulate:t});return t?n:n.simulatedResult}))}
/**
 ...
 */function ee(e){return this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"tokenURI",[e])}
/**
 * Returns the data status of the given token ID.
 * @param tokenId The token ID to query.
 * @returns The data status of the token ID.
 */function te(e){return this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"dataStatus",[e])}
/**
 ...
 */function oe(e,t,n,i,r,a){return this.callContractMethod(this.environment.MARKETPLACE_CONTRACT_ADDRESS,this.environment.MARKETPLACE_ABI,"buyAccess",[e,t,n,i,r],{waitForReceipt:!0,value:a})}
/**
 ...
 */function de(e,t){return f(this,void 0,void 0,(function*(){try{const n=yield this.subscriptionExpiry(t,e);return n>BigInt(Math.floor(Date.now()/1e3))}catch(e){return!1}}))}function ue(e,t){return this.callContractMethod(this.environment.MARKETPLACE_CONTRACT_ADDRESS,this.environment.MARKETPLACE_ABI,"subscriptionExpiry",[e,t])}
/**
 * EXPERIMENTAL METHOD
 ...
 */var le;!function(e){e[e.ACTIVE=0]="ACTIVE",e[e.PENDING_DELETE=1]="PENDING_DELETE",e[e.DELETED=2]="DELETED"}(le||(le={}));
/**
 ...
 */
const ye=(e,t,n,i)=>{if(n<H||n>j)throw new Error(`Royalty basis points must be between ${H} and ${j}`);if(t<B||t>O)throw new Error(`Duration must be between ${B} and ${O} seconds`);if(e<$)throw new Error(`Price must be at least ${$} wei`);return{price:e,duration:t,royaltyBps:n,paymentToken:i}},ce={X402Intent:[{name:"payer",type:"address"},{name:"asset",type:"address"},{name:"amount",type:"uint256"},{name:"httpMethod",type:"string"},{name:"payTo",type:"address"},{name:"tokenId",type:"uint256"},{name:"duration",type:"uint32"},{name:"expiresAt",type:"uint256"},{name:"nonce",type:"bytes32"}]},me=(e,t,n)=>f(void 0,void 0,void 0,(function*(){return yield fetch(`${e.environment.AUTH_HUB_BASE_API}/${e.environment.AUTH_ENDPOINT}/origin/data/${t}`,{method:"GET",headers:Object.assign({"Content-Type":"application/json"},n)})}))
/**
 * EXPERIMENTAL METHOD
 ...
 */function he(e,t,n){return f(this,void 0,void 0,(function*(){var i;const r=this.viemClient;if(!t&&!r)throw new Error("No signer or wallet client provided for X402 intent.");const s=yield me(this,e,{});if(402!==s.status){if(!s.ok)throw new Error("Failed to fetch data");return s.json()}const o=r||I(t),d=r?yield ve.call(this):yield o.getAddress(),u=yield s.json();if(u.error)throw new Error(u.error);const p=u.accepts[0],l=yield fe.call(this,p,a(d),o),y=btoa(JSON.stringify(l)),c=yield me(this,e,{"X-PAYMENT":y});if(402===c.status){
 ...
 */var we,ge,Ae,Ie,be,Ee,Ce,ke,Pe,_e,Se,Ne,xe,Me,De,Fe,Re,Ue,Oe,Be;
/**
 * The Origin class
 * Handles interactions with Origin protocol.
 */class $e{constructor(e,t,n,i){we.add(this),t?this.jwt=t:console.warn("JWT not provided. Some features may be unavailable."),this.viemClient=n,this.environment="string"==typeof e?L[e]:e||L.DEVELOPMENT,this.baseParentId=i,
// DataNFT methods
this.mintWithSignature=J.bind(this),this.registerIpNFT=V.bind(this),this.updateTerms=K.bind(this),this.finalizeDelete=G.bind(this),this.getOrCreateRoyaltyVault=X.bind(this),this.getTerms=Y.bind(this),this.ownerOf=Z.bind(this),this.balanceOf=Q.bind(this),this.tokenURI=ee.bind(this),this.dataStatus=te.bind(this),this.isApprovedForAll=ne.bind(this),this.transferFrom=ie.bind(this),this.safeTransferFrom=re.bind(this),this.approve=ae.bind(this),this.setApprovalForAll=se.bind(this),
// Marketplace methods
this.buyAccess=oe.bind(this),this.hasAccess=de.bind(this),this.subscriptionExpiry=ue.bind(this),this.settlePaymentIntent=pe.bind(this),this.getDataWithIntent=he.bind(this)}getJwt(){return this.jwt}setViemClient(e){this.viemClient=e}
/**
     ...
     */mintFile(e,t,n,i,r){return f(this,void 0,void 0,(function*(){let a,s=null;try{s=yield T(this,we,"m",ke).call(this)}catch(e){throw new Error("Failed to mint file IP. Wallet not connected.")}try{if(a=yield T(this,we,"m",be).call(this,e,r),!a||!a.key)throw new Error("Failed to upload file or get upload info.")}catch(e){throw new Error(`File upload failed: ${e instanceof Error?e.message:String(e)}`)}e.type&&(t.mimetype=e.type);let o=null;(null==r?void 0:r.previewImage)&&(null==r?void 0:r.previewImage.type.startsWith("image/"))?o=yield T(this,we,"m",Ie).call(this,r.previewImage):(null==r?void 0:r.useAssetAsPreview)&&e.type.startsWith("image/")&&(o=yield T(this,we,"m",Ie).call(this,e)),o&&(t.image=`ipfs://${o}`);const d=BigInt(Date.now()+6e5);// 10 minutes from now
let u;this.baseParentId&&(i||(i=[]),i.unshift(this.baseParentId));try{u=yield this.registerIpNFT("file",d,n,t,a.key,i)}catch(e){throw yield T(this,we,"m",Ae).call(this,a.key,"failed"),new Error(`Failed to register IpNFT: ${e instanceof Error?e.message:String(e)}`)}const{tokenId:p,signerAddress:l,creatorContentHash:y,signature:c,uri:m}=u;if(!(p&&l&&y&&void 0!==c&&m))throw new Error("Failed to register IpNFT: Missing required fields in registration response.");try{const e=yield this.mintWithSignature(s,p,i||[],!0,y,m,n,d,c);if(-1===["0x1","success"].indexOf(e.receipt.status))throw yield T(this,we,"m",Ae).call(this,a.key,"failed"),new Error(`Minting failed with status: ${e.receipt.status}`)}catch(e){throw yield T(this,we,"m",Ae).call(this,a.key,"failed"),new Error(`Minting transaction failed: ${e instanceof Error?e.message:String(e)}`)}return p.toString()}))}
/**
     ...
     */mintSocial(e,t,n){return f(this,void 0,void 0,(function*(){let i=null;try{i=yield T(this,we,"m",ke).call(this)}catch(e){throw new Error("Failed to mint social IP. Wallet not connected.")}t.mimetype=`social/${e}`;const r=BigInt(Math.floor(Date.now()/1e3)+600);// 10 minutes from now
...
/**
     ...
     */callContractMethod(e,t,n,i){return f(this,arguments,void 0,(function*(e,t,n,i,r={}){var a;let s=null;try{s=yield T(this,we,"m",ke).call(this)}catch(e){throw new Error("Failed to call contract method. Wallet not connected.")}const o=p({abi:t,name:n});if(o&&"stateMutability"in o&&("view"===o.stateMutability||"pure"===o.stateMutability)){const r=M();return(yield r.readContract({address:e,abi:t,functionName:n,args:i}))||null}yield T(this,we,"m",Ce).call(this,this.environment.CHAIN);const d=M(),{result:u,request:l}=yield d.simulateContract({account:s,address:e,abi:t,functionName:n,args:i,value:r.value});
// simulate
if(r.simulate)return u;try{const e=yield null===(a=this.viemClient)||void 0===a?void 0:a.writeContract(l);if("string"!=typeof e)throw new Error("Transaction failed to send.");if(!r.waitForReceipt)return{txHash:e,simulatedResult:u};return{txHash:e,receipt:yield T(this,we,"m",Ee).call(this,e),simulatedResult:u}}catch(e){throw console.error("Transaction failed:",e),new Error("Transaction failed: "+e)}}))}
/**
     * Buy access to an asset by first checking its price via getTerms, then calling buyAccess.
     * @param {bigint} tokenId The token ID of the asset.
     * @returns {Promise<any>} The result of the buyAccess call.
     */buyAccessSmart(e){return f(this,void 0,void 0,(function*(){let t=null;try{t=yield T(this,we,"m",ke).call(this)}catch(e){throw new Error("Failed to buy access. Wallet not connected.")}const n=yield this.getTerms(e);if(!n)throw new Error("Failed to fetch terms for asset");const{price:i,paymentToken:r,duration:a}=n;if(void 0===i||void 0===r||void 0===a)throw new Error("Terms missing price, paymentToken, or duration");const o=i;return r===s?this.buyAccess(t,e,o,a,r,o):(yield function(e){return f(this,arguments,void 0,(function*({walletClient:e,publicClient:t,tokenAddress:n,owner:i,spender:r,amount:a}){(yield t.readContract({address:n,abi:u,functionName:"allowance",args:[i,r]}))<a&&(yield e.writeContract({address:n,account:i,abi:u,functionName:"approve",args:[r,a],chain:k}))}))}({walletClient:this.viemClient,publicClient:M(),tokenAddress:r,owner:t,spender:this.environment.MARKETPLACE_CONTRACT_ADDRESS,amount:o}),this.buyAccess(t,e,o,a,r))}))}
/**
...
/**
     ...
     * ```
     */getRoyalties(e,t){return f(this,void 0,void 0,(function*(){try{const n=yield this.getTokenBoundAccount(e),i=M();let r,a;if(t&&t!==s){
// erc20 (wrapped camp)
...
/**
     ...
     * ```
     */claimRoyalties(e,t,n){return f(this,void 0,void 0,(function*(){const i=yield T(this,we,"m",Pe).call(this,t),a=yield this.getTokenBoundAccount(e),o=(yield this.getRoyalties(e,n)).balance;if(o===BigInt(0))throw new Error("No royalties available to claim");let d,u,p;
...
/**
     ...
     */
constructor({clientId:e,redirectUri:t,environment:n="DEVELOPMENT",baseParentId:i,storage:r}){if(_e.add(this),Se.set(this,void 0),Ne.set(this,void 0),xe.set(this,void 0),Me.set(this,void 0),!e)throw new Error("clientId is required");if(-1===["PRODUCTION","DEVELOPMENT"].indexOf(n))throw new Error("Invalid environment, must be DEVELOPMENT or PRODUCTION");v(this,Ne,"undefined"==typeof window,"f"),v(this,Me,r||(T(this,Ne,"f")?new E:new b),"f"),this.viem=null,this.environment=L[n],this.baseParentId=i,this.redirectUri=(e=>{const t=["twitter","spotify"];return"object"==typeof e?t.reduce(((t,n)=>(t[n]=e[n]||("undefined"!=typeof window?window.location.href:""),t)),{}):"string"==typeof e?t.reduce(((t,n)=>(t[n]=e,t)),{}):e?{}:t.reduce(((e,t)=>(e[t]="undefined"!=typeof window?window.location.href:"",e)),{})})(t),this.clientId=e,this.isAuthenticated=!1,this.jwt=null,this.origin=null,this.walletAddress=null,this.userId=null,v(this,Se,{},"f"),
// only subscribe to providers in browser environment
T(this,Ne,"f")||W((e=>{T(this,_e,"m",De).call(this,"providers",e)})),T(this,_e,"m",Fe).call(this)}
/**
     ...
     *  console.log(state);
     * });
     */on(e,t){T(this,Se,"f")[e]||(T(this,Se,"f")[e]=[]),T(this,Se,"f")[e].push(t),"providers"===e&&t(q())}
/**
...
/**
     ...
     * @returns {void}
     */setLoading(e){T(this,_e,"m",De).call(this,"state",e?"loading":this.isAuthenticated?"authenticated":"unauthenticated")}
/**
     * Set the provider. This is useful for setting the provider when the user selects a provider from the UI or when dApp wishes to use a specific provider.
     * @param {object} options The options object. Includes the provider and the provider info.
     * @returns {void}
     * @throws {APIError} - Throws an error if the provider is not provided.
     */setProvider({provider:t,info:i,address:r}){if(!t)throw new _("provider is required");this.viem=((t,i="window.ethereum",r,a)=>{var s,o;if(!t&&!S)return console.warn("Provider is required to create a client."),null;const d=r||k;if(!S||S.transport.name!==i&&t||a!==(null===(s=S.account)||void 0===s?void 0:s.address)&&t||(null==x?void 0:x.id)!==d.id){const r={chain:d,transport:n(t,{name:i})};a&&(r.account=c(a)),S=e(r),x=d,N&&(null===(o=N.chain)||void 0===o?void 0:o.id)!==d.id&&(N=null)}return S})(t,i.name,this.environment.CHAIN,r),this.origin&&this.origin.setViemClient(this.viem),
// TODO: only use one of these
T(this,_e,"m",De).call(this,"viem",this.viem),T(this,_e,"m",De).call(this,"provider",{provider:t,info:i}),T(this,Me,"f").setItem("camp-sdk:provider",JSON.stringify(i))}
/**
...
/**
     ...
     */recoverProvider(){return f(this,void 0,void 0,(function*(){var e,t,n,i,r,a,s,o,d,u,p,l,y;if(!this.walletAddress)return void console.warn("No wallet address found in local storage. Please connect your wallet again.");const c=yield T(this,Me,"f").getItem("camp-sdk:provider");if(!c)return;const m=JSON.parse(c);let h;const f=null!==(e=q())&&void 0!==e?e:[];
...
/**
     * Disconnect the user.
     * @returns {Promise<void>}
     */disconnect(){return f(this,void 0,void 0,(function*(){this.isAuthenticated&&(T(this,_e,"m",De).call(this,"state","unauthenticated"),this.isAuthenticated=!1,this.walletAddress=null,this.userId=null,this.jwt=null,this.origin=null,v(this,xe,void 0,"f"),yield T(this,Me,"f").removeItem("camp-sdk:wallet-address"),yield T(this,Me,"f").removeItem("camp-sdk:user-id"),yield T(this,Me,"f").removeItem("camp-sdk:jwt"),yield T(this,Me,"f").removeItem("camp-sdk:environment"))}))}
/**
     * Connect the user's wallet and sign the message.
     * @returns {Promise<{ success: boolean; message: string; walletAddress: string }>} A promise that resolves with the authentication result.
     * @throws {APIError} - Throws an error if the user cannot be authenticated.
     */connect(){return f(this,void 0,void 0,(function*(){T(this,_e,"m",De).call(this,"state","loading");try{this.walletAddress||(yield T(this,_e,"m",Re).call(this)),this.walletAddress=a(this.walletAddress);const e=yield T(this,_e,"m",Ue).call(this),t=T(this,_e,"m",Be).call(this,e),n=yield this.viem.signMessage({account:this.walletAddress,message:t}),i=yield T(this,_e,"m",Oe).call(this,t,n);if(i.success)return this.isAuthenticated=!0,this.userId=i.userId,this.jwt=i.token,this.origin=new $e(this.environment,this.jwt,this.viem,this.baseParentId),yield T(this,Me,"f").setItem("camp-sdk:jwt",this.jwt),yield T(this,Me,"f").setItem("camp-sdk:wallet-address",this.walletAddress),yield T(this,Me,"f").setItem("camp-sdk:user-id",this.userId),yield T(this,Me,"f").setItem("camp-sdk:environment",this.environment.NAME),T(this,_e,"m",De).call(this,"state","authenticated"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,T(this,_e,"m",De).call(this,"state","unauthenticated"),new _("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,T(this,_e,"m",De).call(this,"state","unauthenticated"),new _(e)}}))}
/**
     ...
     */connectWithSigner(e,t){return f(this,void 0,void 0,(function*(){T(this,_e,"m",De).call(this,"state","loading");try{v(this,xe,I(e),"f"),this.walletAddress=a(yield T(this,xe,"f").getAddress()),
// store the signer as viem client if it's a viem client, otherwise keep adapter
"viem"===T(this,xe,"f").type&&(this.viem=e);const n=yield T(this,_e,"m",Ue).call(this),i=T(this,_e,"m",Be).call(this,n,null==t?void 0:t.domain,null==t?void 0:t.uri),r=yield T(this,xe,"f").signMessage(i),s=yield T(this,_e,"m",Oe).call(this,i,r);if(s.success)return this.isAuthenticated=!0,this.userId=s.userId,this.jwt=s.token,this.origin=new $e(this.environment,this.jwt,this.viem,this.baseParentId),yield T(this,Me,"f").setItem("camp-sdk:jwt",this.jwt),yield T(this,Me,"f").setItem("camp-sdk:wallet-address",this.walletAddress),yield T(this,Me,"f").setItem("camp-sdk:user-id",this.userId),yield T(this,Me,"f").setItem("camp-sdk:environment",this.environment.NAME),T(this,_e,"m",De).call(this,"state","authenticated"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,T(this,_e,"m",De).call(this,"state","unauthenticated"),new _("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,v(this,xe,void 0,"f"),T(this,_e,"m",De).call(this,"state","unauthenticated"),new _(e)}}))}
/**
     ...
     * console.log(socials);
     */getLinkedSocials(){return f(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/connections-sdk`,{method:"GET",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"}}).then((e=>e.json()));if(e.isError)throw new _(e.message||"Failed to fetch connections");{const t={};return Object.keys(e.data.data).forEach((n=>{t[n.split("User")[0]]=e.data.data[n]})),t}}))}
/**
...
/**
     ...
     * @throws {Error|APIError} - Throws an error if the user is not authenticated.
     */sendTelegramOTP(e){return f(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(!e)throw new _("Phone number is required");yield this.unlinkTelegram();const t=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/telegram/sendOTP-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({phone:e})}).then((e=>e.json()));if(t.isError)throw new _(t.message||"Failed to send Telegram OTP");return t.data}))}
/**
...
/**
     ...
     * @throws {Error} - Throws an error if the user is not authenticated.
     * @throws {APIError} - Throws an error if the request fails.
     */unlinkDiscord(){return f(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new _("User needs to be authenticated");const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/discord/disconnect-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({id:this.userId})}).then((e=>e.json()));if(e.isError)throw new _(e.message||"Failed to unlink Discord account");return e.data}))}
/**
     * Unlink the user's Spotify account.
     * @returns {Promise<any>} A promise that resolves with the unlink result.
     * @throws {Error} - Throws an error if the user is not authenticated.
     * @throws {APIError} - Throws an error if the request fails.
     */unlinkSpotify(){return f(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new _("User needs to be authenticated");const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/spotify/disconnect-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({id:this.userId})}).then((e=>e.json()));if(e.isError)throw new _(e.message||"Failed to unlink Spotify account");return e.data}))}
/**
     * Unlink the user's TikTok account.
     * @returns {Promise<any>} A promise that resolves with the unlink result.
     * @throws {Error} - Throws an error if the user is not authenticated.
     * @throws {APIError} - Throws an error if the request fails.
     */unlinkTikTok(){return f(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new _("User needs to be authenticated");const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/tiktok/disconnect-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({userId:this.userId})}).then((e=>e.json()));if(e.isError)throw new _(e.message||"Failed to unlink TikTok account");return e.data}))}
/**
     * Unlink the user's Telegram account.
     * @returns {Promise<any>} A promise that resolves with the unlink result.
     * @throws {Error} - Throws an error if the user is not authenticated.
     * @throws {APIError} - Throws an error if the request fails.
     */unlinkTelegram(){return f(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new _("User needs to be authenticated");const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/telegram/disconnect-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({userId:this.userId})}).then((e=>e.json()));if(e.isError)throw new _(e.message||"Failed to unlink Telegram account");return e.data}))}}Se=new WeakMap,Ne=new WeakMap,xe=new WeakMap,Me=new WeakMap,_e=new WeakSet,De=function(e,t){T(this,Se,"f")[e]&&T(this,Se,"f")[e].forEach((e=>e(t)))},Fe=function(e){return f(this,void 0,void 0,(function*(){const t=yield T(this,Me,"f").getItem("camp-sdk:wallet-address"),n=yield T(this,Me,"f").getItem("camp-sdk:user-id"),i=yield T(this,Me,"f").getItem("camp-sdk:jwt"),r=yield T(this,Me,"f").getItem("camp-sdk:environment");t&&n&&i&&(r===this.environment.NAME||!r)?(this.walletAddress=t,this.userId=n,this.jwt=i,this.origin=new $e(this.environment,this.jwt,this.viem,this.baseParentId),this.isAuthenticated=!0,e?this.setProvider({provider:e.provider,info:e.info||{name:"Unknown"},address:t}):T(this,Ne,"f")||(console.warn("No matching provider was given for the stored wallet address. Trying to recover provider."),yield this.recoverProvider())):this.isAuthenticated=!1}))},Re=function(){return f(this,void 0,void 0,(function*(){try{const[e]=yield this.viem.requestAddresses();return this.walletAddress=a(e),this.walletAddress}catch(e){throw new _(e)}}))},Ue=function(){return f(this,void 0,void 0,(function*(){try{const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/nonce`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({walletAddress:this.walletAddress})}),t=yield e.json();return 200!==e.status?Promise.reject(t.message||"Failed to fetch nonce"):t.data}catch(e){throw new Error(e)}}))},Oe=function(e,t){return f(this,void 0,void 0,(function*(){try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/verify`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({message:e,signature:t,walletAddress:this.walletAddress})}),i=yield n.json(),r=i.data.split(".")[1],a=JSON.parse(atob(r));return{success:!i.isError,userId:a.id,token:i.data}}catch(e){throw new _(e)}}))},Be=function(e,t,n){return m({domain:t||(T(this,Ne,"f")?"localhost":window.location.host),address:this.walletAddress,statement:U,uri:n||(T(this,Ne,"f")?"http://localhost":window.location.origin),version:"1",chainId:this.environment.CHAIN.id,nonce:e})};export{He as Auth,b as BrowserStorage,A as CustomSignerAdapter,le as DataStatus,g as EthersSignerAdapter,E as MemoryStorage,$e as Origin,w as ViemSignerAdapter,P as campMainnet,k as campTestnet,ye as createLicenseTerms,C as createNodeWalletClient,I as createSignerAdapter};
