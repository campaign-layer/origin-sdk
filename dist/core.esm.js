import t from"axios";import{custom as e,createWalletClient as n,createPublicClient as i,http as a,erc20Abi as s,getAbiItem as r,encodeFunctionData as o,zeroAddress as d}from"viem";import{toAccount as u}from"viem/accounts";import{createSiweMessage as l}from"viem/siwe";
/******************************************************************************
 ...
 */function U(t,e,n,i,a,s,r){return p(this,void 0,void 0,(function*(){return yield this.callContractMethod(x,j,"mintWithSignature",[t,e,n,i,a,s,r.v,r.r,r.s],{waitForReceipt:!0})}))}
/**
 ...
 */
class wt{constructor(e,n){Q.add(this),Y.set(this,(t=>p(this,void 0,void 0,(function*(){const e=yield fetch(`${M}/auth/origin/upload-url`,{method:"POST",body:JSON.stringify({name:t.name,type:t.type}),headers:{Authorization:`Bearer ${this.jwt}`}}),n=yield e.json();return n.isError?n.message:n.data})))),X.set(this,((t,e)=>p(this,void 0,void 0,(function*(){(yield fetch(`${M}/auth/origin/update-status`,{method:"PATCH",body:JSON.stringify({status:e,fileKey:t}),headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}})).ok||console.error("Failed to update origin status")})))),this.uploadFile=(e,n)=>p(this,void 0,void 0,(function*(){const i=yield c(this,Y,"f").call(this,e);if(i){try{yield((e,n,i)=>new Promise(((a,s)=>{t.put(n,e,Object.assign({headers:{"Content-Type":e.type}},"undefined"!=typeof window&&"function"==typeof i?{onUploadProgress:t=>{if(t.total){const e=t.loaded/t.total*100;i(e)}}}:{})).then((t=>{a(t.data)})).catch((t=>{var e;const n=(null===(e=null==t?void 0:t.response)||void 0===e?void 0:e.data)||(null==t?void 0:t.message)||"Upload failed";s(n)}))})))(e,i.url,(null==n?void 0:n.progressCallback)||(()=>{}))}catch(t){throw yield c(this,X,"f").call(this,i.key,"failed"),new Error("Failed to upload file: "+t)}return yield c(this,X,"f").call(this,i.key,"success"),i}console.error("Failed to generate upload URL")})),this.mintFile=(t,e,n)=>p(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected.");console.log(this.viemClient);try{const i=yield this.uploadFile(t,n);if(console.log("Upload info:",i),!i||!i.key)return console.error("Invalid upload info:",i),null;const a=BigInt(Math.floor(Date.now()/1e3)+600),s=yield this.registerDataNFT("file",a,i.key);// 10 minutes from now
console.log("Registration data:",s);const{tokenId:r,signerAddress:o,hash:d,v:u,r:l,s:p}=s;if(!r||!o||!d||void 0===u||void 0===l||void 0===p)return console.error("Invalid registration data:",s),null;const[c]=yield this.viemClient.request({method:"eth_requestAccounts",params:[]});console.log("Account:",c);const y={v:u,r:l,s:p},h=yield this.mintWithSignature(c,r,d,i.url,e,a,y);return console.log("Mint result:",h),r.toString()}catch(t){return console.error("Failed to upload file:",t),null}})),this.mintSocial=t=>p(this,void 0,void 0,(function*(){try{const e=BigInt(Math.floor(Date.now()/1e3)+600),n=yield this.registerDataNFT(t,e);// 10 minutes from now (temp)
...
/**
     ...
     */callContractMethod(t,e,n,i){return p(this,arguments,void 0,(function*(t,e,n,i,a={}){const s=r({abi:e,name:n}),d=s&&"stateMutability"in s&&("view"===s.stateMutability||"pure"===s.stateMutability);if(!d&&!this.viemClient)throw new Error("WalletClient not connected.");if(d){const a=A();return(yield a.readContract({address:t,abi:e,functionName:n,args:i}))||null}{const[s]=yield this.viemClient.request({method:"eth_requestAccounts",params:[]}),r=o({abi:e,functionName:n,args:i});yield c(this,Q,"m",et).call(this,g);const d=yield this.viemClient.sendTransaction({to:t,data:r,account:s,value:a.value,gas:a.gas});if("string"!=typeof d)throw new Error("Transaction failed to send.");if(!a.waitForReceipt)return d;return yield c(this,Q,"m",tt).call(this,d)}}))}
/**
     * Buy access to an asset by first checking its price via getTerms, then calling buyAccess.
     * @param {bigint} tokenId The token ID of the asset.
     * @param {number} periods The number of periods to buy access for.
     * @returns {Promise<any>} The result of the buyAccess call.
     */buyAccessSmart(t,e){return p(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected.");const n=yield this.getTerms(t);if(!n)throw new Error("Failed to fetch terms for asset");const{price:i,paymentToken:a}=n;if(void 0===i||void 0===a)throw new Error("Terms missing price or paymentToken");const r=i*BigInt(e);if(a===d)return this.buyAccess(t,e,r);const o=yield this.viemClient.getAddress();return yield function(t){return p(this,arguments,void 0,(function*({walletClient:t,publicClient:e,tokenAddress:n,owner:i,spender:a,amount:r}){(yield e.readContract({address:n,abi:s,functionName:"allowance",args:[i,a]}))<r&&(yield t.writeContract({address:n,account:i,abi:s,functionName:"approve",args:[a,r],chain:g}))}))}({walletClient:this.viemClient,publicClient:A(),tokenAddress:a,owner:o,spender:S,amount:r}),this.buyAccess(t,e)}))}getData(t){return p(this,void 0,void 0,(function*(){const e=yield fetch(`${M}/auth/origin/data/${t}`,{method:"GET",headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!e.ok)throw new Error("Failed to fetch data");return e.json()}))}}Y=new WeakMap,X=new WeakMap,Q=new WeakSet,tt=function(t){return p(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected.");for(;;){const e=yield this.viemClient.request({method:"eth_getTransactionReceipt",params:[t]});if(e&&e.blockNumber)return e;yield new Promise((t=>setTimeout(t,1e3)))}}))},et=function(t){return p(this,void 0,void 0,(function*(){
// return;
...
// }
this.redirectUri=(t=>{const e=["twitter","discord","spotify"];return"object"==typeof t?e.reduce(((e,n)=>(e[n]=t[n]||("undefined"!=typeof window?window.location.href:""),e)),{}):"string"==typeof t?e.reduce(((e,n)=>(e[n]=t,e)),{}):t?{}:e.reduce(((t,e)=>(t[e]="undefined"!=typeof window?window.location.href:"",t)),{})})(e),i&&y(this,at,i,"f"),n&&c(this,at,"f"),this.clientId=t,this.isAuthenticated=!1,this.jwt=null,this.origin=null,this.walletAddress=null,this.userId=null,y(this,it,{},"f"),F((t=>{c(this,nt,"m",st).call(this,"providers",t)})),c(this,nt,"m",rt).call(this)}
/**
...
/**
     ...
     * @returns {void}
     */setLoading(t){c(this,nt,"m",st).call(this,"state",t?"loading":this.isAuthenticated?"authenticated":"unauthenticated")}
/**
     * Set the provider. This is useful for setting the provider when the user selects a provider from the UI or when dApp wishes to use a specific provider.
     * @param {object} options The options object. Includes the provider and the provider info.
     * @returns {void}
     * @throws {APIError} - Throws an error if the provider is not provided.
     */setProvider({provider:t,info:i,address:a}){if(!t)throw new h("provider is required");this.viem=((t,i="window.ethereum",a)=>{var s;if(!t&&!I)return console.warn("Provider is required to create a client."),null;if(!I||I.transport.name!==i&&t||a!==(null===(s=I.account)||void 0===s?void 0:s.address)&&t){const s={chain:g,transport:e(t,{name:i})};a&&(s.account=u(a)),I=n(s)}return I})(t,i.name,a),this.origin&&this.origin.setViemClient(this.viem),c(this,nt,"m",st).call(this,"viem",this.viem),c(this,nt,"m",st).call(this,"provider",{provider:t,info:i})}
/**
...
/**
     * Disconnect the user.
     * @returns {Promise<void>}
     */disconnect(){return p(this,void 0,void 0,(function*(){this.isAuthenticated&&(c(this,nt,"m",st).call(this,"state","unauthenticated"),this.isAuthenticated=!1,this.walletAddress=null,this.userId=null,this.jwt=null,this.origin=null,localStorage.removeItem("camp-sdk:wallet-address"),localStorage.removeItem("camp-sdk:user-id"),localStorage.removeItem("camp-sdk:jwt"))}))}
/**
     * Connect the user's wallet and sign the message.
     * @returns {Promise<{ success: boolean; message: string; walletAddress: string }>} A promise that resolves with the authentication result.
     * @throws {APIError} - Throws an error if the user cannot be authenticated.
     */connect(){return p(this,void 0,void 0,(function*(){c(this,nt,"m",st).call(this,"state","loading");try{this.walletAddress||(yield c(this,nt,"m",ot).call(this));const t=yield c(this,nt,"m",dt).call(this),e=c(this,nt,"m",lt).call(this,t),n=yield this.viem.signMessage({account:this.walletAddress,message:e}),i=yield c(this,nt,"m",ut).call(this,e,n);if(i.success)return this.isAuthenticated=!0,this.userId=i.userId,this.jwt=i.token,this.origin=new wt(this.jwt,this.viem),localStorage.setItem("camp-sdk:jwt",this.jwt),localStorage.setItem("camp-sdk:wallet-address",this.walletAddress),localStorage.setItem("camp-sdk:user-id",this.userId),c(this,nt,"m",st).call(this,"state","authenticated"),yield c(this,nt,"m",pt).call(this,E.USER_CONNECTED,"User Connected"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,c(this,nt,"m",st).call(this,"state","unauthenticated"),new h("Failed to authenticate")}catch(t){throw this.isAuthenticated=!1,c(this,nt,"m",st).call(this,"state","unauthenticated"),new h(t)}}))}
/**
...
/**
     ...
     * @throws {Error} - Throws an error if the user is not authenticated.
     * @throws {APIError} - Throws an error if the request fails.
     */unlinkTelegram(){return p(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new h("User needs to be authenticated");const t=yield fetch(`${M}/telegram/disconnect-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({userId:this.userId})}).then((t=>t.json()));if(t.isError)throw new h(t.message||"Failed to unlink Telegram account");return t.data}))}}it=new WeakMap,at=new WeakMap,nt=new WeakSet,st=function(t,e){c(this,it,"f")[t]&&c(this,it,"f")[t].forEach((t=>t(e)))},rt=function(t){return p(this,void 0,void 0,(function*(){var e,n;if("undefined"==typeof localStorage)return;const i=null===localStorage||void 0===localStorage?void 0:localStorage.getItem("camp-sdk:wallet-address"),a=null===localStorage||void 0===localStorage?void 0:localStorage.getItem("camp-sdk:user-id"),s=null===localStorage||void 0===localStorage?void 0:localStorage.getItem("camp-sdk:jwt");if(i&&a&&s){this.walletAddress=i,this.userId=a,this.jwt=s,this.origin=new wt(this.jwt),this.isAuthenticated=!0;let r=t;if(!r){const t=null!==(e=D())&&void 0!==e?e:[];for(const e of t)try{if((null===(n=(yield e.provider.request({method:"eth_requestAccounts"}))[0])||void 0===n?void 0:n.toLowerCase())===i.toLowerCase()){r=e;break}}catch(t){console.warn("Failed to fetch accounts from provider:",t)}}r?this.setProvider({provider:r.provider,info:r.info||{name:"Unknown"},address:i}):
// await this.disconnect();
console.warn("No matching provider found for the stored wallet address. User disconnected.")}else this.isAuthenticated=!1}))},ot=function(){return p(this,void 0,void 0,(function*(){try{const[t]=yield this.viem.requestAddresses();return this.walletAddress=t,t}catch(t){throw new h(t)}}))},dt=function(){return p(this,void 0,void 0,(function*(){try{const t=yield fetch(`${M}/auth/client-user/nonce`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({walletAddress:this.walletAddress})}),e=yield t.json();return 200!==t.status?Promise.reject(e.message||"Failed to fetch nonce"):e.data}catch(t){throw new Error(t)}}))},ut=function(t,e){return p(this,void 0,void 0,(function*(){try{const n=yield fetch(`${M}/auth/client-user/verify`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({message:t,signature:e,walletAddress:this.walletAddress})}),i=yield n.json(),a=i.data.split(".")[1],s=JSON.parse(atob(a));return{success:!i.isError,userId:s.id,token:i.data}}catch(t){throw new h(t)}}))},lt=function(t){return l({domain:window.location.host,address:this.walletAddress,statement:C,uri:window.location.origin,version:"1",chainId:this.viem.chain.id,nonce:t})},pt=function(t,e){return p(this,arguments,void 0,(function*(t,e,n=1){
