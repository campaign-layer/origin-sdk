 ...
 * );
 * ```
 */function xe(e,t,n){return T(this,void 0,void 0,(function*(){return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"raiseDispute",[e,t,n],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function Be(e){return T(this,void 0,void 0,(function*(){return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"resolveDispute",[e],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function Fe(e){return T(this,void 0,void 0,(function*(){return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"cancelDispute",[e],{waitForReceipt:!0})}))}
/**
 ...
 * }
 * ```
 */function Le(e){return T(this,void 0,void 0,(function*(){var t,n,i,a,s,r,o,d,u;const p=F(),l=this.environment.DISPUTE_CONTRACT_ADDRESS,y=this.environment.DISPUTE_ABI,[c,m,h,T]=yield Promise.all([p.readContract({address:l,abi:y,functionName:"disputes",args:[e]}),p.readContract({address:l,abi:y,functionName:"disputeQuorum",args:[]}),p.readContract({address:l,abi:y,functionName:"disputeCoolDownPeriod",args:[]}),p.readContract({address:l,abi:y,functionName:"disputeJudgementPeriod",args:[]})]),f=Number(null!==(t=c.status)&&void 0!==t?t:c[9]),v=BigInt(null!==(i=null!==(n=c.disputeTimestamp)&&void 0!==n?n:c[5])&&void 0!==i?i:0),A=BigInt(null!==(s=null!==(a=c.assertionTimestamp)&&void 0!==a?a:c[6])&&void 0!==s?s:0),w=BigInt(null!==(o=null!==(r=c.yesVotes)&&void 0!==r?r:c[7])&&void 0!==o?o:0),I=BigInt(null!==(u=null!==(d=c.noVotes)&&void 0!==d?d:c[8])&&void 0!==u?u:0),g=w+I;let b=0,C=0;g>BigInt(0)&&(b=Number(w*BigInt(1e4)/g)/100,C=Number(I*BigInt(1e4)/g)/100);
...
// calculate timeline
const P=BigInt(Math.floor(Date.now()/1e3)),R=new Date(1e3*Number(v)),D=new Date(1e3*Number(v+h));let N,k;f===Ee.Asserted?(
...
N=new Date(1e3*Number(v+h+T)),k=v+h+T);const x=(f===Ee.Raised||f===Ee.Asserted)&&P>k,M=x?0:Number(k-P);return{disputeId:e,status:f,yesVotes:w,noVotes:I,totalVotes:g,yesPercentage:b,noPercentage:C,quorum:m,quorumPercentage:E,quorumMet:S,projectedOutcome:_,timeline:{raisedAt:R,cooldownEndsAt:D,votingEndsAt:N,canResolveNow:x,timeUntilResolution:M}}}))}
/**
...
const n=yield ge(this.viemClient),i=[{inputs:[{name:"owner",type:"address"}],name:"balanceOf",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"},{inputs:[],name:"totalSupply",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"}],a=F(),[s,r]=yield Promise.all([a.readContract({address:t,abi:i,functionName:"balanceOf",args:[n]}),a.readContract({address:t,abi:i,functionName:"totalSupply",args:[]})]);
...
const d=F();for(const e of o)yield Xe({walletClient:n,publicClient:d,tokenAddress:e.token,owner:i,spender:this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,amount:e.amount});
...
this.raiseDispute=xe.bind(this),this.disputeAssertion=Me.bind(this),this.voteOnDispute=Oe.bind(this),this.resolveDispute=Be.bind(this),this.cancelDispute=Fe.bind(this),this.tagChildIp=Ue.bind(this),this.getDispute=$e.bind(this),this.canVoteOnDispute=je.bind(this),this.getDisputeProgress=Le.bind(this),
...
/**
     ...
     */callContractMethod(e,t,n,i){return T(this,arguments,void 0,(function*(e,t,n,i,a={}){var s;let r=null;try{r=yield f(this,st,"m",yt).call(this)}catch(t){throw new N(`Cannot call "${n}" on contract ${e}: wallet not connected`)}const o=p({abi:t,name:n});if(o&&"stateMutability"in o&&("view"===o.stateMutability||"pure"===o.stateMutability)){const a=F();return(yield a.readContract({address:e,abi:t,functionName:n,args:i}))||null}yield f(this,st,"m",lt).call(this,this.environment.CHAIN);const d=F(),{result:u,request:l}=yield d.simulateContract({account:r,address:e,abi:t,functionName:n,args:i,value:a.value});
// simulate
if(a.simulate)return u;try{const t=yield null===(s=this.viemClient)||void 0===s?void 0:s.writeContract(l);if("string"!=typeof t)throw new k(`Transaction for "${n}" failed to send: no transaction hash returned`,{contractName:e,methodName:n});if(!a.waitForReceipt)return{txHash:t,simulatedResult:u};return{txHash:t,receipt:yield f(this,st,"m",pt).call(this,t),simulatedResult:u}}catch(t){if(t instanceof k||t instanceof N)throw t;throw new k(`Transaction for "${n}" failed: ${x(t)}`,{contractName:e,methodName:n})}}))}
/**
...
return a===r?this.buyAccess(t,e,u,s,a,o,d,u):(yield Xe({walletClient:this.viemClient,publicClient:F(),tokenAddress:a,owner:t,spender:this.environment.MARKETPLACE_CONTRACT_ADDRESS,amount:u}),this.buyAccess(t,e,u,s,a,o,d))}))}
/**
...
/**
     ...
     * ```
     */getRoyalties(e,t){return T(this,void 0,void 0,(function*(){try{const n=yield this.getTokenBoundAccount(e),i=F();let a,s;if(t&&t!==r){
// erc20 (wrapped camp)
...
/**
     ...
     */setProvider({provider:t,info:i,address:a}){if(!t)throw new P("provider is required");this.viem=((t,i="window.ethereum",a,s)=>{var r,o;if(!t&&!M)return console.warn("Provider is required to create a client."),null;const d=a||S;if(!M||M.transport.name!==i&&t||s!==(null===(r=M.account)||void 0===r?void 0:r.address)&&t||(null==B?void 0:B.id)!==d.id){const a={chain:d,transport:n(t,{name:i})};s&&(a.account=c(s)),M=e(a),B=d,O&&(null===(o=O.chain)||void 0===o?void 0:o.id)!==d.id&&(O=null)}return M})(t,i.name,this.environment.CHAIN,a),this.origin&&this.origin.setViemClient(this.viem),
...
/**
     ...
     * @throws {Error} - Throws an error if the user is not authenticated.
     * @throws {APIError} - Throws an error if the request fails.
     */unlinkTelegram(){return T(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new D("User must be authenticated to unlink Telegram account");const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/telegram/disconnect-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({userId:this.userId})}).then((e=>e.json()));if(e.isError)throw new P(e.message||"Failed to unlink Telegram account");return e.data}))}}ft=new WeakMap,vt=new WeakMap,At=new WeakMap,wt=new WeakMap,Tt=new WeakSet,It=function(e,t){f(this,ft,"f")[e]&&f(this,ft,"f")[e].forEach((e=>e(t)))},gt=function(e){return T(this,void 0,void 0,(function*(){const t=yield f(this,wt,"f").getItem("camp-sdk:wallet-address"),n=yield f(this,wt,"f").getItem("camp-sdk:user-id"),i=yield f(this,wt,"f").getItem("camp-sdk:jwt"),a=yield f(this,wt,"f").getItem("camp-sdk:environment");t&&n&&i&&(a===this.environment.NAME||!a)?(this.walletAddress=t,this.userId=n,this.jwt=i,this.origin=new _t(this.environment,this.jwt,this.viem,this.baseParentId,this.clientId),this.isAuthenticated=!0,e?this.setProvider({provider:e.provider,info:e.info||{name:"Unknown"},address:t}):f(this,vt,"f")||(console.warn("No matching provider was given for the stored wallet address. Trying to recover provider."),yield this.recoverProvider())):this.isAuthenticated=!1}))},bt=function(){return T(this,void 0,void 0,(function*(){try{const[e]=yield this.viem.requestAddresses();return this.walletAddress=s(e),this.walletAddress}catch(e){throw new N(`Failed to connect wallet: ${x(e)}`)}}))},Ct=function(){return T(this,void 0,void 0,(function*(){try{const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/nonce`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({walletAddress:this.walletAddress})}),t=yield e.json();if(200!==e.status)throw new P(t.message||`Failed to fetch nonce (HTTP ${e.status})`,e.status);return t.data}catch(e){if(e instanceof P)throw e;throw new P(`Failed to fetch nonce: ${x(e)}`)}}))},Et=function(e,t){return T(this,void 0,void 0,(function*(){try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/verify`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({message:e,signature:t,walletAddress:this.walletAddress})}),i=yield n.json(),a=i.data.split(".")[1],s=JSON.parse(atob(a));return{success:!i.isError,userId:s.id,token:i.data}}catch(e){throw new P(`Failed to verify signature: ${x(e)}`)}}))},St=function(e,t,n){return m({domain:t||(f(this,vt,"f")?"localhost":window.location.host),address:this.walletAddress,statement:q,uri:n||(f(this,vt,"f")?"http://localhost":window.location.origin),version:"1",chainId:this.environment.CHAIN.id,nonce:e})};export{Pt as Auth,b as BrowserStorage,I as CustomSignerAdapter,Ce as DataStatus,Ee as DisputeStatus,w as EthersSignerAdapter,be as LicenseType,C as MemoryStorage,_t as Origin,A as ViemSignerAdapter,_ as campMainnet,S as campTestnet,Se as createLicenseTerms,E as createNodeWalletClient,g as createSignerAdapter};
