 ...
 */function re(e){return this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"dataStatus",[e])}
/**
 ...
 */function le(e,t,n,i,a,r=0,s=0,o){return this.callContractMethod(this.environment.MARKETPLACE_CONTRACT_ADDRESS,this.environment.MARKETPLACE_ABI,"buyAccess",[e,t,n,i,a,r,s],{waitForReceipt:!0,value:o})}
/**
 ...
 */var fe,ve,Ae;!function(e){e[e.DURATION_BASED=0]="DURATION_BASED",e[e.SINGLE_PAYMENT=1]="SINGLE_PAYMENT",e[e.X402=2]="X402"}(fe||(fe={})),function(e){e[e.ACTIVE=0]="ACTIVE",e[e.DELETED=1]="DELETED",e[e.DISPUTED=2]="DISPUTED"}(ve||(ve={})),function(e){e[e.Uninitialized=0]="Uninitialized",e[e.Raised=1]="Raised",e[e.Asserted=2]="Asserted",e[e.Resolved=3]="Resolved",e[e.Cancelled=4]="Cancelled"}(Ae||(Ae={}));
/**
 ...
 */
const we=(e,t,n,i,a=fe.DURATION_BASED)=>{if(n<q||n>V)throw new Error(`Royalty basis points must be between ${q} and ${V}`);if(a===fe.DURATION_BASED){if(t<L||t>$)throw new Error(`Duration must be between ${L} and ${$} seconds for DURATION_BASED licenses`)}else if((a===fe.SINGLE_PAYMENT||a===fe.X402)&&t>0)throw new Error(`Duration must be 0 for ${fe[a]} licenses`);if(e<z)throw new Error(`Price must be at least ${z} wei`);return{price:e,duration:t,royaltyBps:n,paymentToken:i,licenseType:a}},Ie={X402Intent:[{name:"payer",type:"address"},{name:"asset",type:"address"},{name:"amount",type:"uint256"},{name:"httpMethod",type:"string"},{name:"payTo",type:"address"},{name:"tokenId",type:"uint256"},{name:"duration",type:"uint32"},{name:"expiresAt",type:"uint256"},{name:"nonce",type:"bytes32"}]},ge=(e,t,n)=>T(void 0,void 0,void 0,(function*(){return yield fetch(`${e.environment.AUTH_HUB_BASE_API}/${e.environment.AUTH_ENDPOINT}/origin/data/${t}`,{method:"GET",headers:Object.assign({"Content-Type":"application/json"},n)})}))
/**
 * EXPERIMENTAL METHOD
 ...
 */function be(e,t,n){return T(this,void 0,void 0,(function*(){var i;const a=this.viemClient;if(!t&&!a)throw new Error("No signer or wallet client provided for X402 intent.");const s=yield ge(this,e,{});if(402!==s.status){if(!s.ok)throw new Error("Failed to fetch data");return s.json()}const o=a||g(t),d=a?yield _e.call(this):yield o.getAddress(),u=yield s.json();if(u.error)throw new Error(u.error);const p=u.accepts[0],l=yield Ee.call(this,p,r(d),o),y=btoa(JSON.stringify(l)),c=yield ge(this,e,{"X-PAYMENT":y});if(402===c.status){
 ...
 * ```
 */function Re(e,t){return T(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"disputeAssertion",[e,t],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function De(e,t){return T(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"voteOnDispute",[e,t],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function Pe(e){return T(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"resolveDispute",[e],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function Ne(e){return T(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"cancelDispute",[e],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function xe(e,t){return T(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"tagChildIp",[e,t],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function ke(e){return T(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"disputes",[e])}))}
 ...
 * }
 * ```
 */function Me(e,t){return T(this,void 0,void 0,(function*(){var n,i,a,r,s;if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");
// Resolve voter address
let o;if(t)o=t;else{const e=this.viemClient;if(!e)throw new Error("No voter address provided and no wallet connected");if(e.account)o=e.account.address;else{const t=yield e.request({method:"eth_requestAccounts",params:[]});if(!t||0===t.length)throw new Error("No accounts found in connected wallet");o=t[0]}}const d=x(),u=this.environment.DISPUTE_CONTRACT_ADDRESS,p=this.environment.DISPUTE_ABI,[l,y,c,m,h,T]=yield Promise.all([d.readContract({address:u,abi:p,functionName:"disputes",args:[e]}),d.readContract({address:u,abi:p,functionName:"stakingVault",args:[]}),d.readContract({address:u,abi:p,functionName:"stakingThreshold",args:[]}),d.readContract({address:u,abi:p,functionName:"disputeCoolDownPeriod",args:[]}),d.readContract({address:u,abi:p,functionName:"disputeJudgementPeriod",args:[]}),d.readContract({address:u,abi:p,functionName:"hasVoted",args:[e,o]})]),f=Number(null!==(n=l.status)&&void 0!==n?n:l[9]),v=BigInt(null!==(a=null!==(i=l.disputeTimestamp)&&void 0!==i?i:l[5])&&void 0!==a?a:0),A=BigInt(null!==(s=null!==(r=l.assertionTimestamp)&&void 0!==r?r:l[6])&&void 0!==s?s:0),[w,I]=yield Promise.all([d.readContract({address:y,abi:Oe,functionName:"userStakeTimestamp",args:[o]}),d.readContract({address:y,abi:Oe,functionName:"balanceOf",args:[o]})]),g=BigInt(Math.floor(Date.now()/1e3));let b,E=!1;f===Ae.Asserted?(
// For asserted disputes, voting period is relative to assertion timestamp
b=A+h,E=g<=b):f===Ae.Raised&&(
// For raised disputes, voting period extends from cooldown through judgement
b=v+m+h,E=g<=b);
// Build base result
const C={canVote:!1,votingWeight:I,stakingThreshold:c,hasAlreadyVoted:T,userStakeTimestamp:w,disputeTimestamp:v,disputeStatus:f,isVotingPeriodActive:E};
// Check all requirements in order
return f!==Ae.Raised&&f!==Ae.Asserted?Object.assign(Object.assign({},C),{reason:`Dispute is not in a voteable status (current: ${Ae[f]})`}):E?T?Object.assign(Object.assign({},C),{reason:"You have already voted on this dispute"}):w===BigInt(0)?Object.assign(Object.assign({},C),{reason:"You have never staked CAMP tokens"}):w>=v?Object.assign(Object.assign({},C),{reason:"You staked after this dispute was raised (vote recycling prevention)"}):I<c?Object.assign(Object.assign({},C),{reason:`Insufficient stake: you have ${I} but need at least ${c}`}):Object.assign(Object.assign({},C),{canVote:!0}):Object.assign(Object.assign({},C),{reason:"Voting period has ended"})}))}
/**
 ...
 * }
 * ```
 */function Be(e){return T(this,void 0,void 0,(function*(){var t,n,i,a,r,s,o,d,u;if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");const p=x(),l=this.environment.DISPUTE_CONTRACT_ADDRESS,y=this.environment.DISPUTE_ABI,[c,m,h,T]=yield Promise.all([p.readContract({address:l,abi:y,functionName:"disputes",args:[e]}),p.readContract({address:l,abi:y,functionName:"disputeQuorum",args:[]}),p.readContract({address:l,abi:y,functionName:"disputeCoolDownPeriod",args:[]}),p.readContract({address:l,abi:y,functionName:"disputeJudgementPeriod",args:[]})]),f=Number(null!==(t=c.status)&&void 0!==t?t:c[9]),v=BigInt(null!==(i=null!==(n=c.disputeTimestamp)&&void 0!==n?n:c[5])&&void 0!==i?i:0),A=BigInt(null!==(r=null!==(a=c.assertionTimestamp)&&void 0!==a?a:c[6])&&void 0!==r?r:0),w=BigInt(null!==(o=null!==(s=c.yesVotes)&&void 0!==s?s:c[7])&&void 0!==o?o:0),I=BigInt(null!==(u=null!==(d=c.noVotes)&&void 0!==d?d:c[8])&&void 0!==u?u:0),g=w+I;let b=0,E=0;g>BigInt(0)&&(b=Number(w*BigInt(1e4)/g)/100,E=Number(I*BigInt(1e4)/g)/100);
// Calculate quorum progress
let C=0;m>BigInt(0)&&(C=Number(g*BigInt(1e4)/m)/100);const _=g>=m;
// Determine projected outcome
let S;S=_?w>I?"dispute_succeeds":"dispute_fails":"no_quorum";
// Calculate timeline
const R=BigInt(Math.floor(Date.now()/1e3)),D=new Date(1e3*Number(v)),P=new Date(1e3*Number(v+h));let N,k;f===Ae.Asserted?(
...
N=new Date(1e3*Number(v+h+T)),k=v+h+T);const O=(f===Ae.Raised||f===Ae.Asserted)&&R>k,M=O?0:Number(k-R);return{disputeId:e,status:f,yesVotes:w,noVotes:I,totalVotes:g,yesPercentage:b,noPercentage:E,quorum:m,quorumPercentage:C,quorumMet:_,projectedOutcome:S,timeline:{raisedAt:D,cooldownEndsAt:P,votingEndsAt:N,canResolveNow:O,timeUntilResolution:M}}}))}
/**
 ...
 * ```
 */function Ue(e){return T(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");return this.callContractMethod(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,this.environment.FRACTIONALIZER_ABI,"redeem",[e],{waitForReceipt:!0})}))}
/**
 ...
 * }
 * ```
 */function He(e){return T(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");return this.callContractMethod(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,this.environment.FRACTIONALIZER_ABI,"getTokenForNFT",[e])}))}
/**
 ...
 * ```
 */function je(e){return T(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");
 ...
 * }
 * ```
 */function $e(e){return T(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");
...
// Minimal ERC20 ABI
const Le=[{inputs:[{name:"owner",type:"address"}],name:"balanceOf",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"},{inputs:[],name:"totalSupply",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"},{inputs:[],name:"decimals",outputs:[{name:"",type:"uint8"}],stateMutability:"view",type:"function"}];
/**
 ...
 * }
 * ```
 */function ze(e,t){return T(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");
// Resolve owner address
let n;if(t)n=t;else{const e=this.viemClient;if(!e)throw new Error("No owner address provided and no wallet connected");if(e.account)n=e.account.address;else{const t=yield e.request({method:"eth_requestAccounts",params:[]});if(!t||0===t.length)throw new Error("No accounts found in connected wallet");n=t[0]}}
// Get the ERC20 token address for this NFT
const i=yield this.getTokenForNFT(e);
// Check if fractionalized
if(!i||i===s)return{tokenId:e,erc20Address:s,isFractionalized:!1,balance:BigInt(0),totalSupply:BigInt(0),ownershipPercentage:0,canRedeem:!1,decimals:18};const a=x(),[r,o,d]=yield Promise.all([a.readContract({address:i,abi:Le,functionName:"balanceOf",args:[n]}),a.readContract({address:i,abi:Le,functionName:"totalSupply",args:[]}),a.readContract({address:i,abi:Le,functionName:"decimals",args:[]})]);
// Fetch ERC20 data
// Calculate ownership percentage
let u=0;o>BigInt(0)&&(u=Number(r*BigInt(1e4)/o)/100);const p=r>=o&&o>BigInt(0);return{tokenId:e,erc20Address:i,isFractionalized:!0,balance:r,totalSupply:o,ownershipPercentage:u,canRedeem:p,decimals:d}}))}
/**
 ...
 * }
 * ```
 */function qe(e,t){return T(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");
// Resolve owner address
let n;if(t)n=t;else{const e=this.viemClient;if(!e)throw new Error("No owner address provided and no wallet connected");if(e.account)n=e.account.address;else{const t=yield e.request({method:"eth_requestAccounts",params:[]});if(!t||0===t.length)throw new Error("No accounts found in connected wallet");n=t[0]}}const i=x(),a=this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,[r,o,d,u,p]=yield Promise.all([this.ownerOf(e),this.dataStatus(e),this.getTokenForNFT(e),i.readContract({address:this.environment.DATANFT_CONTRACT_ADDRESS,abi:this.environment.IPNFT_ABI,functionName:"getApproved",args:[e]}),i.readContract({address:this.environment.DATANFT_CONTRACT_ADDRESS,abi:this.environment.IPNFT_ABI,functionName:"isApprovedForAll",args:[n,a]})]),l=r.toLowerCase()===n.toLowerCase(),y=d&&d!==s,c=p||u.toLowerCase()===a.toLowerCase(),m={canFractionalize:!1,isOwner:l,currentOwner:r,isAlreadyFractionalized:!!y,existingErc20Address:y?d:void 0,dataStatus:o,isApproved:c,needsApproval:!c};
// Check requirements in order
return l?y?Object.assign(Object.assign({},m),{reason:`This NFT is already fractionalized. ERC20: ${d}`}):o===ve.DELETED?Object.assign(Object.assign({},m),{reason:"This NFT has been deleted and cannot be fractionalized"}):o===ve.DISPUTED?Object.assign(Object.assign({},m),{reason:"This NFT is disputed and cannot be fractionalized"}):Object.assign(Object.assign({},m),{canFractionalize:!0}):Object.assign(Object.assign({},m),{reason:`You don't own this NFT. Current owner: ${r}`})}))}
/**
 ...
 * ```
 */function Ve(e){return T(this,void 0,void 0,(function*(){if(!this.environment.APP_REGISTRY_CONTRACT_ADDRESS)throw new Error("App registry contract address not configured");if(!this.environment.APP_REGISTRY_ABI)throw new Error("App registry ABI not configured");return this.callContractMethod(this.environment.APP_REGISTRY_CONTRACT_ADDRESS,this.environment.APP_REGISTRY_ABI,"getAppInfo",[e])}))}
/**
 * Approves a spender to spend a specified amount of tokens on behalf of the owner.
 * If the current allowance is less than the specified amount, it will perform the approval.
 * @param {ApproveParams} params - The parameters for the approval.
 */function Ze(e){return T(this,arguments,void 0,(function*({walletClient:e,publicClient:t,tokenAddress:n,owner:i,spender:a,amount:r}){(yield t.readContract({address:n,abi:u,functionName:"allowance",args:[i,a]}))<r&&(yield e.writeContract({address:n,account:i,abi:u,functionName:"approve",args:[a,r],chain:_}))}))}
/**
 ...
 * ```
 */function We(e,t,n){return this.callContractMethod(this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,this.environment.BATCH_PURCHASE_ABI,"bulkBuyAccess",[e,t],{waitForReceipt:!0,value:n})}
/**
 ...
 * ```
 */function Ge(e,t,n){return this.callContractMethod(this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,this.environment.BATCH_PURCHASE_ABI,"bulkBuyAccessTolerant",[e,t],{waitForReceipt:!0,value:n})}
/**
 ...
 * ```
 */function Je(e){return this.callContractMethod(this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,this.environment.BATCH_PURCHASE_ABI,"previewBulkCost",[e])}
/**
 ...
 * ```
 */function Ye(e){return this.callContractMethod(this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,this.environment.BATCH_PURCHASE_ABI,"buildPurchaseParams",[e])}
/**
 ...
 * ```
 */function Ke(e){return this.callContractMethod(this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,this.environment.BATCH_PURCHASE_ABI,"checkActiveStatus",[e])}
/**
 ...
 * ```
 */function Xe(e,t){return T(this,void 0,void 0,(function*(){if(!e||0===e.length)throw new Error("No token IDs provided for bulk purchase");
...
const d=x();for(const e of o)yield Ze({walletClient:n,publicClient:d,tokenAddress:e.token,owner:i,spender:this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,amount:e.amount});
// Execute the purchase
return(null==t?void 0:t.tolerant)?this.bulkBuyAccessTolerant(i,a,r):this.bulkBuyAccess(i,a,r)}))}var Qe,et,tt,nt,it,at,rt,st,ot,dt,ut,pt,lt,yt,ct,mt,ht,Tt,ft,vt,At,wt;
/**
 * The Origin class
 * Handles interactions with Origin protocol.
 */class It{constructor(e,t,n,i,a){Qe.add(this),t?this.jwt=t:console.warn("JWT not provided. Some features may be unavailable."),this.viemClient=n,this.environment="string"==typeof e?Z[e]:e||Z.DEVELOPMENT,this.baseParentId=i,this.appId=a,
// DataNFT methods
this.mintWithSignature=Y.bind(this),this.registerIpNFT=K.bind(this),this.updateTerms=X.bind(this),this.finalizeDelete=Q.bind(this),this.getOrCreateRoyaltyVault=ee.bind(this),this.getTerms=te.bind(this),this.ownerOf=ne.bind(this),this.balanceOf=ie.bind(this),this.tokenURI=ae.bind(this),this.dataStatus=re.bind(this),this.isApprovedForAll=se.bind(this),this.transferFrom=oe.bind(this),this.safeTransferFrom=de.bind(this),this.approve=ue.bind(this),this.setApprovalForAll=pe.bind(this),
// Marketplace methods
this.buyAccess=le.bind(this),this.hasAccess=ye.bind(this),this.subscriptionExpiry=ce.bind(this),this.settlePaymentIntent=Te.bind(this),this.getDataWithIntent=be.bind(this),
// Bulk purchase methods
this.bulkBuyAccess=We.bind(this),this.bulkBuyAccessTolerant=Ge.bind(this),this.bulkBuyAccessSmart=Xe.bind(this),this.previewBulkCost=Je.bind(this),this.buildPurchaseParams=Ye.bind(this),this.checkActiveStatus=Ke.bind(this),
// Dispute module methods
this.raiseDispute=Se.bind(this),this.disputeAssertion=Re.bind(this),this.voteOnDispute=De.bind(this),this.resolveDispute=Pe.bind(this),this.cancelDispute=Ne.bind(this),this.tagChildIp=xe.bind(this),this.getDispute=ke.bind(this),this.canVoteOnDispute=Me.bind(this),this.getDisputeProgress=Be.bind(this),
// Fractionalizer module methods
this.fractionalize=Fe.bind(this),this.redeem=Ue.bind(this),this.getTokenForNFT=He.bind(this),this.fractionalizeWithApproval=je.bind(this),this.redeemIfComplete=$e.bind(this),this.getFractionOwnership=ze.bind(this),this.canFractionalize=qe.bind(this),
// AppRegistry module methods
this.getAppInfo=Ve.bind(this)}getJwt(){return this.jwt}setViemClient(e){this.viemClient=e}
/**
     ...
     */mintFile(e,t,n,i,a){return T(this,void 0,void 0,(function*(){let r,s=null;try{s=yield f(this,Qe,"m",st).call(this)}catch(e){throw new Error("Failed to mint file IP. Wallet not connected.")}try{if(r=yield f(this,Qe,"m",it).call(this,e,a),!r||!r.key)throw new Error("Failed to upload file or get upload info.")}catch(e){throw new Error(`File upload failed: ${e instanceof Error?e.message:String(e)}`)}e.type&&(t.mimetype=e.type);let o=null;(null==a?void 0:a.previewImage)&&(null==a?void 0:a.previewImage.type.startsWith("image/"))?o=yield f(this,Qe,"m",nt).call(this,a.previewImage):(null==a?void 0:a.useAssetAsPreview)&&e.type.startsWith("image/")&&(o=yield f(this,Qe,"m",nt).call(this,e)),o&&(t.image=`ipfs://${o}`);const d=BigInt(Date.now()+6e5);// 10 minutes from now
let u;this.baseParentId&&(i||(i=[]),i.unshift(this.baseParentId));try{u=yield this.registerIpNFT("file",d,n,t,r.key,i)}catch(e){throw yield f(this,Qe,"m",tt).call(this,r.key,"failed"),new Error(`Failed to register IpNFT: ${e instanceof Error?e.message:String(e)}`)}const{tokenId:p,signerAddress:l,creatorContentHash:y,signature:c,uri:m}=u;if(!(p&&l&&y&&void 0!==c&&m))throw new Error("Failed to register IpNFT: Missing required fields in registration response.");try{const e=yield this.mintWithSignature(s,p,i||[],!0,y,m,n,d,c);if(-1===["0x1","success"].indexOf(e.receipt.status))throw yield f(this,Qe,"m",tt).call(this,r.key,"failed"),new Error(`Minting failed with status: ${e.receipt.status}`)}catch(e){throw yield f(this,Qe,"m",tt).call(this,r.key,"failed"),new Error(`Minting transaction failed: ${e instanceof Error?e.message:String(e)}`)}return p.toString()}))}
/**
     ...
     */mintSocial(e,t,n){return T(this,void 0,void 0,(function*(){let i=null;try{i=yield f(this,Qe,"m",st).call(this)}catch(e){throw new Error("Failed to mint social IP. Wallet not connected.")}t.mimetype=`social/${e}`;const a=BigInt(Math.floor(Date.now()/1e3)+600);// 10 minutes from now
...
/**
     ...
     */callContractMethod(e,t,n,i){return T(this,arguments,void 0,(function*(e,t,n,i,a={}){var r;let s=null;try{s=yield f(this,Qe,"m",st).call(this)}catch(e){throw new Error("Failed to call contract method. Wallet not connected.")}const o=p({abi:t,name:n});if(o&&"stateMutability"in o&&("view"===o.stateMutability||"pure"===o.stateMutability)){const a=x();return(yield a.readContract({address:e,abi:t,functionName:n,args:i}))||null}yield f(this,Qe,"m",rt).call(this,this.environment.CHAIN);const d=x(),{result:u,request:l}=yield d.simulateContract({account:s,address:e,abi:t,functionName:n,args:i,value:a.value});
// simulate
if(a.simulate)return u;try{const e=yield null===(r=this.viemClient)||void 0===r?void 0:r.writeContract(l);if("string"!=typeof e)throw new Error("Transaction failed to send.");if(!a.waitForReceipt)return{txHash:e,simulatedResult:u};return{txHash:e,receipt:yield f(this,Qe,"m",at).call(this,e),simulatedResult:u}}catch(e){throw console.error("Transaction failed:",e),new Error("Transaction failed: "+e)}}))}
/**
...
/**
     ...
     * }
     * ```
     */buyAccessSmart(e){return T(this,void 0,void 0,(function*(){let t=null;try{t=yield f(this,Qe,"m",st).call(this)}catch(e){throw new Error("Failed to buy access. Wallet not connected.")}
// Check if user already has access
if(yield this.hasAccess(t,e))return console.log("User already has access to this asset"),null;const n=yield this.getTerms(e);if(!n)throw new Error("Failed to fetch terms for asset");const{price:i,paymentToken:a,duration:r}=n;if(void 0===i||void 0===a||void 0===r)throw new Error("Terms missing price, paymentToken, or duration");
// Fetch protocol fee from marketplace
const o=yield f(this,Qe,"m",ot).call(this),d=yield f(this,Qe,"m",dt).call(this,e),u=i;
// Fetch app fee from token's appId
return a===s?this.buyAccess(t,e,u,r,a,o,d,u):(yield Ze({walletClient:this.viemClient,publicClient:x(),tokenAddress:a,owner:t,spender:this.environment.MARKETPLACE_CONTRACT_ADDRESS,amount:u}),this.buyAccess(t,e,u,r,a,o,d))}))}
/**
...
/**
     ...
     * ```
     */getRoyalties(e,t){return T(this,void 0,void 0,(function*(){try{const n=yield this.getTokenBoundAccount(e),i=x();let a,r;if(t&&t!==s){
// erc20 (wrapped camp)
...
/**
     ...
     * ```
     */claimRoyalties(e,t,n){return T(this,void 0,void 0,(function*(){const i=yield f(this,Qe,"m",ut).call(this,t),r=yield this.getTokenBoundAccount(e),o=(yield this.getRoyalties(e,n)).balance;if(o===BigInt(0))throw new Error("No royalties available to claim");let d,u,p;
...
{waitForReceipt:!0,value:BigInt(0)})}))}}Qe=new WeakSet,et=function(e){return T(this,void 0,void 0,(function*(){try{const t=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/upload-url`,{method:"POST",body:JSON.stringify({name:e.name,type:e.type}),headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!t.ok)throw new Error(`HTTP ${t.status}: ${t.statusText}`);const n=yield t.json();if(n.isError)throw new Error(n.message||"Failed to generate upload URL");return n.data}catch(e){throw console.error("Failed to generate upload URL:",e),e}}))},tt=function(e,t){return T(this,void 0,void 0,(function*(){try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/update-status`,{method:"PATCH",body:JSON.stringify({status:t,fileKey:e}),headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!n.ok){const e=yield n.text().catch((()=>"Unknown error"));throw new Error(`HTTP ${n.status}: ${e}`)}return!0}catch(e){throw console.error("Failed to update origin status:",e),e}}))},nt=function(e){return T(this,void 0,void 0,(function*(){var t;if(!e)return null;try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/upload-url-ipfs`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.jwt}`},body:JSON.stringify({fileName:e.name,fileType:e.type})});if(!n.ok){const e=yield n.text().catch((()=>"Unknown error"));throw new Error(`Failed to get presigned URL (HTTP ${n.status}): ${e}`)}const i=yield n.json(),{isError:a,data:r,message:s}=i;if(a||!r)throw new Error(`Failed to get presigned URL: ${s||"No URL returned from server"}`);const o=new FormData;o.append("file",e);const d=yield fetch(r,{method:"POST",body:o});if(!d.ok){const e=yield d.text().catch((()=>d.statusText));throw new Error(`Failed to upload preview image to IPFS (HTTP ${d.status}): ${e}`)}const u=yield d.json();if(!u||!u.data)throw new Error("Invalid response from IPFS upload: Missing data field");return null===(t=u.data)||void 0===t?void 0:t.cid}catch(e){const t=e instanceof Error?e.message:String(e);throw console.error("Error uploading preview image to IPFS:",t),new Error(`Failed to upload preview image to IPFS: ${t}`)}}))},it=function(e,t){return T(this,void 0,void 0,(function*(){let n;try{n=yield f(this,Qe,"m",et).call(this,e)}catch(e){throw console.error("Failed to generate upload URL:",e),new Error(`Failed to generate upload URL: ${e instanceof Error?e.message:String(e)}`)}if(!n)throw new Error("Failed to generate upload URL: No upload info returned");try{yield((e,t,n)=>new Promise(((i,a)=>{h.put(t,e,Object.assign({headers:{"Content-Type":e.type}},"undefined"!=typeof window&&"function"==typeof n?{onUploadProgress:e=>{if(e.total){const t=e.loaded/e.total*100;n(t)}}}:{})).then((e=>{i(e.data)})).catch((e=>{var t;const n=(null===(t=null==e?void 0:e.response)||void 0===t?void 0:t.data)||(null==e?void 0:e.message)||"Upload failed";a(n)}))})))(e,n.url,(null==t?void 0:t.progressCallback)||(()=>{}))}catch(e){try{yield f(this,Qe,"m",tt).call(this,n.key,"failed")}catch(e){console.error("Failed to update status to failed:",e)}const t=e instanceof Error?e.message:String(e);throw new Error(`Failed to upload file: ${t}`)}try{yield f(this,Qe,"m",tt).call(this,n.key,"success")}catch(e){console.error("Failed to update status to success:",e)}return n}))},at=function(e){return T(this,arguments,void 0,(function*(e,t={}){var n,i,a;const r=x();let s=e;const o=null!==(n=t.confirmations)&&void 0!==n?n:1,d=null!==(i=t.timeoutMs)&&void 0!==i?i:18e4,u=null!==(a=t.pollingIntervalMs)&&void 0!==a?a:1500;try{return yield r.waitForTransactionReceipt({hash:s,confirmations:o,timeout:d,pollingInterval:u,onReplaced:e=>{s=e.transaction.hash}})}catch(e){
// fallback
const t=Date.now();for(;Date.now()-t<d;){try{const e=yield r.getTransactionReceipt({hash:s});if(e&&e.blockNumber)return e}catch(e){}yield new Promise((e=>setTimeout(e,u)))}throw e}}))},rt=function(e){return T(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected. Could not ensure chain ID.");let t=yield this.viemClient.request({method:"eth_chainId",params:[]});if("string"==typeof t&&(t=parseInt(t,16)),t!==e.id){(e=>{N=e,P=null})// reset public client to be recreated with new chain
(e);try{yield this.viemClient.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16)}]})}catch(t){
// Unrecognized chain
if(4902!==t.code)throw t;yield this.viemClient.request({method:"wallet_addEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16),chainName:e.name,rpcUrls:e.rpcUrls.default.http,nativeCurrency:e.nativeCurrency}]}),yield this.viemClient.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16)}]})}}}))},st=function(){return T(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected. Please connect a wallet.");
// If account is already set on the client, return it directly
if(this.viemClient.account)return this.viemClient.account.address;
// Otherwise request accounts (browser wallet flow)
const e=yield this.viemClient.request({method:"eth_requestAccounts",params:[]});if(!e||0===e.length)throw new Error("No accounts found in connected wallet.");return e[0]}))},ot=function(){return T(this,void 0,void 0,(function*(){try{const e=yield this.callContractMethod(this.environment.MARKETPLACE_CONTRACT_ADDRESS,this.environment.MARKETPLACE_ABI,"protocolFeeBps",[]);return Number(e)}catch(e){return console.warn("Failed to fetch protocol fee, defaulting to 0:",e),0}}))},dt=function(e){return T(this,void 0,void 0,(function*(){try{
...
/**
     ...
     */
constructor({clientId:e,redirectUri:t,environment:n="DEVELOPMENT",baseParentId:i,storage:a}){if(pt.add(this),lt.set(this,void 0),yt.set(this,void 0),ct.set(this,void 0),mt.set(this,void 0),!e)throw new Error("clientId is required");if(-1===["PRODUCTION","DEVELOPMENT"].indexOf(n))throw new Error("Invalid environment, must be DEVELOPMENT or PRODUCTION");v(this,yt,"undefined"==typeof window,"f"),v(this,mt,a||(f(this,yt,"f")?new E:new b),"f"),this.viem=null,this.environment=Z[n],this.baseParentId=i,this.redirectUri=(e=>{const t=["twitter","spotify"];return"object"==typeof e?t.reduce(((t,n)=>(t[n]=e[n]||("undefined"!=typeof window?window.location.href:""),t)),{}):"string"==typeof e?t.reduce(((t,n)=>(t[n]=e,t)),{}):e?{}:t.reduce(((e,t)=>(e[t]="undefined"!=typeof window?window.location.href:"",e)),{})})(t),this.clientId=e,this.isAuthenticated=!1,this.jwt=null,this.origin=null,this.walletAddress=null,this.userId=null,v(this,lt,{},"f"),
// only subscribe to providers in browser environment
f(this,yt,"f")||J((e=>{f(this,pt,"m",ht).call(this,"providers",e)})),f(this,pt,"m",Tt).call(this)}
/**
     ...
     *  console.log(state);
     * });
     */on(e,t){f(this,lt,"f")[e]||(f(this,lt,"f")[e]=[]),f(this,lt,"f")[e].push(t),"providers"===e&&t(G())}
/**
     * Unsubscribe from an event. Possible events are "state", "provider", "providers", and "viem".
     * @param {("state"|"provider"|"providers"|"viem")} event The event.
     * @param {function} callback The callback function.
     * @returns {void}
     */off(e,t){f(this,lt,"f")[e]&&(f(this,lt,"f")[e]=f(this,lt,"f")[e].filter((e=>e!==t)))}
/**
     * Set the loading state.
     * @param {boolean} loading The loading state.
     * @returns {void}
     */setLoading(e){f(this,pt,"m",ht).call(this,"state",e?"loading":this.isAuthenticated?"authenticated":"unauthenticated")}
/**
     * Set the provider. This is useful for setting the provider when the user selects a provider from the UI or when dApp wishes to use a specific provider.
     * @param {object} options The options object. Includes the provider and the provider info.
     * @returns {void}
     * @throws {APIError} - Throws an error if the provider is not provided.
     */setProvider({provider:t,info:i,address:a}){if(!t)throw new R("provider is required");this.viem=((t,i="window.ethereum",a,r)=>{var s,o;if(!t&&!D)return console.warn("Provider is required to create a client."),null;const d=a||_;if(!D||D.transport.name!==i&&t||r!==(null===(s=D.account)||void 0===s?void 0:s.address)&&t||(null==N?void 0:N.id)!==d.id){const a={chain:d,transport:n(t,{name:i})};r&&(a.account=c(r)),D=e(a),N=d,P&&(null===(o=P.chain)||void 0===o?void 0:o.id)!==d.id&&(P=null)}return D})(t,i.name,this.environment.CHAIN,a),this.origin&&this.origin.setViemClient(this.viem),
// TODO: only use one of these
f(this,pt,"m",ht).call(this,"viem",this.viem),f(this,pt,"m",ht).call(this,"provider",{provider:t,info:i}),f(this,mt,"f").setItem("camp-sdk:provider",JSON.stringify(i))}
/**
...
/**
     ...
     */recoverProvider(){return T(this,void 0,void 0,(function*(){var e,t,n,i,a,r,s,o,d,u,p,l,y;if(!this.walletAddress)return void console.warn("No wallet address found in local storage. Please connect your wallet again.");const c=yield f(this,mt,"f").getItem("camp-sdk:provider");if(!c)return;const m=JSON.parse(c);let h;const T=null!==(e=G())&&void 0!==e?e:[];
...
/**
     * Disconnect the user.
     * @returns {Promise<void>}
     */disconnect(){return T(this,void 0,void 0,(function*(){this.isAuthenticated&&(f(this,pt,"m",ht).call(this,"state","unauthenticated"),this.isAuthenticated=!1,this.walletAddress=null,this.userId=null,this.jwt=null,this.origin=null,v(this,ct,void 0,"f"),yield f(this,mt,"f").removeItem("camp-sdk:wallet-address"),yield f(this,mt,"f").removeItem("camp-sdk:user-id"),yield f(this,mt,"f").removeItem("camp-sdk:jwt"),yield f(this,mt,"f").removeItem("camp-sdk:environment"))}))}
/**
     * Connect the user's wallet and sign the message.
     * @returns {Promise<{ success: boolean; message: string; walletAddress: string }>} A promise that resolves with the authentication result.
     * @throws {APIError} - Throws an error if the user cannot be authenticated.
     */connect(){return T(this,void 0,void 0,(function*(){f(this,pt,"m",ht).call(this,"state","loading");try{this.walletAddress||(yield f(this,pt,"m",ft).call(this)),this.walletAddress=r(this.walletAddress);const e=yield f(this,pt,"m",vt).call(this),t=f(this,pt,"m",wt).call(this,e),n=yield this.viem.signMessage({account:this.walletAddress,message:t}),i=yield f(this,pt,"m",At).call(this,t,n);if(i.success)return this.isAuthenticated=!0,this.userId=i.userId,this.jwt=i.token,this.origin=new It(this.environment,this.jwt,this.viem,this.baseParentId,this.clientId),yield f(this,mt,"f").setItem("camp-sdk:jwt",this.jwt),yield f(this,mt,"f").setItem("camp-sdk:wallet-address",this.walletAddress),yield f(this,mt,"f").setItem("camp-sdk:user-id",this.userId),yield f(this,mt,"f").setItem("camp-sdk:environment",this.environment.NAME),f(this,pt,"m",ht).call(this,"state","authenticated"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,f(this,pt,"m",ht).call(this,"state","unauthenticated"),new R("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,f(this,pt,"m",ht).call(this,"state","unauthenticated"),new R(e)}}))}
/**
     ...
     */connectWithSigner(e,t){return T(this,void 0,void 0,(function*(){f(this,pt,"m",ht).call(this,"state","loading");try{v(this,ct,g(e),"f"),this.walletAddress=r(yield f(this,ct,"f").getAddress()),
// store the signer as viem client if it's a viem client, otherwise keep adapter
"viem"===f(this,ct,"f").type&&(this.viem=e);const n=yield f(this,pt,"m",vt).call(this),i=f(this,pt,"m",wt).call(this,n,null==t?void 0:t.domain,null==t?void 0:t.uri),a=yield f(this,ct,"f").signMessage(i),s=yield f(this,pt,"m",At).call(this,i,a);if(s.success)return this.isAuthenticated=!0,this.userId=s.userId,this.jwt=s.token,this.origin=new It(this.environment,this.jwt,this.viem,this.baseParentId,this.clientId),yield f(this,mt,"f").setItem("camp-sdk:jwt",this.jwt),yield f(this,mt,"f").setItem("camp-sdk:wallet-address",this.walletAddress),yield f(this,mt,"f").setItem("camp-sdk:user-id",this.userId),yield f(this,mt,"f").setItem("camp-sdk:environment",this.environment.NAME),f(this,pt,"m",ht).call(this,"state","authenticated"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,f(this,pt,"m",ht).call(this,"state","unauthenticated"),new R("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,v(this,ct,void 0,"f"),f(this,pt,"m",ht).call(this,"state","unauthenticated"),new R(e)}}))}
/**
...
/**
     ...
     */linkTwitter(){return T(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(f(this,yt,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/twitter/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.twitter}`}))}
/**
     * Link the user's Discord account.
     * @returns {Promise<void>}
     * @throws {Error} - Throws an error if the user is not authenticated or in Node.js environment.
     */linkDiscord(){return T(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(f(this,yt,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/discord/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.discord}`}))}
/**
     * Link the user's Spotify account.
     * @returns {Promise<void>}
     * @throws {Error} - Throws an error if the user is not authenticated or in Node.js environment.
     */linkSpotify(){return T(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(f(this,yt,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/spotify/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.spotify}`}))}
/**
...
/**
     ...
     * @throws {Error} - Throws an error if the user is not authenticated.
     * @throws {APIError} - Throws an error if the request fails.
     */unlinkTelegram(){return T(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new R("User needs to be authenticated");const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/telegram/disconnect-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({userId:this.userId})}).then((e=>e.json()));if(e.isError)throw new R(e.message||"Failed to unlink Telegram account");return e.data}))}}lt=new WeakMap,yt=new WeakMap,ct=new WeakMap,mt=new WeakMap,pt=new WeakSet,ht=function(e,t){f(this,lt,"f")[e]&&f(this,lt,"f")[e].forEach((e=>e(t)))},Tt=function(e){return T(this,void 0,void 0,(function*(){const t=yield f(this,mt,"f").getItem("camp-sdk:wallet-address"),n=yield f(this,mt,"f").getItem("camp-sdk:user-id"),i=yield f(this,mt,"f").getItem("camp-sdk:jwt"),a=yield f(this,mt,"f").getItem("camp-sdk:environment");t&&n&&i&&(a===this.environment.NAME||!a)?(this.walletAddress=t,this.userId=n,this.jwt=i,this.origin=new It(this.environment,this.jwt,this.viem,this.baseParentId,this.clientId),this.isAuthenticated=!0,e?this.setProvider({provider:e.provider,info:e.info||{name:"Unknown"},address:t}):f(this,yt,"f")||(console.warn("No matching provider was given for the stored wallet address. Trying to recover provider."),yield this.recoverProvider())):this.isAuthenticated=!1}))},ft=function(){return T(this,void 0,void 0,(function*(){try{const[e]=yield this.viem.requestAddresses();return this.walletAddress=r(e),this.walletAddress}catch(e){throw new R(e)}}))},vt=function(){return T(this,void 0,void 0,(function*(){try{const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/nonce`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({walletAddress:this.walletAddress})}),t=yield e.json();return 200!==e.status?Promise.reject(t.message||"Failed to fetch nonce"):t.data}catch(e){throw new Error(e)}}))},At=function(e,t){return T(this,void 0,void 0,(function*(){try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/verify`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({message:e,signature:t,walletAddress:this.walletAddress})}),i=yield n.json(),a=i.data.split(".")[1],r=JSON.parse(atob(a));return{success:!i.isError,userId:r.id,token:i.data}}catch(e){throw new R(e)}}))},wt=function(e,t,n){return m({domain:t||(f(this,yt,"f")?"localhost":window.location.host),address:this.walletAddress,statement:j,uri:n||(f(this,yt,"f")?"http://localhost":window.location.origin),version:"1",chainId:this.environment.CHAIN.id,nonce:e})};export{gt as Auth,b as BrowserStorage,I as CustomSignerAdapter,ve as DataStatus,Ae as DisputeStatus,w as EthersSignerAdapter,fe as LicenseType,E as MemoryStorage,It as Origin,A as ViemSignerAdapter,S as campMainnet,_ as campTestnet,we as createLicenseTerms,C as createNodeWalletClient,g as createSignerAdapter};
