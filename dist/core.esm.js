 ...
 */function P(e,t,n,i,a,r,s,o){return y(this,void 0,void 0,(function*(){return console.log("mintWithSignature",this.environment),yield this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"mintWithSignature",
...
o,u,n,i,d);if("0x1"!==l.status)throw new Error(`Minting Social IpNFT failed with status: ${l.status}`);return r.toString()})),this.getOriginUploads=()=>y(this,void 0,void 0,(function*(){const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/auth/origin/files`,{method:"GET",headers:{Authorization:`Bearer ${this.jwt}`}});if(!e.ok)return console.error("Failed to get origin uploads"),null;return(yield e.json()).data})),this.jwt=t,this.viemClient=i,this.environment=n,
// DataNFT methods
this.mintWithSignature=P.bind(this),this.registerIpNFT=x.bind(this),this.updateTerms=M.bind(this),this.requestDelete=U.bind(this),this.getTerms=B.bind(this),this.ownerOf=O.bind(this),this.balanceOf=F.bind(this),this.contentHash=R.bind(this),this.tokenURI=$.bind(this),this.dataStatus=H.bind(this),this.royaltyInfo=j.bind(this),this.getApproved=L.bind(this),this.isApprovedForAll=W.bind(this),this.transferFrom=q.bind(this),this.safeTransferFrom=K.bind(this),this.approve=z.bind(this),this.setApprovalForAll=J.bind(this),
// Marketplace methods
