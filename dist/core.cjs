...
// DataNFT methods
this.mintWithSignature=C.bind(this),this.registerIpNFT=E.bind(this),this.updateTerms=M.bind(this),this.requestDelete=x.bind(this),this.getTerms=S.bind(this),this.ownerOf=O.bind(this),this.balanceOf=$.bind(this),this.contentHash=F.bind(this),this.tokenURI=j.bind(this),this.dataStatus=P.bind(this),this.royaltyInfo=N.bind(this),this.getApproved=U.bind(this),this.isApprovedForAll=D.bind(this),this.transferFrom=B.bind(this),this.safeTransferFrom=_.bind(this),this.approve=W.bind(this),this.setApprovalForAll=q.bind(this),
// Marketplace methods
