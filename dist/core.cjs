 ...
 */function u(t){return r(this,arguments,void 0,(function*(t,n={}){try{return(yield e.get(t,{headers:n})).data}catch(e){if(e.response)throw new o(e.response.data.message||"API request failed",e.response.status);throw new o("Network error or server is unavailable",500)}}))}
/**
 ...
 */function E(e,t,n,i,a,s,o,d){return r(this,void 0,void 0,(function*(){return yield this.callContractMethod(g,C,"mintWithSignature",[e,t,n,i,a,s,o,d],{waitForReceipt:!0})}))}
/**
...
o,u,n,i,d);if("0x1"!==p.status)throw new Error(`Minting Social IpNFT failed with status: ${p.status}`);return a.toString()})),this.getOriginUploads=()=>r(this,void 0,void 0,(function*(){const e=yield fetch(`${v}/auth/origin/files`,{method:"GET",headers:{Authorization:`Bearer ${this.jwt}`}});if(!e.ok)return console.error("Failed to get origin uploads"),null;return(yield e.json()).data})),this.jwt=t,this.viemClient=n,
// DataNFT methods
this.mintWithSignature=E.bind(this),this.registerIpNFT=x.bind(this),this.updateTerms=S.bind(this),this.requestDelete=M.bind(this),this.getTerms=P.bind(this),this.ownerOf=$.bind(this),this.balanceOf=F.bind(this),this.contentHash=U.bind(this),this.tokenURI=O.bind(this),this.dataStatus=N.bind(this),this.royaltyInfo=j.bind(this),this.getApproved=D.bind(this),this.isApprovedForAll=_.bind(this),this.transferFrom=B.bind(this),this.safeTransferFrom=q.bind(this),this.approve=L.bind(this),this.setApprovalForAll=W.bind(this),
// Marketplace methods
this.buyAccess=ae.bind(this),this.renewAccess=se.bind(this),this.hasAccess=oe.bind(this),this.subscriptionExpiry=de.bind(this)}getJwt(){return this.jwt}setViemClient(e){this.viemClient=e}
/**
     * Get the user's Origin stats (multiplier, consent, usage, etc.).
     * @returns {Promise<OriginUsageReturnType>} A promise that resolves with the user's Origin stats.
     */getOriginUsage(){return r(this,void 0,void 0,(function*(){const e=yield fetch(`${v}/auth/origin/usage`,{method:"GET",headers:{Authorization:`Bearer ${this.jwt}`,
...
/**
     ...
     */setOriginConsent(e){return r(this,void 0,void 0,(function*(){if(void 0===e)throw new o("Consent is required");const t=yield fetch(`${v}/auth/origin/status`,{method:"PATCH",headers:{Authorization:`Bearer ${this.jwt}`,
// "x-client-id": this.clientId,
...
/**
     ...
     */setOriginMultiplier(e){return r(this,void 0,void 0,(function*(){if(void 0===e)throw new o("Multiplier is required");const t=yield fetch(`${v}/auth/origin/multiplier`,{method:"PATCH",headers:{Authorization:`Bearer ${this.jwt}`,
// "x-client-id": this.clientId,
...
/**
     ...
     */callContractMethod(e,n,i,s){return r(this,arguments,void 0,(function*(e,n,i,r,s={}){const o=t.getAbiItem({abi:n,name:i}),d=o&&"stateMutability"in o&&("view"===o.stateMutability||"pure"===o.stateMutability);if(!d&&!this.viemClient)throw new Error("WalletClient not connected.");if(d){const t=f();return(yield t.readContract({address:e,abi:n,functionName:i,args:r}))||null}{const[o]=yield this.viemClient.request({method:"eth_requestAccounts",params:[]}),d=t.encodeFunctionData({abi:n,functionName:i,args:r});yield a(this,R,"m",H).call(this,y);try{const t=yield this.viemClient.sendTransaction({to:e,data:d,account:o,value:s.value,gas:s.gas});if("string"!=typeof t)throw new Error("Transaction failed to send.");if(!s.waitForReceipt)return t;return yield a(this,R,"m",J).call(this,t)}catch(e){throw console.error("Transaction failed:",e),new Error("Transaction failed: "+e)}}}))}
/**
     * Buy access to an asset by first checking its price via getTerms, then calling buyAccess.
     * @param {bigint} tokenId The token ID of the asset.
     * @param {number} periods The number of periods to buy access for.
     * @returns {Promise<any>} The result of the buyAccess call.
     */buyAccessSmart(e,n){return r(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected.");const i=yield this.getTerms(e);if(!i)throw new Error("Failed to fetch terms for asset");const{price:a,paymentToken:s}=i;if(void 0===a||void 0===s)throw new Error("Terms missing price or paymentToken");const[o]=yield this.viemClient.request({method:"eth_requestAccounts",params:[]}),d=a*BigInt(n);return s===t.zeroAddress?this.buyAccess(o,e,n,d):(yield function(e){return r(this,arguments,void 0,(function*({walletClient:e,publicClient:n,tokenAddress:i,owner:r,spender:a,amount:s}){(yield n.readContract({address:i,abi:t.erc20Abi,functionName:"allowance",args:[r,a]}))<s&&(yield e.writeContract({address:i,account:r,abi:t.erc20Abi,functionName:"approve",args:[a,s],chain:y}))}))}({walletClient:this.viemClient,publicClient:f(),tokenAddress:s,owner:o,spender:b,amount:d}),this.buyAccess(o,e,n))}))}getData(e){return r(this,void 0,void 0,(function*(){const t=yield fetch(`${v}/auth/origin/data/${e}`,{method:"GET",headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!t.ok)throw new Error("Failed to fetch data");return t.json()}))}}z=new WeakMap,K=new WeakMap,R=new WeakSet,J=function(e){return r(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected.");for(;;){const t=yield this.viemClient.request({method:"eth_getTransactionReceipt",params:[e]});if(t&&t.blockNumber)return t;yield new Promise((e=>setTimeout(e,1e3)))}}))},H=function(e){return r(this,void 0,void 0,(function*(){
// return;
...
// }
this.redirectUri=(e=>{const t=["twitter","discord","spotify"];return"object"==typeof e?t.reduce(((t,n)=>(t[n]=e[n]||("undefined"!=typeof window?window.location.href:""),t)),{}):"string"==typeof e?t.reduce(((t,n)=>(t[n]=e,t)),{}):e?{}:t.reduce(((e,t)=>(e[t]="undefined"!=typeof window?window.location.href:"",e)),{})})(t),i&&s(this,V,i,"f"),n&&a(this,V,"f"),this.clientId=e,this.isAuthenticated=!1,this.jwt=null,this.origin=null,this.walletAddress=null,this.userId=null,s(this,Z,{},"f"),k((e=>{a(this,G,"m",Y).call(this,"providers",e)})),a(this,G,"m",Q).call(this)}
/**
     ...
     *  console.log(state);
     * });
     */on(e,t){a(this,Z,"f")[e]||(a(this,Z,"f")[e]=[]),a(this,Z,"f")[e].push(t),"providers"===e&&t(A())}
/**
     * Set the loading state.
     * @param {boolean} loading The loading state.
     * @returns {void}
     */setLoading(e){a(this,G,"m",Y).call(this,"state",e?"loading":this.isAuthenticated?"authenticated":"unauthenticated")}
/**
...
a(this,G,"m",Y).call(this,"viem",this.viem),a(this,G,"m",Y).call(this,"provider",{provider:e,info:i}),localStorage.setItem("camp-sdk:provider",JSON.stringify(i))}
/**
     * Set the wallet address. This is useful for edge cases where the provider can't return the wallet address. Don't use this unless you know what you're doing.
     * @param {string} walletAddress The wallet address.
     * @returns {void}
     */setWalletAddress(e){this.walletAddress=e}recoverProvider(){return r(this,void 0,void 0,(function*(){var e,t,n,i,r,a,s,o,d,u,l,p,c,y,h;if(!this.walletAddress)return void console.warn("No wallet address found in local storage. Please connect your wallet again.");const m=JSON.parse(localStorage.getItem("camp-sdk:provider")||"{}");let f;const w=null!==(e=A())&&void 0!==e?e:[];
...
/**
     ...
     */connect(){return r(this,void 0,void 0,(function*(){a(this,G,"m",Y).call(this,"state","loading");try{this.walletAddress||(yield a(this,G,"m",X).call(this)),this.walletAddress=t.checksumAddress(this.walletAddress);const e=yield a(this,G,"m",ee).call(this),n=a(this,G,"m",ne).call(this,e),i=yield this.viem.signMessage({account:this.walletAddress,message:n}),r=yield a(this,G,"m",te).call(this,n,i);if(r.success)return this.isAuthenticated=!0,this.userId=r.userId,this.jwt=r.token,this.origin=new ue(this.jwt,this.viem),localStorage.setItem("camp-sdk:jwt",this.jwt),localStorage.setItem("camp-sdk:wallet-address",this.walletAddress),localStorage.setItem("camp-sdk:user-id",this.userId),a(this,G,"m",Y).call(this,"state","authenticated"),yield a(this,G,"m",ie).call(this,T.USER_CONNECTED,"User Connected"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,a(this,G,"m",Y).call(this,"state","unauthenticated"),new o("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,a(this,G,"m",Y).call(this,"state","unauthenticated"),new o(e)}}))}
/**
...
//   "Twitter Linked"
// );
window.location.href=`${v}/twitter/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.twitter}`}))}
/**
...
//   "Discord Linked"
// );
window.location.href=`${v}/discord/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.discord}`}))}
/**
...
//   "Spotify Linked"
// );
window.location.href=`${v}/spotify/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.spotify}`}))}
/**
...
/**
     ...
     * @throws {Error|APIError} - Throws an error if the user is not authenticated.
     */sendTelegramOTP(e){return r(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(!e)throw new o("Phone number is required");yield this.unlinkTelegram();const t=yield fetch(`${v}/telegram/sendOTP-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({phone:e})}).then((e=>e.json()));if(t.isError)throw new o(t.message||"Failed to send Telegram OTP");return t.data}))}
/**
...
/**
     ...
     */
constructor(e){if(!e||!e.apiKey||"string"!=typeof e.apiKey||""===e.apiKey.trim())throw new d("API key is required and must be a non-empty string");this.apiKey=e.apiKey.trim()}
/**
     * Fetch the user's saved tracks by Spotify user ID.
     * @param {string} spotifyId - The user's Spotify ID.
     * @returns {Promise<object>} - The saved tracks.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchSavedTracksById(e){return r(this,void 0,void 0,(function*(){if(!e||"string"!=typeof e||""===e.trim())throw new d("Spotify ID is required and must be a non-empty string");const t=l(`${c}/save-tracks`,{spotifyId:e.trim()});return this._fetchDataWithAuth(t)}))}
/**
     * Fetch the played tracks of a user by Spotify ID.
     * @param {string} spotifyId - The user's Spotify ID.
     * @returns {Promise<object>} - The played tracks.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchPlayedTracksById(e){return r(this,void 0,void 0,(function*(){if(!e||"string"!=typeof e||""===e.trim())throw new d("Spotify ID is required and must be a non-empty string");const t=l(`${c}/played-tracks`,{spotifyId:e.trim()});return this._fetchDataWithAuth(t)}))}
/**
     * Fetch the user's saved albums by Spotify user ID.
     * @param {string} spotifyId - The user's Spotify ID.
     * @returns {Promise<object>} - The saved albums.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchSavedAlbumsById(e){return r(this,void 0,void 0,(function*(){if(!e||"string"!=typeof e||""===e.trim())throw new d("Spotify ID is required and must be a non-empty string");const t=l(`${c}/saved-albums`,{spotifyId:e.trim()});return this._fetchDataWithAuth(t)}))}
/**
     * Fetch the user's saved playlists by Spotify user ID.
     * @param {string} spotifyId - The user's Spotify ID.
     * @returns {Promise<object>} - The saved playlists.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchSavedPlaylistsById(e){return r(this,void 0,void 0,(function*(){if(!e||"string"!=typeof e||""===e.trim())throw new d("Spotify ID is required and must be a non-empty string");const t=l(`${c}/saved-playlists`,{spotifyId:e.trim()});return this._fetchDataWithAuth(t)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchTracksInAlbum(e,t){return r(this,void 0,void 0,(function*(){if(!e||"string"!=typeof e||""===e.trim())throw new d("Spotify ID is required and must be a non-empty string");if(!t||"string"!=typeof t||""===t.trim())throw new d("Album ID is required and must be a non-empty string");const n=l(`${c}/album/tracks`,{spotifyId:e.trim(),albumId:t.trim()});return this._fetchDataWithAuth(n)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchTracksInPlaylist(e,t){return r(this,void 0,void 0,(function*(){if(!e||"string"!=typeof e||""===e.trim())throw new d("Spotify ID is required and must be a non-empty string");if(!t||"string"!=typeof t||""===t.trim())throw new d("Playlist ID is required and must be a non-empty string");const n=l(`${c}/playlist/tracks`,{spotifyId:e.trim(),playlistId:t.trim()});return this._fetchDataWithAuth(n)}))}
/**
     * Fetch the user's Spotify data by wallet address.
     * @param {string} walletAddress - The wallet address.
     * @returns {Promise<object>} - The user's Spotify data.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchUserByWalletAddress(e){return r(this,void 0,void 0,(function*(){if(!e||"string"!=typeof e||""===e.trim())throw new d("Wallet address is required and must be a non-empty string");
// Basic Ethereum address format validation
const t=e.trim();if(!/^0x[a-fA-F0-9]{40}$/.test(t))throw new d("Invalid wallet address format");const n=l(`${c}/wallet-spotify-data`,{walletAddress:t});return this._fetchDataWithAuth(n)}))}
/**
     * Private method to fetch data with authorization header.
     * @param {string} url - The URL to fetch.
     * @returns {Promise<object>} - The response data.
     * @throws {APIError} - Throws an error if the request fails.
     */_fetchDataWithAuth(e){return r(this,void 0,void 0,(function*(){if(!this.apiKey)throw new o("API key is required for fetching data",401);try{return yield u(e,{"x-api-key":this.apiKey})}catch(e){throw new o(e.message,e.statusCode)}}))}},exports.TwitterAPI=
/**
...
/**
     ...
     */
constructor({apiKey:e}){if(!e||"string"!=typeof e||""===e.trim())throw new d("API key is required and must be a non-empty string");this.apiKey=e.trim()}
/**
     * Fetch Twitter user details by username.
     * @param {string} twitterUserName - The Twitter username.
     * @returns {Promise<object>} - The user details.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchUserByUsername(e){return r(this,void 0,void 0,(function*(){if(!e||"string"!=typeof e||""===e.trim())throw new d("Twitter username is required and must be a non-empty string");const t=e.trim();
// Basic Twitter username validation (no @ symbol, alphanumeric + underscore)
if(!/^[a-zA-Z0-9_]{1,15}$/.test(t))throw new d("Invalid Twitter username format");const n=l(`${p}/user`,{twitterUserName:t});return this._fetchDataWithAuth(n)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchTweetsByUsername(e){return r(this,arguments,void 0,(function*(e,t=1,n=10){if(!e||"string"!=typeof e||""===e.trim())throw new d("Twitter username is required and must be a non-empty string");const i=e.trim();if(!/^[a-zA-Z0-9_]{1,15}$/.test(i))throw new d("Invalid Twitter username format");if(!Number.isInteger(t)||t<1)throw new d("Page must be a positive integer");if(!Number.isInteger(n)||n<1||n>100)throw new d("Limit must be a positive integer between 1 and 100");const r=l(`${p}/tweets`,{twitterUserName:i,page:t,limit:n});return this._fetchDataWithAuth(r)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchFollowersByUsername(e){return r(this,arguments,void 0,(function*(e,t=1,n=10){const{validatedUsername:i,validatedPage:r,validatedLimit:a}=this._validateUsernamePageLimit(e,t,n),s=l(`${p}/followers`,{twitterUserName:i,page:r,limit:a});return this._fetchDataWithAuth(s)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchFollowingByUsername(e){return r(this,arguments,void 0,(function*(e,t=1,n=10){const{validatedUsername:i,validatedPage:r,validatedLimit:a}=this._validateUsernamePageLimit(e,t,n),s=l(`${p}/following`,{twitterUserName:i,page:r,limit:a});return this._fetchDataWithAuth(s)}))}
/**
     * Fetch tweet by tweet ID.
     * @param {string} tweetId - The tweet ID.
     * @returns {Promise<object>} - The tweet.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchTweetById(e){return r(this,void 0,void 0,(function*(){if(!e||"string"!=typeof e||""===e.trim())throw new d("Tweet ID is required and must be a non-empty string");const t=e.trim();
// Basic tweet ID validation (should be numeric)
if(!/^\d+$/.test(t))throw new d("Invalid tweet ID format");const n=l(`${p}/getTweetById`,{tweetId:t});return this._fetchDataWithAuth(n)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchUserByWalletAddress(e){return r(this,arguments,void 0,(function*(e,t=1,n=10){if(!e||"string"!=typeof e||""===e.trim())throw new d("Wallet address is required and must be a non-empty string");const i=e.trim();if(!/^0x[a-fA-F0-9]{40}$/.test(i))throw new d("Invalid wallet address format");if(!Number.isInteger(t)||t<1)throw new d("Page must be a positive integer");if(!Number.isInteger(n)||n<1||n>100)throw new d("Limit must be a positive integer between 1 and 100");const r=l(`${p}/wallet-twitter-data`,{walletAddress:i,page:t,limit:n});return this._fetchDataWithAuth(r)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchRepostedByUsername(e){return r(this,arguments,void 0,(function*(e,t=1,n=10){const{validatedUsername:i,validatedPage:r,validatedLimit:a}=this._validateUsernamePageLimit(e,t,n),s=l(`${p}/reposted`,{twitterUserName:i,page:r,limit:a});return this._fetchDataWithAuth(s)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchRepliesByUsername(e){return r(this,arguments,void 0,(function*(e,t=1,n=10){const{validatedUsername:i,validatedPage:r,validatedLimit:a}=this._validateUsernamePageLimit(e,t,n),s=l(`${p}/replies`,{twitterUserName:i,page:r,limit:a});return this._fetchDataWithAuth(s)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchLikesByUsername(e){return r(this,arguments,void 0,(function*(e,t=1,n=10){const{validatedUsername:i,validatedPage:r,validatedLimit:a}=this._validateUsernamePageLimit(e,t,n),s=l(`${p}/event/likes/${i}`,{page:r,limit:a});return this._fetchDataWithAuth(s)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchFollowsByUsername(e){return r(this,arguments,void 0,(function*(e,t=1,n=10){const{validatedUsername:i,validatedPage:r,validatedLimit:a}=this._validateUsernamePageLimit(e,t,n),s=l(`${p}/event/follows/${i}`,{page:r,limit:a});return this._fetchDataWithAuth(s)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchViewedTweetsByUsername(e){return r(this,arguments,void 0,(function*(e,t=1,n=10){const{validatedUsername:i,validatedPage:r,validatedLimit:a}=this._validateUsernamePageLimit(e,t,n),s=l(`${p}/event/viewed-tweets/${i}`,{page:r,limit:a});return this._fetchDataWithAuth(s)}))}
/**
     ...
     */_validateUsernamePageLimit(e,t,n){if(!e||"string"!=typeof e||""===e.trim())throw new d("Twitter username is required and must be a non-empty string");const i=e.trim();if(!/^[a-zA-Z0-9_]{1,15}$/.test(i))throw new d("Invalid Twitter username format");if(!Number.isInteger(t)||t<1)throw new d("Page must be a positive integer");if(!Number.isInteger(n)||n<1||n>100)throw new d("Limit must be a positive integer between 1 and 100");return{validatedUsername:i,validatedPage:t,validatedLimit:n}}
/**
     * Private method to fetch data with authorization header.
     * @param {string} url - The URL to fetch.
     * @returns {Promise<object>} - The response data.
     * @throws {APIError} - Throws an error if the request fails.
     */_fetchDataWithAuth(e){return r(this,void 0,void 0,(function*(){if(!this.apiKey)throw new o("API key is required for fetching data",401);try{return yield u(e,{"x-api-key":this.apiKey})}catch(e){throw new o(e.message,e.statusCode)}}))}};
