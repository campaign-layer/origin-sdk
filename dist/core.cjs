...
/**
     ...
     * ```
     */getRoyalties(e,n){return a(this,void 0,void 0,(function*(){const i=yield r(this,q,"m",K).call(this,n);try{const n=yield this.getOrCreateRoyaltyVault(i,!0),a=m();let r,s;if(e&&e!==t.zeroAddress){
// erc20 (wrapped camp)
...
/**
     ...
     *  console.log(state);
     * });
     */on(e,t){r(this,G,"f")[e]||(r(this,G,"f")[e]=[]),r(this,G,"f")[e].push(t),"providers"===e&&t(g())}
/**
