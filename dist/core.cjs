 ...
 */function I(e,t,n,i,r,s,o,d){return a(this,void 0,void 0,(function*(){return console.log("mintWithSignature",this.environment),yield this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"mintWithSignature",
...
o,u,n,i,d);if("0x1"!==l.status)throw new Error(`Minting Social IpNFT failed with status: ${l.status}`);return r.toString()})),this.getOriginUploads=()=>a(this,void 0,void 0,(function*(){const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/auth/origin/files`,{method:"GET",headers:{Authorization:`Bearer ${this.jwt}`}});if(!e.ok)return console.error("Failed to get origin uploads"),null;return(yield e.json()).data})),this.jwt=t,this.viemClient=i,this.environment=n,
// DataNFT methods
this.mintWithSignature=I.bind(this),this.registerIpNFT=g.bind(this),this.updateTerms=b.bind(this),this.requestDelete=E.bind(this),this.getTerms=_.bind(this),this.ownerOf=C.bind(this),this.balanceOf=S.bind(this),this.contentHash=k.bind(this),this.tokenURI=D.bind(this),this.dataStatus=P.bind(this),this.royaltyInfo=N.bind(this),this.getApproved=x.bind(this),this.isApprovedForAll=M.bind(this),this.transferFrom=U.bind(this),this.safeTransferFrom=B.bind(this),this.approve=O.bind(this),this.setApprovalForAll=F.bind(this),
// Marketplace methods
