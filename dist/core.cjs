...
let _;_=P?w>I?"dispute_succeeds":"dispute_fails":"no_quorum";
// calculate timeline
const D=BigInt(Math.floor(Date.now()/1e3)),R=new Date(1e3*Number(v)),x=new Date(1e3*Number(v+h));let N,k;f===exports.DisputeStatus.Asserted?(
...
N=new Date(1e3*Number(v+h+T)),k=v+h+T);const M=(f===exports.DisputeStatus.Raised||f===exports.DisputeStatus.Asserted)&&D>k,O=M?0:Number(k-D);return{disputeId:e,status:f,yesVotes:w,noVotes:I,totalVotes:g,yesPercentage:b,noPercentage:E,quorum:m,quorumPercentage:S,quorumMet:P,projectedOutcome:_,timeline:{raisedAt:R,cooldownEndsAt:x,votingEndsAt:N,canResolveNow:M,timeUntilResolution:O}}}))}
/**
 ...
 * ```
 */function De(e){return a(this,void 0,void 0,(function*(){return this.callContractMethod(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,this.environment.FRACTIONALIZER_ABI,"fractionalize",[e],{waitForReceipt:!0})}))}
/**
 ...
 * }
 * ```
 */function xe(e){return a(this,void 0,void 0,(function*(){return this.callContractMethod(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,this.environment.FRACTIONALIZER_ABI,"getTokenForNFT",[e])}))}
/**
 ...
 * ```
 */function Ne(e){return a(this,void 0,void 0,(function*(){return yield this.approve(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,e),this.callContractMethod(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,this.environment.FRACTIONALIZER_ABI,"fractionalize",[e],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function Be(e){return a(this,void 0,void 0,(function*(){return this.callContractMethod(this.environment.APP_REGISTRY_CONTRACT_ADDRESS,this.environment.APP_REGISTRY_ABI,"getAppInfo",[e])}))}
/**
...
this.raiseDispute=Ae.bind(this),this.disputeAssertion=we.bind(this),this.voteOnDispute=Ie.bind(this),this.resolveDispute=ge.bind(this),this.cancelDispute=be.bind(this),this.tagChildIp=Ce.bind(this),this.getDispute=Ee.bind(this),this.canVoteOnDispute=Pe.bind(this),this.getDisputeProgress=_e.bind(this),
// Fractionalizer module methods
this.fractionalize=De.bind(this),this.redeem=Re.bind(this),this.getTokenForNFT=xe.bind(this),this.fractionalizeWithApproval=Ne.bind(this),this.redeemIfComplete=ke.bind(this),this.getFractionOwnership=Oe.bind(this),this.canFractionalize=Fe.bind(this),
// AppRegistry module methods
this.getAppInfo=Be.bind(this)}getJwt(){return this.jwt}setViemClient(e){this.viemClient=e}
/**
...
/**
     ...
     * @throws {Error} - Throws an error if the user is not authenticated.
     * @throws {APIError} - Throws an error if the request fails.
     */unlinkTelegram(){return a(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new f("User must be authenticated to unlink Telegram account");const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/telegram/disconnect-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({userId:this.userId})}).then((e=>e.json()));if(e.isError)throw new h(e.message||"Failed to unlink Telegram account");return e.data}))}},exports.BrowserStorage=l,exports.CustomSignerAdapter=u,exports.EthersSignerAdapter=d,exports.MemoryStorage=y,exports.Origin=ct,exports.ViemSignerAdapter=o,exports.campMainnet=m,exports.campTestnet=c,exports.createLicenseTerms=(e,t,n,i,a=exports.LicenseType.DURATION_BASED)=>{if(n<F||n>B)throw new Error(`Royalty basis points must be between ${F} and ${B}`);if(a===exports.LicenseType.DURATION_BASED){if(t<M||t>k)throw new Error(`Duration must be between ${M} and ${k} seconds for DURATION_BASED licenses`)}else if((a===exports.LicenseType.SINGLE_PAYMENT||a===exports.LicenseType.X402)&&t>0)throw new Error(`Duration must be 0 for ${exports.LicenseType[a]} licenses`);if(e<O)throw new Error(`Price must be at least ${O} wei`);return{price:e,duration:t,royaltyBps:n,paymentToken:i,licenseType:a}},exports.createNodeWalletClient=function(t,n,i){return e.createWalletClient({account:t,chain:n,transport:e.http(i)})},exports.createSignerAdapter=p;
