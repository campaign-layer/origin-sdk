...
/**
     ...
     */callContractMethod(t,n,i,s){return a(this,arguments,void 0,(function*(t,n,i,a,s={}){const o=e.getAbiItem({abi:n,name:i}),d=o&&"stateMutability"in o&&("view"===o.stateMutability||"pure"===o.stateMutability);if(!d&&!this.viemClient)throw new Error("WalletClient not connected.");if(d){const e=m();return(yield e.readContract({address:t,abi:n,functionName:i,args:a}))||null}{const[o]=yield this.viemClient.getAddresses(),d=e.encodeFunctionData({abi:n,functionName:i,args:a});yield r(this,k,"m",S).call(this,p);const u=yield this.viemClient.sendTransaction({to:t,data:d,account:o,value:s.value,gas:s.gas});if(s.waitForReceipt){return yield r(this,k,"m",E).call(this,u)}return u}}))}}A=new WeakMap,C=new WeakMap,k=new WeakSet,E=function(t){return a(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected.");for(;;){const e=yield this.viemClient.request({method:"eth_getTransactionReceipt",params:[t]});if(e&&e.blockNumber)return e;yield new Promise((t=>setTimeout(t,1e3)))}}))},S=function(t){return a(this,void 0,void 0,(function*(){
// return;
...
// Unrecognized chain
if(4902!==e.code)throw e;yield this.viemClient.request({method:"wallet_addEthereumChain",params:[{chainId:"0x"+BigInt(t.id).toString(16),chainName:t.name,rpcUrls:t.rpcUrls.default.http,nativeCurrency:t.nativeCurrency}]}),yield this.viemClient.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x"+BigInt(t.id).toString(16)}]})}}))},B.prototype.mintWithSignature=function(t,e,n,i,a,r,s){return this.callContractMethod(T,F,"mintWithSignature",[t,e,n,i,a,r,s.v,s.r,s.s])},B.prototype.updateTerms=function(t,e){return this.callContractMethod(T,F,"updateTerms",[t,e])},B.prototype.requestDelete=function(t){return this.callContractMethod(T,F,"requestDelete",[t])},B.prototype.getTerms=function(t){return this.callContractMethod(T,F,"getTerms",[t])},B.prototype.ownerOf=function(t){return this.callContractMethod(T,F,"ownerOf",[t])},B.prototype.balanceOf=function(t){return this.callContractMethod(T,F,"balanceOf",[t])},B.prototype.contentHash=function(t){return this.callContractMethod(T,F,"contentHash",[t])},B.prototype.tokenURI=function(t){return this.callContractMethod(T,F,"tokenURI",[t])},B.prototype.dataStatus=function(t){return this.callContractMethod(T,F,"dataStatus",[t])},B.prototype.royaltyInfo=function(t,e){return a(this,void 0,void 0,(function*(){return this.callContractMethod(T,F,"royaltyInfo",[t,e])}))},B.prototype.getApproved=function(t){return this.callContractMethod(T,F,"getApproved",[t])},B.prototype.isApprovedForAll=function(t,e){return this.callContractMethod(T,F,"isApprovedForAll",[t,e])},B.prototype.transferFrom=function(t,e,n){return this.callContractMethod(T,F,"transferFrom",[t,e,n])},B.prototype.safeTransferFrom=function(t,e,n,i){const a=i?[t,e,n,i]:[t,e,n];return this.callContractMethod(T,F,"safeTransferFrom",a)},B.prototype.approve=function(t,e){return this.callContractMethod(T,F,"approve",[t,e])},B.prototype.setApprovalForAll=function(t,e){return this.callContractMethod(T,F,"setApprovalForAll",[t,e])};M=new WeakMap,j=new WeakMap,$=new WeakSet,x=function(t,e){r(this,M,"f")[t]&&r(this,M,"f")[t].forEach((t=>t(e)))},U=function(t){return a(this,void 0,void 0,(function*(){var e,n;if("undefined"==typeof localStorage)return;const i=null===localStorage||void 0===localStorage?void 0:localStorage.getItem("camp-sdk:wallet-address"),a=null===localStorage||void 0===localStorage?void 0:localStorage.getItem("camp-sdk:user-id"),r=null===localStorage||void 0===localStorage?void 0:localStorage.getItem("camp-sdk:jwt");if(i&&a&&r){this.walletAddress=i,this.userId=a,this.jwt=r,this.origin=new B(this.jwt),this.isAuthenticated=!0;let s=t;if(!s){const t=null!==(e=b())&&void 0!==e?e:[];for(const e of t)try{if((null===(n=(yield e.provider.request({method:"eth_accounts"}))[0])||void 0===n?void 0:n.toLowerCase())===i.toLowerCase()){s=e.provider;break}}catch(t){console.warn("Failed to fetch accounts from provider:",t)}}s&&
// this.viem = getClient(
//   selectedProvider,
...
this.setProvider({provider:s,info:{name:"reinitialized",version:"1.0.0"},address:i})}else this.isAuthenticated=!1}))},D=function(){return a(this,void 0,void 0,(function*(){try{const[t]=yield this.viem.requestAddresses();return this.walletAddress=t,t}catch(t){throw new o(t)}}))},O=function(){return a(this,void 0,void 0,(function*(){try{const t=yield fetch(`${w}/auth/client-user/nonce`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({walletAddress:this.walletAddress})}),e=yield t.json();return 200!==t.status?Promise.reject(e.message||"Failed to fetch nonce"):e.data}catch(t){throw new Error(t)}}))},P=function(t,e){return a(this,void 0,void 0,(function*(){try{const n=yield fetch(`${w}/auth/client-user/verify`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({message:t,signature:e,walletAddress:this.walletAddress})}),i=yield n.json(),a=i.data.split(".")[1],r=JSON.parse(atob(a));return{success:!i.isError,userId:r.id,token:i.data}}catch(t){throw new o(t)}}))},N=function(t){return i.createSiweMessage({domain:window.location.host,address:this.walletAddress,statement:f,uri:window.location.origin,version:"1",chainId:this.viem.chain.id,nonce:t})},_=function(t,e){return a(this,arguments,void 0,(function*(t,e,n=1){
...
/**
     ...
     */
constructor({clientId:t,redirectUri:e,allowAnalytics:n=!0,ackeeInstance:i}){if($.add(this),M.set(this,void 0),j.set(this,void 0),!t)throw new Error("clientId is required");this.viem=null,
// if (typeof window !== "undefined") {
//   if (window.ethereum) this.viem = getClient(window.ethereum);
// }
this.redirectUri=(t=>{const e=["twitter","discord","spotify"];return"object"==typeof t?e.reduce(((e,n)=>(e[n]=t[n]||("undefined"!=typeof window?window.location.href:""),e)),{}):"string"==typeof t?e.reduce(((e,n)=>(e[n]=t,e)),{}):t?{}:e.reduce(((t,e)=>(t[e]="undefined"!=typeof window?window.location.href:"",t)),{})})(e),i&&s(this,j,i,"f"),n&&r(this,j,"f"),this.clientId=t,this.isAuthenticated=!1,this.jwt=null,this.origin=null,this.walletAddress=null,this.userId=null,s(this,M,{},"f"),I((t=>{r(this,$,"m",x).call(this,"providers",t)})),r(this,$,"m",U).call(this)}
/**
     ...
     *  console.log(state);
     * });
     */on(t,e){r(this,M,"f")[t]||(r(this,M,"f")[t]=[]),r(this,M,"f")[t].push(e),"providers"===t&&e(b())}
/**
     * Set the loading state.
     * @param {boolean} loading The loading state.
     * @returns {void}
     */setLoading(t){r(this,$,"m",x).call(this,"state",t?"loading":this.isAuthenticated?"authenticated":"unauthenticated")}
/**
     * Set the provider. This is useful for setting the provider when the user selects a provider from the UI or when dApp wishes to use a specific provider.
     * @param {object} options The options object. Includes the provider and the provider info.
     * @returns {void}
     * @throws {APIError} - Throws an error if the provider is not provided.
     */setProvider({provider:t,info:i,address:a}){if(!t)throw new o("provider is required");this.viem=((t,i="window.ethereum",a)=>{var r;if(!t&&!h)return console.warn("Provider is required to create a client."),null;if(!h||h.transport.name!==i&&t||a!==(null===(r=h.account)||void 0===r?void 0:r.address)&&t){const r={chain:p,transport:e.custom(t,{name:i})};a&&(r.account=n.toAccount(a)),h=e.createWalletClient(r)}return h})(t,i.name,a),this.origin&&this.origin.setViemClient(this.viem),r(this,$,"m",x).call(this,"viem",this.viem),r(this,$,"m",x).call(this,"provider",{provider:t,info:i})}
/**
...
/**
     * Disconnect the user.
     * @returns {Promise<void>}
     */disconnect(){return a(this,void 0,void 0,(function*(){this.isAuthenticated&&(this.isAuthenticated=!1,this.walletAddress=null,this.userId=null,this.jwt=null,this.origin=null,localStorage.removeItem("camp-sdk:wallet-address"),localStorage.removeItem("camp-sdk:user-id"),localStorage.removeItem("camp-sdk:jwt"),r(this,$,"m",x).call(this,"state","unauthenticated"),yield r(this,$,"m",_).call(this,v.USER_DISCONNECTED,"User Disconnected"))}))}
/**
     * Connect the user's wallet and sign the message.
     * @returns {Promise<{ success: boolean; message: string; walletAddress: string }>} A promise that resolves with the authentication result.
     * @throws {APIError} - Throws an error if the user cannot be authenticated.
     */connect(){return a(this,void 0,void 0,(function*(){r(this,$,"m",x).call(this,"state","loading");try{this.walletAddress||(yield r(this,$,"m",D).call(this));const t=yield r(this,$,"m",O).call(this),e=r(this,$,"m",N).call(this,t),n=yield this.viem.signMessage({account:this.walletAddress,message:e}),i=yield r(this,$,"m",P).call(this,e,n);if(i.success)return this.isAuthenticated=!0,this.userId=i.userId,this.jwt=i.token,this.origin=new B(this.jwt,this.viem),localStorage.setItem("camp-sdk:jwt",this.jwt),localStorage.setItem("camp-sdk:wallet-address",this.walletAddress),localStorage.setItem("camp-sdk:user-id",this.userId),r(this,$,"m",x).call(this,"state","authenticated"),yield r(this,$,"m",_).call(this,v.USER_CONNECTED,"User Connected"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,r(this,$,"m",x).call(this,"state","unauthenticated"),new o("Failed to authenticate")}catch(t){throw this.isAuthenticated=!1,r(this,$,"m",x).call(this,"state","unauthenticated"),new o(t)}}))}
/**
...
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchSavedTracksById(t){return a(this,void 0,void 0,(function*(){const e=u(`${c}/save-tracks`,{spotifyId:t});return this._fetchDataWithAuth(e)}))}
/**
     * Fetch the played tracks of a user by Spotify ID.
     * @param {string} spotifyId - The user's Spotify ID.
     * @returns {Promise<object>} - The played tracks.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchPlayedTracksById(t){return a(this,void 0,void 0,(function*(){const e=u(`${c}/played-tracks`,{spotifyId:t});return this._fetchDataWithAuth(e)}))}
/**
     * Fetch the user's saved albums by Spotify user ID.
     * @param {string} spotifyId - The user's Spotify ID.
     * @returns {Promise<object>} - The saved albums.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchSavedAlbumsById(t){return a(this,void 0,void 0,(function*(){const e=u(`${c}/saved-albums`,{spotifyId:t});return this._fetchDataWithAuth(e)}))}
/**
     * Fetch the user's saved playlists by Spotify user ID.
     * @param {string} spotifyId - The user's Spotify ID.
     * @returns {Promise<object>} - The saved playlists.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchSavedPlaylistsById(t){return a(this,void 0,void 0,(function*(){const e=u(`${c}/saved-playlists`,{spotifyId:t});return this._fetchDataWithAuth(e)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchTracksInAlbum(t,e){return a(this,void 0,void 0,(function*(){const n=u(`${c}/album/tracks`,{spotifyId:t,albumId:e});return this._fetchDataWithAuth(n)}))}
/**
     ...
     * @throws {APIError} - Throws an error if the request fails.
     */fetchTracksInPlaylist(t,e){return a(this,void 0,void 0,(function*(){const n=u(`${c}/playlist/tracks`,{spotifyId:t,playlistId:e});return this._fetchDataWithAuth(n)}))}
/**
     * Fetch the user's Spotify data by wallet address.
     * @param {string} walletAddress - The wallet address.
     * @returns {Promise<object>} - The user's Spotify data.
     * @throws {APIError} - Throws an error if the request fails.
     */fetchUserByWalletAddress(t){return a(this,void 0,void 0,(function*(){const e=u(`${c}/wallet-spotify-data`,{walletAddress:t});return this._fetchDataWithAuth(e)}))}
/**
