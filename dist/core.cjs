 ...
 */
function F(e,t,n,i,r,s,o,d,u,p){return a(this,void 0,void 0,(function*(){var a;
// Use provided appId, or fall back to SDK's appId, or use empty string
const l=null!==(a=null!=p?p:this.appId)&&void 0!==a?a:"";return yield this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"mintWithSignature",[e,t,r,s,o,d,n,i,l,u],{waitForReceipt:!0})}))}
/**
 ...
 */function U(e,t,n,i,r,s){return a(this,void 0,void 0,(function*(){const a={source:e,deadline:Number(t),licenseTerms:{price:n.price.toString(),duration:n.duration,royaltyBps:n.royaltyBps,paymentToken:n.paymentToken,licenseType:n.licenseType},metadata:i,parentId:s?s.map((e=>e.toString())):[]};void 0!==r&&(a.fileKey=r);const o=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/register`,{method:"POST",headers:{Authorization:`Bearer ${this.getJwt()}`,"Content-Type":"application/json"},body:JSON.stringify(a)}),d=yield o.json();if(d.isError)throw new Error(`Failed to get signature: ${d.message}`);if(!o.ok)throw new Error(`Failed to get signature: ${o.statusText}`);return d.data}))}
/**
 ...
 */function X(e,t,n,i,a,r=0,s=0,o){return this.callContractMethod(this.environment.MARKETPLACE_CONTRACT_ADDRESS,this.environment.MARKETPLACE_ABI,"buyAccess",[e,t,n,i,a,r,s],{waitForReceipt:!0,value:o})}
/**
 ...
 */var ae,re,se;exports.LicenseType=void 0,(ae=exports.LicenseType||(exports.LicenseType={}))[ae.DURATION_BASED=0]="DURATION_BASED",ae[ae.SINGLE_PAYMENT=1]="SINGLE_PAYMENT",ae[ae.X402=2]="X402",
/**
 ...
 */
exports.DisputeStatus=void 0,(se=exports.DisputeStatus||(exports.DisputeStatus={}))[se.Uninitialized=0]="Uninitialized",se[se.Raised=1]="Raised",se[se.Asserted=2]="Asserted",se[se.Resolved=3]="Resolved",se[se.Cancelled=4]="Cancelled";
/**
 ...
 */
const oe={X402Intent:[{name:"payer",type:"address"},{name:"asset",type:"address"},{name:"amount",type:"uint256"},{name:"httpMethod",type:"string"},{name:"payTo",type:"address"},{name:"tokenId",type:"uint256"},{name:"duration",type:"uint32"},{name:"expiresAt",type:"uint256"},{name:"nonce",type:"bytes32"}]},de=(e,t,n)=>a(void 0,void 0,void 0,(function*(){return yield fetch(`${e.environment.AUTH_HUB_BASE_API}/${e.environment.AUTH_ENDPOINT}/origin/data/${t}`,{method:"GET",headers:Object.assign({"Content-Type":"application/json"},n)})}))
/**
 * EXPERIMENTAL METHOD
 ...
 */function ue(t,n,i){return a(this,void 0,void 0,(function*(){var a;const r=this.viemClient;if(!n&&!r)throw new Error("No signer or wallet client provided for X402 intent.");const s=yield de(this,t,{});if(402!==s.status){if(!s.ok)throw new Error("Failed to fetch data");return s.json()}const o=r||p(n),d=r?yield ye.call(this):yield o.getAddress(),u=yield s.json();if(u.error)throw new Error(u.error);const l=u.accepts[0],y=yield pe.call(this,l,e.checksumAddress(d),o),c=btoa(JSON.stringify(y)),m=yield de(this,t,{"X-PAYMENT":c});if(402===m.status){
 ...
 * @private
 */function pe(t,n,i){return a(this,void 0,void 0,(function*(){const a="native"===t.asset?e.zeroAddress:t.asset,r=BigInt(t.maxAmountRequired||0),s=t.extra.duration,o=le.call(this),d=oe,u=crypto.randomUUID(),l=e.keccak256(e.toBytes(u)),y={payer:n,asset:a,amount:r.toString(),httpMethod:"GET",payTo:e.checksumAddress(this.environment.MARKETPLACE_CONTRACT_ADDRESS),tokenId:t.extra.tokenId,duration:s,expiresAt:Math.floor(Date.now()/1e3)+t.maxTimeoutSeconds,nonce:l},c=p(i),m=yield c.signTypedData(o,d,y);return{x402Version:1,scheme:"exact",network:t.network,payload:Object.assign(Object.assign({},y),{sigType:"eip712",signature:m,license:{tokenId:t.extra.tokenId,duration:s}})}}))}
/**
 * Create the X402 Intent domain for EIP-712 signing.
 * @private
 */function le(){return{name:"Origin X402 Intent",version:"1",chainId:this.environment.CHAIN.id,verifyingContract:this.environment.MARKETPLACE_CONTRACT_ADDRESS}}
/**
 * Get the current account address.
 * @private
 */function ye(){return a(this,void 0,void 0,(function*(){const e=this.viemClient;if(!e)throw new Error("WalletClient not connected. Please connect a wallet.");
 ...
 * );
 * ```
 */function ce(e,t,n){return a(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"raiseDispute",[e,t,n],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function me(e,t){return a(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"disputeAssertion",[e,t],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function he(e,t){return a(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"voteOnDispute",[e,t],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function Te(e){return a(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"resolveDispute",[e],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function fe(e){return a(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"cancelDispute",[e],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function ve(e,t){return a(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"tagChildIp",[e,t],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function Ae(e){return a(this,void 0,void 0,(function*(){if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");return this.callContractMethod(this.environment.DISPUTE_CONTRACT_ADDRESS,this.environment.DISPUTE_ABI,"disputes",[e])}))}
// Minimal ABI for staking vault
const we=[{inputs:[{name:"account",type:"address"}],name:"balanceOf",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"},{inputs:[{name:"account",type:"address"}],name:"userStakeTimestamp",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"}];
/**
 ...
 * }
 * ```
 */function Ie(e,t){return a(this,void 0,void 0,(function*(){var n,i,a,r,s;if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");
// Resolve voter address
let o;if(t)o=t;else{const e=this.viemClient;if(!e)throw new Error("No voter address provided and no wallet connected");if(e.account)o=e.account.address;else{const t=yield e.request({method:"eth_requestAccounts",params:[]});if(!t||0===t.length)throw new Error("No accounts found in connected wallet");o=t[0]}}const d=A(),u=this.environment.DISPUTE_CONTRACT_ADDRESS,p=this.environment.DISPUTE_ABI,[l,y,c,m,h,T]=yield Promise.all([d.readContract({address:u,abi:p,functionName:"disputes",args:[e]}),d.readContract({address:u,abi:p,functionName:"stakingVault",args:[]}),d.readContract({address:u,abi:p,functionName:"stakingThreshold",args:[]}),d.readContract({address:u,abi:p,functionName:"disputeCoolDownPeriod",args:[]}),d.readContract({address:u,abi:p,functionName:"disputeJudgementPeriod",args:[]}),d.readContract({address:u,abi:p,functionName:"hasVoted",args:[e,o]})]),f=Number(null!==(n=l.status)&&void 0!==n?n:l[9]),v=BigInt(null!==(a=null!==(i=l.disputeTimestamp)&&void 0!==i?i:l[5])&&void 0!==a?a:0),w=BigInt(null!==(s=null!==(r=l.assertionTimestamp)&&void 0!==r?r:l[6])&&void 0!==s?s:0),[I,g]=yield Promise.all([d.readContract({address:y,abi:we,functionName:"userStakeTimestamp",args:[o]}),d.readContract({address:y,abi:we,functionName:"balanceOf",args:[o]})]),b=BigInt(Math.floor(Date.now()/1e3));let E,C=!1;f===exports.DisputeStatus.Asserted?(
// For asserted disputes, voting period is relative to assertion timestamp
E=w+h,C=b<=E):f===exports.DisputeStatus.Raised&&(
// For raised disputes, voting period extends from cooldown through judgement
E=v+m+h,C=b<=E);
// Build base result
const S={canVote:!1,votingWeight:g,stakingThreshold:c,hasAlreadyVoted:T,userStakeTimestamp:I,disputeTimestamp:v,disputeStatus:f,isVotingPeriodActive:C};
// Check all requirements in order
return f!==exports.DisputeStatus.Raised&&f!==exports.DisputeStatus.Asserted?Object.assign(Object.assign({},S),{reason:`Dispute is not in a voteable status (current: ${exports.DisputeStatus[f]})`}):C?T?Object.assign(Object.assign({},S),{reason:"You have already voted on this dispute"}):I===BigInt(0)?Object.assign(Object.assign({},S),{reason:"You have never staked CAMP tokens"}):I>=v?Object.assign(Object.assign({},S),{reason:"You staked after this dispute was raised (vote recycling prevention)"}):g<c?Object.assign(Object.assign({},S),{reason:`Insufficient stake: you have ${g} but need at least ${c}`}):Object.assign(Object.assign({},S),{canVote:!0}):Object.assign(Object.assign({},S),{reason:"Voting period has ended"})}))}
/**
 ...
 * }
 * ```
 */function ge(e){return a(this,void 0,void 0,(function*(){var t,n,i,a,r,s,o,d,u;if(!this.environment.DISPUTE_CONTRACT_ADDRESS)throw new Error("Dispute contract address not configured");if(!this.environment.DISPUTE_ABI)throw new Error("Dispute ABI not configured");const p=A(),l=this.environment.DISPUTE_CONTRACT_ADDRESS,y=this.environment.DISPUTE_ABI,[c,m,h,T]=yield Promise.all([p.readContract({address:l,abi:y,functionName:"disputes",args:[e]}),p.readContract({address:l,abi:y,functionName:"disputeQuorum",args:[]}),p.readContract({address:l,abi:y,functionName:"disputeCoolDownPeriod",args:[]}),p.readContract({address:l,abi:y,functionName:"disputeJudgementPeriod",args:[]})]),f=Number(null!==(t=c.status)&&void 0!==t?t:c[9]),v=BigInt(null!==(i=null!==(n=c.disputeTimestamp)&&void 0!==n?n:c[5])&&void 0!==i?i:0),w=BigInt(null!==(r=null!==(a=c.assertionTimestamp)&&void 0!==a?a:c[6])&&void 0!==r?r:0),I=BigInt(null!==(o=null!==(s=c.yesVotes)&&void 0!==s?s:c[7])&&void 0!==o?o:0),g=BigInt(null!==(u=null!==(d=c.noVotes)&&void 0!==d?d:c[8])&&void 0!==u?u:0),b=I+g;let E=0,C=0;b>BigInt(0)&&(E=Number(I*BigInt(1e4)/b)/100,C=Number(g*BigInt(1e4)/b)/100);
// Calculate quorum progress
let S=0;m>BigInt(0)&&(S=Number(b*BigInt(1e4)/m)/100);const D=b>=m;
// Determine projected outcome
let _;_=D?I>g?"dispute_succeeds":"dispute_fails":"no_quorum";
// Calculate timeline
const R=BigInt(Math.floor(Date.now()/1e3)),P=new Date(1e3*Number(v)),N=new Date(1e3*Number(v+h));let x,k;f===exports.DisputeStatus.Asserted?(
...
x=new Date(1e3*Number(v+h+T)),k=v+h+T);const O=(f===exports.DisputeStatus.Raised||f===exports.DisputeStatus.Asserted)&&R>k,M=O?0:Number(k-R);return{disputeId:e,status:f,yesVotes:I,noVotes:g,totalVotes:b,yesPercentage:E,noPercentage:C,quorum:m,quorumPercentage:S,quorumMet:D,projectedOutcome:_,timeline:{raisedAt:P,cooldownEndsAt:N,votingEndsAt:x,canResolveNow:O,timeUntilResolution:M}}}))}
/**
 ...
 * ```
 */function be(e){return a(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");return this.callContractMethod(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,this.environment.FRACTIONALIZER_ABI,"fractionalize",[e],{waitForReceipt:!0})}))}
/**
 ...
 * ```
 */function Ee(e){return a(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");return this.callContractMethod(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,this.environment.FRACTIONALIZER_ABI,"redeem",[e],{waitForReceipt:!0})}))}
/**
 ...
 * }
 * ```
 */function Ce(e){return a(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");return this.callContractMethod(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,this.environment.FRACTIONALIZER_ABI,"getTokenForNFT",[e])}))}
/**
 ...
 * ```
 */function Se(e){return a(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");
// Approve the fractionalizer contract to transfer the NFT
// Then fractionalize
return yield this.approve(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,e),this.callContractMethod(this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,this.environment.FRACTIONALIZER_ABI,"fractionalize",[e],{waitForReceipt:!0})}))}
/**
 ...
 * }
 * ```
 */function De(e){return a(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");
...
const a=[{inputs:[{name:"owner",type:"address"}],name:"balanceOf",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"},{inputs:[],name:"totalSupply",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"}],r=A(),[s,o]=yield Promise.all([r.readContract({address:t,abi:a,functionName:"balanceOf",args:[i]}),r.readContract({address:t,abi:a,functionName:"totalSupply",args:[]})]);if(s<o){const e=s*BigInt(1e4)/o;throw new Error(`Cannot redeem: you own ${e/BigInt(100)}.${e%BigInt(100)}% of the fractional tokens (${s}/${o}). You need 100% to redeem.`)}
...
// Minimal ERC20 ABI
const _e=[{inputs:[{name:"owner",type:"address"}],name:"balanceOf",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"},{inputs:[],name:"totalSupply",outputs:[{name:"",type:"uint256"}],stateMutability:"view",type:"function"},{inputs:[],name:"decimals",outputs:[{name:"",type:"uint8"}],stateMutability:"view",type:"function"}];
/**
 ...
 * }
 * ```
 */function Re(t,n){return a(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");
// Resolve owner address
let i;if(n)i=n;else{const e=this.viemClient;if(!e)throw new Error("No owner address provided and no wallet connected");if(e.account)i=e.account.address;else{const t=yield e.request({method:"eth_requestAccounts",params:[]});if(!t||0===t.length)throw new Error("No accounts found in connected wallet");i=t[0]}}
// Get the ERC20 token address for this NFT
const a=yield this.getTokenForNFT(t);
// Check if fractionalized
if(!a||a===e.zeroAddress)return{tokenId:t,erc20Address:e.zeroAddress,isFractionalized:!1,balance:BigInt(0),totalSupply:BigInt(0),ownershipPercentage:0,canRedeem:!1,decimals:18};const r=A(),[s,o,d]=yield Promise.all([r.readContract({address:a,abi:_e,functionName:"balanceOf",args:[i]}),r.readContract({address:a,abi:_e,functionName:"totalSupply",args:[]}),r.readContract({address:a,abi:_e,functionName:"decimals",args:[]})]);
// Fetch ERC20 data
// Calculate ownership percentage
let u=0;o>BigInt(0)&&(u=Number(s*BigInt(1e4)/o)/100);const p=s>=o&&o>BigInt(0);return{tokenId:t,erc20Address:a,isFractionalized:!0,balance:s,totalSupply:o,ownershipPercentage:u,canRedeem:p,decimals:d}}))}
/**
 ...
 * }
 * ```
 */function Pe(t,n){return a(this,void 0,void 0,(function*(){if(!this.environment.FRACTIONALIZER_CONTRACT_ADDRESS)throw new Error("Fractionalizer contract address not configured");if(!this.environment.FRACTIONALIZER_ABI)throw new Error("Fractionalizer ABI not configured");
// Resolve owner address
let i;if(n)i=n;else{const e=this.viemClient;if(!e)throw new Error("No owner address provided and no wallet connected");if(e.account)i=e.account.address;else{const t=yield e.request({method:"eth_requestAccounts",params:[]});if(!t||0===t.length)throw new Error("No accounts found in connected wallet");i=t[0]}}const a=A(),r=this.environment.FRACTIONALIZER_CONTRACT_ADDRESS,[s,o,d,u,p]=yield Promise.all([this.ownerOf(t),this.dataStatus(t),this.getTokenForNFT(t),a.readContract({address:this.environment.DATANFT_CONTRACT_ADDRESS,abi:this.environment.IPNFT_ABI,functionName:"getApproved",args:[t]}),a.readContract({address:this.environment.DATANFT_CONTRACT_ADDRESS,abi:this.environment.IPNFT_ABI,functionName:"isApprovedForAll",args:[i,r]})]),l=s.toLowerCase()===i.toLowerCase(),y=d&&d!==e.zeroAddress,c=p||u.toLowerCase()===r.toLowerCase(),m={canFractionalize:!1,isOwner:l,currentOwner:s,isAlreadyFractionalized:!!y,existingErc20Address:y?d:void 0,dataStatus:o,isApproved:c,needsApproval:!c};
 ...
 * ```
 */function Ne(e){return a(this,void 0,void 0,(function*(){if(!this.environment.APP_REGISTRY_CONTRACT_ADDRESS)throw new Error("App registry contract address not configured");if(!this.environment.APP_REGISTRY_ABI)throw new Error("App registry ABI not configured");return this.callContractMethod(this.environment.APP_REGISTRY_CONTRACT_ADDRESS,this.environment.APP_REGISTRY_ABI,"getAppInfo",[e])}))}
/**
 * Approves a spender to spend a specified amount of tokens on behalf of the owner.
 * If the current allowance is less than the specified amount, it will perform the approval.
 * @param {ApproveParams} params - The parameters for the approval.
 */function xe(t){return a(this,arguments,void 0,(function*({walletClient:t,publicClient:n,tokenAddress:i,owner:a,spender:r,amount:s}){(yield n.readContract({address:i,abi:e.erc20Abi,functionName:"allowance",args:[a,r]}))<s&&(yield t.writeContract({address:i,account:a,abi:e.erc20Abi,functionName:"approve",args:[r,s],chain:c}))}))}
/**
 ...
 * ```
 */function ke(e,t,n){return this.callContractMethod(this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,this.environment.BATCH_PURCHASE_ABI,"bulkBuyAccess",[e,t],{waitForReceipt:!0,value:n})}
/**
 ...
 * ```
 */function Me(e){return this.callContractMethod(this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,this.environment.BATCH_PURCHASE_ABI,"previewBulkCost",[e])}
/**
 ...
 * ```
 */function Be(e){return this.callContractMethod(this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,this.environment.BATCH_PURCHASE_ABI,"buildPurchaseParams",[e])}
/**
 ...
 * ```
 */function Fe(e){return this.callContractMethod(this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,this.environment.BATCH_PURCHASE_ABI,"checkActiveStatus",[e])}
/**
 ...
 * ```
 */function Ue(t,n){return a(this,void 0,void 0,(function*(){if(!t||0===t.length)throw new Error("No token IDs provided for bulk purchase");
...
const d=A();for(const e of o)yield xe({walletClient:i,publicClient:d,tokenAddress:e.token,owner:a,spender:this.environment.BATCH_PURCHASE_CONTRACT_ADDRESS,amount:e.amount});
// Execute the purchase
return(null==n?void 0:n.tolerant)?this.bulkBuyAccessTolerant(a,r,s):this.bulkBuyAccess(a,r,s)}))}var He,je,$e,Le,ze,qe,Ve,Ze,We,Ge,Je,Ye,Ke,Xe,Qe,et,tt,nt,it,at,rt,st;
/**
 * The Origin class
 * Handles interactions with Origin protocol.
 */class ot{constructor(e,t,n,i,a){He.add(this),t?this.jwt=t:console.warn("JWT not provided. Some features may be unavailable."),this.viemClient=n,this.environment="string"==typeof e?k[e]:e||k.DEVELOPMENT,this.baseParentId=i,this.appId=a,
// DataNFT methods
this.mintWithSignature=F.bind(this),this.registerIpNFT=U.bind(this),this.updateTerms=H.bind(this),this.finalizeDelete=j.bind(this),this.getOrCreateRoyaltyVault=$.bind(this),this.getTerms=L.bind(this),this.ownerOf=z.bind(this),this.balanceOf=q.bind(this),this.tokenURI=V.bind(this),this.dataStatus=Z.bind(this),this.isApprovedForAll=W.bind(this),this.transferFrom=G.bind(this),this.safeTransferFrom=J.bind(this),this.approve=Y.bind(this),this.setApprovalForAll=K.bind(this),
// Marketplace methods
this.buyAccess=X.bind(this),this.hasAccess=Q.bind(this),this.subscriptionExpiry=ee.bind(this),this.settlePaymentIntent=ie.bind(this),this.getDataWithIntent=ue.bind(this),
// Bulk purchase methods
this.bulkBuyAccess=ke.bind(this),this.bulkBuyAccessTolerant=Oe.bind(this),this.bulkBuyAccessSmart=Ue.bind(this),this.previewBulkCost=Me.bind(this),this.buildPurchaseParams=Be.bind(this),this.checkActiveStatus=Fe.bind(this),
// Dispute module methods
this.raiseDispute=ce.bind(this),this.disputeAssertion=me.bind(this),this.voteOnDispute=he.bind(this),this.resolveDispute=Te.bind(this),this.cancelDispute=fe.bind(this),this.tagChildIp=ve.bind(this),this.getDispute=Ae.bind(this),this.canVoteOnDispute=Ie.bind(this),this.getDisputeProgress=ge.bind(this),
// Fractionalizer module methods
this.fractionalize=be.bind(this),this.redeem=Ee.bind(this),this.getTokenForNFT=Ce.bind(this),this.fractionalizeWithApproval=Se.bind(this),this.redeemIfComplete=De.bind(this),this.getFractionOwnership=Re.bind(this),this.canFractionalize=Pe.bind(this),
// AppRegistry module methods
this.getAppInfo=Ne.bind(this)}getJwt(){return this.jwt}setViemClient(e){this.viemClient=e}
/**
     ...
     */mintFile(e,t,n,i,s){return a(this,void 0,void 0,(function*(){let a,o=null;try{o=yield r(this,He,"m",Ze).call(this)}catch(e){throw new Error("Failed to mint file IP. Wallet not connected.")}try{if(a=yield r(this,He,"m",ze).call(this,e,s),!a||!a.key)throw new Error("Failed to upload file or get upload info.")}catch(e){throw new Error(`File upload failed: ${e instanceof Error?e.message:String(e)}`)}e.type&&(t.mimetype=e.type);let d=null;(null==s?void 0:s.previewImage)&&(null==s?void 0:s.previewImage.type.startsWith("image/"))?d=yield r(this,He,"m",Le).call(this,s.previewImage):(null==s?void 0:s.useAssetAsPreview)&&e.type.startsWith("image/")&&(d=yield r(this,He,"m",Le).call(this,e)),d&&(t.image=`ipfs://${d}`);const u=BigInt(Date.now()+6e5);// 10 minutes from now
let p;this.baseParentId&&(i||(i=[]),i.unshift(this.baseParentId));try{p=yield this.registerIpNFT("file",u,n,t,a.key,i)}catch(e){throw yield r(this,He,"m",$e).call(this,a.key,"failed"),new Error(`Failed to register IpNFT: ${e instanceof Error?e.message:String(e)}`)}const{tokenId:l,signerAddress:y,creatorContentHash:c,signature:m,uri:h}=p;if(!(l&&y&&c&&void 0!==m&&h))throw new Error("Failed to register IpNFT: Missing required fields in registration response.");try{const e=yield this.mintWithSignature(o,l,i||[],!0,c,h,n,u,m);if(-1===["0x1","success"].indexOf(e.receipt.status))throw yield r(this,He,"m",$e).call(this,a.key,"failed"),new Error(`Minting failed with status: ${e.receipt.status}`)}catch(e){throw yield r(this,He,"m",$e).call(this,a.key,"failed"),new Error(`Minting transaction failed: ${e instanceof Error?e.message:String(e)}`)}return l.toString()}))}
/**
     ...
     */mintSocial(e,t,n){return a(this,void 0,void 0,(function*(){let i=null;try{i=yield r(this,He,"m",Ze).call(this)}catch(e){throw new Error("Failed to mint social IP. Wallet not connected.")}t.mimetype=`social/${e}`;const a=BigInt(Math.floor(Date.now()/1e3)+600);// 10 minutes from now
...
/**
     ...
     */callContractMethod(t,n,i,s){return a(this,arguments,void 0,(function*(t,n,i,a,s={}){var o;let d=null;try{d=yield r(this,He,"m",Ze).call(this)}catch(e){throw new Error("Failed to call contract method. Wallet not connected.")}const u=e.getAbiItem({abi:n,name:i});if(u&&"stateMutability"in u&&("view"===u.stateMutability||"pure"===u.stateMutability)){const e=A();return(yield e.readContract({address:t,abi:n,functionName:i,args:a}))||null}yield r(this,He,"m",Ve).call(this,this.environment.CHAIN);const p=A(),{result:l,request:y}=yield p.simulateContract({account:d,address:t,abi:n,functionName:i,args:a,value:s.value});
// simulate
if(s.simulate)return l;try{const e=yield null===(o=this.viemClient)||void 0===o?void 0:o.writeContract(y);if("string"!=typeof e)throw new Error("Transaction failed to send.");if(!s.waitForReceipt)return{txHash:e,simulatedResult:l};return{txHash:e,receipt:yield r(this,He,"m",qe).call(this,e),simulatedResult:l}}catch(e){throw console.error("Transaction failed:",e),new Error("Transaction failed: "+e)}}))}
/**
...
const[a,r,s,o,d]=yield Promise.all([this.ownerOf(e),this.tokenURI(e),this.dataStatus(e),this.getTerms(e),this.callContractMethod(this.environment.DATANFT_CONTRACT_ADDRESS,this.environment.IPNFT_ABI,"tokenInfo",[e]).catch((()=>({appId:""})))]);
...
}return{tokenId:e,owner:a,uri:r,status:s,terms:o,hasAccess:u,accessExpiry:p,appId:(null==d?void 0:d.appId)||""}}))}
/**
     ...
     * }
     * ```
     */buyAccessSmart(t){return a(this,void 0,void 0,(function*(){let n=null;try{n=yield r(this,He,"m",Ze).call(this)}catch(e){throw new Error("Failed to buy access. Wallet not connected.")}
// Check if user already has access
if(yield this.hasAccess(n,t))return console.log("User already has access to this asset"),null;const i=yield this.getTerms(t);if(!i)throw new Error("Failed to fetch terms for asset");const{price:a,paymentToken:s,duration:o}=i;if(void 0===a||void 0===s||void 0===o)throw new Error("Terms missing price, paymentToken, or duration");
// Fetch protocol fee from marketplace
const d=yield r(this,He,"m",We).call(this),u=yield r(this,He,"m",Ge).call(this,t),p=a;
// Fetch app fee from token's appId
return s===e.zeroAddress?this.buyAccess(n,t,p,o,s,d,u,p):(yield xe({walletClient:this.viemClient,publicClient:A(),tokenAddress:s,owner:n,spender:this.environment.MARKETPLACE_CONTRACT_ADDRESS,amount:p}),this.buyAccess(n,t,p,o,s,d,u))}))}
/**
...
/**
     ...
     * ```
     */getRoyalties(t,n){return a(this,void 0,void 0,(function*(){try{const i=yield this.getTokenBoundAccount(t),a=A();let r,s;if(n&&n!==e.zeroAddress){
// erc20 (wrapped camp)
...
/**
     ...
     * ```
     */claimRoyalties(t,n,i){return a(this,void 0,void 0,(function*(){const a=yield r(this,He,"m",Je).call(this,n),s=yield this.getTokenBoundAccount(t),o=(yield this.getRoyalties(t,i)).balance;if(o===BigInt(0))throw new Error("No royalties available to claim");let d,u,p;
...
{waitForReceipt:!0,value:BigInt(0)})}))}}He=new WeakSet,je=function(e){return a(this,void 0,void 0,(function*(){try{const t=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/upload-url`,{method:"POST",body:JSON.stringify({name:e.name,type:e.type}),headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!t.ok)throw new Error(`HTTP ${t.status}: ${t.statusText}`);const n=yield t.json();if(n.isError)throw new Error(n.message||"Failed to generate upload URL");return n.data}catch(e){throw console.error("Failed to generate upload URL:",e),e}}))},$e=function(e,t){return a(this,void 0,void 0,(function*(){try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/update-status`,{method:"PATCH",body:JSON.stringify({status:t,fileKey:e}),headers:{Authorization:`Bearer ${this.jwt}`,"Content-Type":"application/json"}});if(!n.ok){const e=yield n.text().catch((()=>"Unknown error"));throw new Error(`HTTP ${n.status}: ${e}`)}return!0}catch(e){throw console.error("Failed to update origin status:",e),e}}))},Le=function(e){return a(this,void 0,void 0,(function*(){var t;if(!e)return null;try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/origin/upload-url-ipfs`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.jwt}`},body:JSON.stringify({fileName:e.name,fileType:e.type})});if(!n.ok){const e=yield n.text().catch((()=>"Unknown error"));throw new Error(`Failed to get presigned URL (HTTP ${n.status}): ${e}`)}const i=yield n.json(),{isError:a,data:r,message:s}=i;if(a||!r)throw new Error(`Failed to get presigned URL: ${s||"No URL returned from server"}`);const o=new FormData;o.append("file",e);const d=yield fetch(r,{method:"POST",body:o});if(!d.ok){const e=yield d.text().catch((()=>d.statusText));throw new Error(`Failed to upload preview image to IPFS (HTTP ${d.status}): ${e}`)}const u=yield d.json();if(!u||!u.data)throw new Error("Invalid response from IPFS upload: Missing data field");return null===(t=u.data)||void 0===t?void 0:t.cid}catch(e){const t=e instanceof Error?e.message:String(e);throw console.error("Error uploading preview image to IPFS:",t),new Error(`Failed to upload preview image to IPFS: ${t}`)}}))},ze=function(e,t){return a(this,void 0,void 0,(function*(){let n;try{n=yield r(this,He,"m",je).call(this,e)}catch(e){throw console.error("Failed to generate upload URL:",e),new Error(`Failed to generate upload URL: ${e instanceof Error?e.message:String(e)}`)}if(!n)throw new Error("Failed to generate upload URL: No upload info returned");try{yield((e,t,n)=>new Promise(((a,r)=>{i.put(t,e,Object.assign({headers:{"Content-Type":e.type}},"undefined"!=typeof window&&"function"==typeof n?{onUploadProgress:e=>{if(e.total){const t=e.loaded/e.total*100;n(t)}}}:{})).then((e=>{a(e.data)})).catch((e=>{var t;const n=(null===(t=null==e?void 0:e.response)||void 0===t?void 0:t.data)||(null==e?void 0:e.message)||"Upload failed";r(n)}))})))(e,n.url,(null==t?void 0:t.progressCallback)||(()=>{}))}catch(e){try{yield r(this,He,"m",$e).call(this,n.key,"failed")}catch(e){console.error("Failed to update status to failed:",e)}const t=e instanceof Error?e.message:String(e);throw new Error(`Failed to upload file: ${t}`)}try{yield r(this,He,"m",$e).call(this,n.key,"success")}catch(e){console.error("Failed to update status to success:",e)}return n}))},qe=function(e){return a(this,arguments,void 0,(function*(e,t={}){var n,i,a;const r=A();let s=e;const o=null!==(n=t.confirmations)&&void 0!==n?n:1,d=null!==(i=t.timeoutMs)&&void 0!==i?i:18e4,u=null!==(a=t.pollingIntervalMs)&&void 0!==a?a:1500;try{return yield r.waitForTransactionReceipt({hash:s,confirmations:o,timeout:d,pollingInterval:u,onReplaced:e=>{s=e.transaction.hash}})}catch(e){
// fallback
const t=Date.now();for(;Date.now()-t<d;){try{const e=yield r.getTransactionReceipt({hash:s});if(e&&e.blockNumber)return e}catch(e){}yield new Promise((e=>setTimeout(e,u)))}throw e}}))},Ve=function(e){return a(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected. Could not ensure chain ID.");let t=yield this.viemClient.request({method:"eth_chainId",params:[]});if("string"==typeof t&&(t=parseInt(t,16)),t!==e.id){(e=>{v=e,f=null})// reset public client to be recreated with new chain
(e);try{yield this.viemClient.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16)}]})}catch(t){
// Unrecognized chain
if(4902!==t.code)throw t;yield this.viemClient.request({method:"wallet_addEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16),chainName:e.name,rpcUrls:e.rpcUrls.default.http,nativeCurrency:e.nativeCurrency}]}),yield this.viemClient.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x"+BigInt(e.id).toString(16)}]})}}}))},Ze=function(){return a(this,void 0,void 0,(function*(){if(!this.viemClient)throw new Error("WalletClient not connected. Please connect a wallet.");
// If account is already set on the client, return it directly
if(this.viemClient.account)return this.viemClient.account.address;
// Otherwise request accounts (browser wallet flow)
const e=yield this.viemClient.request({method:"eth_requestAccounts",params:[]});if(!e||0===e.length)throw new Error("No accounts found in connected wallet.");return e[0]}))},We=function(){return a(this,void 0,void 0,(function*(){try{const e=yield this.callContractMethod(this.environment.MARKETPLACE_CONTRACT_ADDRESS,this.environment.MARKETPLACE_ABI,"protocolFeeBps",[]);return Number(e)}catch(e){return console.warn("Failed to fetch protocol fee, defaulting to 0:",e),0}}))},Ge=function(e){return a(this,void 0,void 0,(function*(){try{
...
return(null==i?void 0:i.isActive)?Number(i.revenueShareBps):0}catch(e){return console.warn("Failed to fetch app fee, defaulting to 0:",e),0}}))},Je=function(e){return a(this,void 0,void 0,(function*(){if(e)return e;if(!this.viemClient)throw new Error("No wallet address provided and no wallet client connected. Please provide an owner address or connect a wallet.");try{const e=yield this.viemClient.request({method:"eth_requestAccounts",params:[]});if(!e||0===e.length)throw new Error("No accounts found in connected wallet.");return e[0]}catch(e){throw new Error(`Failed to get wallet address: ${e instanceof Error?e.message:String(e)}`)}}))};Ke=new WeakMap,Xe=new WeakMap,Qe=new WeakMap,et=new WeakMap,Ye=new WeakSet,tt=function(e,t){r(this,Ke,"f")[e]&&r(this,Ke,"f")[e].forEach((e=>e(t)))},nt=function(e){return a(this,void 0,void 0,(function*(){const t=yield r(this,et,"f").getItem("camp-sdk:wallet-address"),n=yield r(this,et,"f").getItem("camp-sdk:user-id"),i=yield r(this,et,"f").getItem("camp-sdk:jwt"),a=yield r(this,et,"f").getItem("camp-sdk:environment");t&&n&&i&&(a===this.environment.NAME||!a)?(this.walletAddress=t,this.userId=n,this.jwt=i,this.origin=new ot(this.environment,this.jwt,this.viem,this.baseParentId,this.clientId),this.isAuthenticated=!0,e?this.setProvider({provider:e.provider,info:e.info||{name:"Unknown"},address:t}):r(this,Xe,"f")||(console.warn("No matching provider was given for the stored wallet address. Trying to recover provider."),yield this.recoverProvider())):this.isAuthenticated=!1}))},it=function(){return a(this,void 0,void 0,(function*(){try{const[t]=yield this.viem.requestAddresses();return this.walletAddress=e.checksumAddress(t),this.walletAddress}catch(e){throw new h(e)}}))},at=function(){return a(this,void 0,void 0,(function*(){try{const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/nonce`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({walletAddress:this.walletAddress})}),t=yield e.json();return 200!==e.status?Promise.reject(t.message||"Failed to fetch nonce"):t.data}catch(e){throw new Error(e)}}))},rt=function(e,t){return a(this,void 0,void 0,(function*(){try{const n=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/${this.environment.AUTH_ENDPOINT}/client-user/verify`,{method:"POST",headers:{"Content-Type":"application/json","x-client-id":this.clientId},body:JSON.stringify({message:e,signature:t,walletAddress:this.walletAddress})}),i=yield n.json(),a=i.data.split(".")[1],r=JSON.parse(atob(a));return{success:!i.isError,userId:r.id,token:i.data}}catch(e){throw new h(e)}}))},st=function(e,t,i){return n.createSiweMessage({domain:t||(r(this,Xe,"f")?"localhost":window.location.host),address:this.walletAddress,statement:D,uri:i||(r(this,Xe,"f")?"http://localhost":window.location.origin),version:"1",chainId:this.environment.CHAIN.id,nonce:e})},exports.Auth=
/**
 * The Auth class.
 * @class
...
/**
     ...
     */
constructor({clientId:e,redirectUri:t,environment:n="DEVELOPMENT",baseParentId:i,storage:a}){if(Ye.add(this),Ke.set(this,void 0),Xe.set(this,void 0),Qe.set(this,void 0),et.set(this,void 0),!e)throw new Error("clientId is required");if(-1===["PRODUCTION","DEVELOPMENT"].indexOf(n))throw new Error("Invalid environment, must be DEVELOPMENT or PRODUCTION");s(this,Xe,"undefined"==typeof window,"f"),s(this,et,a||(r(this,Xe,"f")?new y:new l),"f"),this.viem=null,this.environment=k[n],this.baseParentId=i,this.redirectUri=(e=>{const t=["twitter","spotify"];return"object"==typeof e?t.reduce(((t,n)=>(t[n]=e[n]||("undefined"!=typeof window?window.location.href:""),t)),{}):"string"==typeof e?t.reduce(((t,n)=>(t[n]=e,t)),{}):e?{}:t.reduce(((e,t)=>(e[t]="undefined"!=typeof window?window.location.href:"",e)),{})})(t),this.clientId=e,this.isAuthenticated=!1,this.jwt=null,this.origin=null,this.walletAddress=null,this.userId=null,s(this,Ke,{},"f"),
// only subscribe to providers in browser environment
r(this,Xe,"f")||B((e=>{r(this,Ye,"m",tt).call(this,"providers",e)})),r(this,Ye,"m",nt).call(this)}
/**
     ...
     *  console.log(state);
     * });
     */on(e,t){r(this,Ke,"f")[e]||(r(this,Ke,"f")[e]=[]),r(this,Ke,"f")[e].push(t),"providers"===e&&t(M())}
/**
     * Unsubscribe from an event. Possible events are "state", "provider", "providers", and "viem".
     * @param {("state"|"provider"|"providers"|"viem")} event The event.
     * @param {function} callback The callback function.
     * @returns {void}
     */off(e,t){r(this,Ke,"f")[e]&&(r(this,Ke,"f")[e]=r(this,Ke,"f")[e].filter((e=>e!==t)))}
/**
     * Set the loading state.
     * @param {boolean} loading The loading state.
     * @returns {void}
     */setLoading(e){r(this,Ye,"m",tt).call(this,"state",e?"loading":this.isAuthenticated?"authenticated":"unauthenticated")}
/**
...
r(this,Ye,"m",tt).call(this,"viem",this.viem),r(this,Ye,"m",tt).call(this,"provider",{provider:n,info:i}),r(this,et,"f").setItem("camp-sdk:provider",JSON.stringify(i))}
/**
...
/**
     ...
     */recoverProvider(){return a(this,void 0,void 0,(function*(){var e,t,n,i,a,s,o,d,u,p,l,y,c;if(!this.walletAddress)return void console.warn("No wallet address found in local storage. Please connect your wallet again.");const m=yield r(this,et,"f").getItem("camp-sdk:provider");if(!m)return;const h=JSON.parse(m);let T;const f=null!==(e=M())&&void 0!==e?e:[];
...
/**
     * Disconnect the user.
     * @returns {Promise<void>}
     */disconnect(){return a(this,void 0,void 0,(function*(){this.isAuthenticated&&(r(this,Ye,"m",tt).call(this,"state","unauthenticated"),this.isAuthenticated=!1,this.walletAddress=null,this.userId=null,this.jwt=null,this.origin=null,s(this,Qe,void 0,"f"),yield r(this,et,"f").removeItem("camp-sdk:wallet-address"),yield r(this,et,"f").removeItem("camp-sdk:user-id"),yield r(this,et,"f").removeItem("camp-sdk:jwt"),yield r(this,et,"f").removeItem("camp-sdk:environment"))}))}
/**
     * Connect the user's wallet and sign the message.
     * @returns {Promise<{ success: boolean; message: string; walletAddress: string }>} A promise that resolves with the authentication result.
     * @throws {APIError} - Throws an error if the user cannot be authenticated.
     */connect(){return a(this,void 0,void 0,(function*(){r(this,Ye,"m",tt).call(this,"state","loading");try{this.walletAddress||(yield r(this,Ye,"m",it).call(this)),this.walletAddress=e.checksumAddress(this.walletAddress);const t=yield r(this,Ye,"m",at).call(this),n=r(this,Ye,"m",st).call(this,t),i=yield this.viem.signMessage({account:this.walletAddress,message:n}),a=yield r(this,Ye,"m",rt).call(this,n,i);if(a.success)return this.isAuthenticated=!0,this.userId=a.userId,this.jwt=a.token,this.origin=new ot(this.environment,this.jwt,this.viem,this.baseParentId,this.clientId),yield r(this,et,"f").setItem("camp-sdk:jwt",this.jwt),yield r(this,et,"f").setItem("camp-sdk:wallet-address",this.walletAddress),yield r(this,et,"f").setItem("camp-sdk:user-id",this.userId),yield r(this,et,"f").setItem("camp-sdk:environment",this.environment.NAME),r(this,Ye,"m",tt).call(this,"state","authenticated"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,r(this,Ye,"m",tt).call(this,"state","unauthenticated"),new h("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,r(this,Ye,"m",tt).call(this,"state","unauthenticated"),new h(e)}}))}
/**
     ...
     */connectWithSigner(t,n){return a(this,void 0,void 0,(function*(){r(this,Ye,"m",tt).call(this,"state","loading");try{s(this,Qe,p(t),"f"),this.walletAddress=e.checksumAddress(yield r(this,Qe,"f").getAddress()),
// store the signer as viem client if it's a viem client, otherwise keep adapter
"viem"===r(this,Qe,"f").type&&(this.viem=t);const i=yield r(this,Ye,"m",at).call(this),a=r(this,Ye,"m",st).call(this,i,null==n?void 0:n.domain,null==n?void 0:n.uri),o=yield r(this,Qe,"f").signMessage(a),d=yield r(this,Ye,"m",rt).call(this,a,o);if(d.success)return this.isAuthenticated=!0,this.userId=d.userId,this.jwt=d.token,this.origin=new ot(this.environment,this.jwt,this.viem,this.baseParentId,this.clientId),yield r(this,et,"f").setItem("camp-sdk:jwt",this.jwt),yield r(this,et,"f").setItem("camp-sdk:wallet-address",this.walletAddress),yield r(this,et,"f").setItem("camp-sdk:user-id",this.userId),yield r(this,et,"f").setItem("camp-sdk:environment",this.environment.NAME),r(this,Ye,"m",tt).call(this,"state","authenticated"),{success:!0,message:"Successfully authenticated",walletAddress:this.walletAddress};throw this.isAuthenticated=!1,r(this,Ye,"m",tt).call(this,"state","unauthenticated"),new h("Failed to authenticate")}catch(e){throw this.isAuthenticated=!1,s(this,Qe,void 0,"f"),r(this,Ye,"m",tt).call(this,"state","unauthenticated"),new h(e)}}))}
/**
...
/**
     ...
     */linkTwitter(){return a(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(r(this,Xe,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/twitter/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.twitter}`}))}
/**
     * Link the user's Discord account.
     * @returns {Promise<void>}
     * @throws {Error} - Throws an error if the user is not authenticated or in Node.js environment.
     */linkDiscord(){return a(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(r(this,Xe,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/discord/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.discord}`}))}
/**
     * Link the user's Spotify account.
     * @returns {Promise<void>}
     * @throws {Error} - Throws an error if the user is not authenticated or in Node.js environment.
     */linkSpotify(){return a(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new Error("User needs to be authenticated");if(r(this,Xe,"f"))throw new Error("Social linking requires browser environment for OAuth flow");window.location.href=`${this.environment.AUTH_HUB_BASE_API}/spotify/connect?clientId=${this.clientId}&userId=${this.userId}&redirect_url=${this.redirectUri.spotify}`}))}
/**
...
/**
     ...
     * @throws {Error} - Throws an error if the user is not authenticated.
     * @throws {APIError} - Throws an error if the request fails.
     */unlinkTelegram(){return a(this,void 0,void 0,(function*(){if(!this.isAuthenticated)throw new h("User needs to be authenticated");const e=yield fetch(`${this.environment.AUTH_HUB_BASE_API}/telegram/disconnect-sdk`,{method:"POST",redirect:"follow",headers:{Authorization:`Bearer ${this.jwt}`,"x-client-id":this.clientId,"Content-Type":"application/json"},body:JSON.stringify({userId:this.userId})}).then((e=>e.json()));if(e.isError)throw new h(e.message||"Failed to unlink Telegram account");return e.data}))}},exports.BrowserStorage=l,exports.CustomSignerAdapter=u,exports.EthersSignerAdapter=d,exports.MemoryStorage=y,exports.Origin=ot,exports.ViemSignerAdapter=o,exports.campMainnet=m,exports.campTestnet=c,exports.createLicenseTerms=(e,t,n,i,a=exports.LicenseType.DURATION_BASED)=>{if(n<N||n>x)throw new Error(`Royalty basis points must be between ${N} and ${x}`);if(a===exports.LicenseType.DURATION_BASED){if(t<R||t>_)throw new Error(`Duration must be between ${R} and ${_} seconds for DURATION_BASED licenses`)}else if((a===exports.LicenseType.SINGLE_PAYMENT||a===exports.LicenseType.X402)&&t>0)throw new Error(`Duration must be 0 for ${exports.LicenseType[a]} licenses`);if(e<P)throw new Error(`Price must be at least ${P} wei`);return{price:e,duration:t,royaltyBps:n,paymentToken:i,licenseType:a}},exports.createNodeWalletClient=function(t,n,i){return e.createWalletClient({account:t,chain:n,transport:e.http(i)})},exports.createSignerAdapter=p;
