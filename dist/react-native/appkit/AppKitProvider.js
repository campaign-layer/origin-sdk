...
const AppKitProvider = ({ children, config }) => {
    ...
    const appKitValue = {
        ...
        signMessage: (message) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        ...
        signTransaction: (transaction) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
            // This would sign and send transaction
            console.log('Signing transaction:', transaction);
            return 'mock_tx_hash';
        }),
        switchNetwork: (chainId) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
...
const AppKitUtils = {
    ...
    open: () => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
...
exports.AppKitUtils = AppKitUtils;
