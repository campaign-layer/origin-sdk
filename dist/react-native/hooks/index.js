...
const useCampAuth = () => {
    const context = React.useContext(CampContext.CampContext);
    if (!context) {
...
const useSocials = () => {
    ...
    const fetchSocials = React.useCallback(() => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const linkSocial = React.useCallback((platform) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        if (!auth)
            throw new Error('Authentication required');
        return auth.linkSocial(platform);
    }), [auth]);
    const unlinkSocial = React.useCallback((platform) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        if (!auth)
            throw new Error('Authentication required');
...
const useAppKit = () => {
    ...
    const openAppKit = React.useCallback(() => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        var _a;
        if (!appKit)
    ...
    const disconnectAppKit = React.useCallback(() => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        var _a;
        if (!appKit)
            return;
        try {
    ...
    const switchNetwork = React.useCallback((targetChainId) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        var _a;
        if (!appKit)
            throw new Error('AppKit not initialized');
        try {
    ...
    const signMessage = React.useCallback((message) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        if (!appKit)
            throw new Error('AppKit not initialized');
        if (!isConnected)
    ...
    const sendTransaction = React.useCallback((transaction) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        if (!appKit)
            throw new Error('AppKit not initialized');
        if (!isConnected)
            throw new Error('Wallet not connected');
    ...
    const getBalance = React.useCallback(() => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        if (!appKit)
            throw new Error('AppKit not initialized');
    ...
    const getChainId = React.useCallback(() => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        var _a;
        if (!appKit)
            throw new Error('AppKit not initialized');
        try {
...
const useOrigin = () => {
    ...
    const fetchStats = React.useCallback(() => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const fetchUploads = React.useCallback(() => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        if (!auth || !auth.isAuthenticated || !auth.origin)
            return;
    ...
    const mintFile = React.useCallback((file, metadata, license, parentId) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const createIPAsset = React.useCallback((file, metadata, license) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        if (!(auth === null || auth === void 0 ? void 0 : auth.origin))
            throw new Error('Origin not initialized');
    ...
    const createSocialIPAsset = React.useCallback((source, license) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        if (!auth)
            throw new Error('Authentication required');
