...
}, _Auth_loadAuthStatusFromStorage = function _Auth_loadAuthStatusFromStorage() {
...
const ToastProvider = ({ children }) => {
    ...
    return (React.createElement(ToastContext.Provider, { value: { addToast } },
        children,
        createPortal(React.createElement("div", { className: styles$1["toast-container"], onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave }, toasts.map((toast) => (React.createElement("div", { key: toast.id, className: `${styles$1.toast} ${styles$1[`toast-${toast.type}`]} ${toast.isVisible ? styles$1["toast-enter"] : styles$1["toast-exit"]}`, onClick: () => removeToast(toast.id) }, toast.message)))), document.body)));
};
const useToast = () => {
...
const CampIcon = () => (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 571.95 611.12", height: "1rem", width: "1rem" },
...
const MyCampModal = ({ wcProvider }) => {
    ...
    return (React.createElement("div", { className: styles.container },
        React.createElement("div", { className: styles["close-button"], onClick: () => setIsVisible(false) },
            React.createElement(CloseIcon, null)),
        React.createElement("div", { className: styles.header },
            React.createElement("span", null, "My Camp"),
            React.createElement("span", { className: styles["wallet-address"] }, formatAddress(auth.walletAddress))),
        React.createElement("div", { className: styles["socials-wrapper"] }, isLoading || isLoadingSocials ? (React.createElement("div", { className: styles.spinner, style: { margin: "auto", marginTop: "6rem", marginBottom: "6rem" } })) : (React.createElement(React.Fragment, null,
