...
var ToastProvider = function ToastProvider(_ref) {
  ...
  var timers = useRef({});
  var remainingTimes = useRef({});
  var startTimes = useRef({});
  ...
  var removeToast = function removeToast(id) {
    setToasts(function (prevToasts) {
      return prevToasts.map(function (toast) {
        return toast.id === Number(id) ? _objectSpread2(_objectSpread2({}, toast), {}, {
          isVisible: false
        }) : toast;
      });
    });
  ...
  var handleMouseEnter = function handleMouseEnter() {
    ...
    Object.keys(timers.current).forEach(function (id) {
  ...
  var handleMouseLeave = function handleMouseLeave() {
    ...
    Object.keys(remainingTimes.current).forEach(function (id) {
  ...
  return /*#__PURE__*/React.createElement(ToastContext.Provider, {
    value: addToast
  }, children, /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement("div", {
    className: styles$1["toast-container"],
    onMouseEnter: handleMouseEnter,
    onMouseLeave: handleMouseLeave
  }, toasts.map(function (toast) {
    return /*#__PURE__*/React.createElement("div", {
      key: toast.id,
      className: "".concat(styles$1.toast, " ").concat(styles$1["toast-".concat(toast.type)], " ").concat(toast.isVisible ? styles$1["toast-enter"] : styles$1["toast-exit"]),
...
var CampProvider = function CampProvider(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(SocialsProvider, null, /*#__PURE__*/React.createElement(ToastProvider, null, /*#__PURE__*/React.createElement(ModalProvider, null, children))));
};
...
var TelegramFlow = function TelegramFlow() {
  ...
  var _useState25 = useState(true),
    ...
    isPhoneValid = _useState26[0],
    setIsPhoneValid = _useState26[1];
  var toast = useToast();
  var resetState = function resetState() {
    setIsLoading(false);
    setPhoneInput("");
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "".concat(styles["tiktok-input"], " ").concat(!isPhoneValid ? styles["invalid"] : "")
  }))))), /*#__PURE__*/React.createElement("button", {
    className: styles["linking-button"],
    onClick: handleAction,
    disabled: IsLoading || !isPhoneValid && !isOTPSent || !phoneInput && !isOTPSent || isOTPSent && otpInput.length < 5
...
var BasicFlow = function BasicFlow() {
  ...
  var _useState27 = useState(false),
    ...
    isUnlinking = _useState28[0],
    setIsUnlinking = _useState28[1];
  var handleLink = /*#__PURE__*/function () {
...
var MyCampModal = function MyCampModal(_ref10) {
  ...
  var _useState31 = useState(true),
    ...
    isLoadingSocials = _useState32[0],
    setIsLoadingSocials = _useState32[1];
  var _useLinkModal = useLinkModal(),
