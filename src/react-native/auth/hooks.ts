...
const getAuthProperties = (auth: AuthRN) => {
...
const getAuthVariables = (auth: AuthRN) => {
...
export const useAuth = (): AuthRN => {
  ...
  return { ...authVariables, ...authProperties } as AuthRN;
};
